...
import { a as L, k as K, l as $, m as O } from "chunk-M5XSLRLD.mjs";
import { a as fe } from "chunk-W774OHJB.mjs";
import { X as H, Z as q, ia as T } from "chunk-FVJDO2XD.mjs";
...
var a = T("accessTokenRefresher"),
  ...
  x = class {
    ...
    async start() {
      (S(!this.hasStarted, "Attempt to start AccessTokenRefresher more than once."),
        (this.hasStarted = !0));
...
var Ct = new x(m().api, { onInsufficientScopes: (t) => V(t), onUnauthorized: (t) => V(t) });
var Ot = Object.freeze({ "X-Requested-By": "Framer" });
export {
  A as a,
  b,
  rt as c,
...
//# sourceMappingURL=chunk-QH5BKXZN.mjs.map
