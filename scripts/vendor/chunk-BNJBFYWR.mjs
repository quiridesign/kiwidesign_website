import { a as ir, c as st, d as ar } from "chunk-VPDJYJ6F.mjs";
import {
  Vc as pt,
  aa as se,
  ab as br,
  ...
  wd as Ct,
  xd as De,
} from "chunk-YEI3MERI.mjs";
import { a as X, o as Oe } from "chunk-FNUTCKMA.mjs";
import { sb as Re, yb as Fr } from "chunk-PJ6FAON2.mjs";
import {
  $k as nr,
  AI as Nr,
  Ab as qt,
...
import { o as jt } from "chunk-HSJM72PS.mjs";
import { a as v } from "chunk-5WDLMAA7.mjs";
import { a as Xt, b as Ae, e as ne, f as K, k as zt } from "chunk-LA34HORX.mjs";
import { $ as Gt, X as et } from "chunk-FCG35XJJ.mjs";
import { b as x, c as $ } from "chunk-4JY5UMT2.mjs";
function as(e, t) {
...
function cs(e, t) {
  let r = vr(e),
    s = vr(t);
  return v(r.blocks, s.blocks) && v(r.entityMap, s.entityMap);
}
function Nt(e, t, r) {
  return t === r
    ? !0
...
function Ot(e, t, r, s) {
  ...
  let u = s._deleted;
  if (u && d) for (let _ of u) d[_] !== void 0 && (T || (T = { ...d }), delete T[_]);
  if (!T) return null;
  let A = t.asDraft(e),
    p = { ...o };
  return (
    Gt(T) ? delete p[r] : (p[r] = T),
    (A.replicaInfo = { ...i, overrides: p }),
...
function Vr(e, t, r, s, i) {
  return t === r || ((t = Yr(e, t)), (r = Yr(e, r)), v(t, r))
    ? !1
    : (t === void 0 ? (s._deleted || (s._deleted = []), s._deleted.push(e)) : (s[wr(e)] = t),
      r === void 0 ? (i._deleted || (i._deleted = []), i._deleted.push(e)) : (i[wr(e)] = r),
      !0);
}
function Wr(e, t, r, s) {
  let i = !1,
    o = {},
    d = {};
  for (let T in s) i = Vr(T, r[T], s[T], d, o) || i;
  for (let T in r) T in s || (i = Vr(T, r[T], s[T], d, o) || i);
...
function Pt(e, t, r, s, i) {
  if (!Gr(s)) return null;
  let o = e.get(s.parentid);
  if (!o || (_t(o) && !o.isLoaded())) return null;
  let d = Kr(e, t, r, s);
  return (e.insertNode(d, d.parentid, i), d);
}
function Kr(e, t, r, s) {
  let i = xr(r);
  ...
  if (o) {
    ...
    if (!d || !Ne(d)) throw Error("broken diff, replica without master: " + t + " " + o.master);
    let T = Ct(o),
      u = mr.create(e, d, {
  ...
  return Hr(i)
    ? (x(Dr(t), "Invalid EntityReferenceNode ID: " + t), new i({ ...Pe(s), id: t }))
    : new i({ ...Pe(s), id: t });
}
function Gr(e) {
...
function Ts(e) {
  let t = "styledText";
  return e != null && typeof e[t] == "object" && e[t] !== null && Xr(e[t]);
}
function zr(e, t) {
  e.has(t) && e.remove(t);
}
function Pe(e) {
  ...
  for (let r in e)
    r === "_deleted" ||
      (r === "guidesX" || r === "guidesY"
        ? (t[r] = Ur(e[r]))
        : (_r(r) || r === "formSelectOptions") && Array.isArray(e[r])
          ? (t[r] = e[r])
          : r === "replicaInfo"
            ? (t.replicaInfo = Ct(e[r]))
            : fr(r) || ur(r) || Sr(r)
              ? (t[r] = e[r])
              : r === "masks"
                ? (t[r] = De(e[r]))
...
function Es(e, t) {
  ...
  return (
    ...
    (t === "replicaInfo"
      ...
      : (ge(r) && ((r = r.toJS()), Xr(r) && t === "styledText" && delete r.cached), r))
  );
}
function ie(e, t, r, s = !1) {
  let i = e.get(t);
  if (!i) return null;
  let o = r.to;
  ...
  let d = se.updateNode(e, i, o, s);
  return (d && o.replicaInfo && V(d) && (d.cache.rebuildReplica = !0), d);
}
function hs(e, t, r, s = !1) {
  let i = !1;
  for (let [_, C] of Object.entries(r))
    if (_ === "_deleted" || !v(C, Es(t, _))) {
      i = !0;
      break;
    }
  if (!i) return null;
  let o = er(t),
    { styledText: d, replicaInfo: T, ...u } = r,
    A = t.asDraft(e);
  if ((A.assign(Pe(u)), d)) {
    let _ = ft.fromRawData(d);
    A.styledText = _;
  }
  if (T && (t.replicaInfo?.master !== T.master || t.replicaInfo?.inheritsFrom !== T.inheritsFrom)) {
    let _ = { ...T, overrides: t.replicaInfo?.overrides ?? {} };
    A.replicaInfo = _;
  }
  let p = !1;
  if (o) {
  ...
  if (Array.isArray(r._deleted))
    for (let _ of r._deleted)
      ((p ||= o && nt(_)),
        s ? A.resetToDefault(_) : _.startsWith("$") ? A.setProp(_, void 0) : (A[_] = void 0));
  return (p && t.cache.controlPropVersion++, A);
}
function Dt(e, t, r) {
  let s = r.replicaInfo;
  if (s?.master) {
...
function fs(e, t, r) {
  ...
  ms(o, s) || (t.asDraft(e).children = new nr(s));
}
function ms(e, t) {
        ...
        for (let o = 0, d = t.length; o < d; o++) {
          ...
          T.added
            ? Dt(e, T.id, T.to)
              ...
              : e.has(u)
                ? ie(e, u, T)
                : Pt(e, u, T.added, T.to, T.position)
            : T.removed || (Dt(e, T.id, T.to) ? i.push(T) : (ps(e, T, s), ie(e, u, T)));
        }
...
var Cs = { id: !0, cache: !0, children: !0, mutable: !0, update: !0, styledText: !0, _deleted: !0 },
  Ns = { parentid: !0, replicaInfo: !0, originalid: !0, duplicatedFrom: !0 };
function Is(e, t) {
  let r = e.length;
  if (r !== t.length) return !1;
...
function Os(e, t, r) {
  ...
  for (let u of T) {
    if (o) {
      ...
      if (u === "children") {
        (gs(r, e.children, t.children), (r.fromChildren || r.toChildren) && (d = !0));
        continue;
      }
      if (Cs[u]) continue;
    }
    ...
    A !== p &&
      ...
      (u === "replicaInfo"
        ? ((A = Rt(A)), (p = Rt(p)))
        : (ge(A) && (A = A.toJS()), ge(p) && (p = p.toJS())),
      !v(A, p, !0) &&
        (A === void 0 ? (s._deleted || (s._deleted = []), s._deleted.push(u)) : (s[u] = A),
        p === void 0 ? (i._deleted || (i._deleted = []), i._deleted.push(u)) : (i[u] = p),
        (d = !0)));
  }
  if (t instanceof pt) {
    if (!(e instanceof pt)) throw Error("assertion failed: nodes must be of same type");
    let u = e.styledText,
      A = t.styledText;
    if (u !== A) {
      let p = e.styledText.toJS();
      delete p.cached;
      let _ = t.styledText.toJS();
      (delete _.cached, v(p, _, !0) || ((s.styledText = p), (i.styledText = _), (d = !0)));
    }
  }
  if (!(!d && !r.added && !r.removed)) return r;
}
se.setGeneric("diffNodes", Os);
se.setGeneric("updateNode", hs);
function Lt(e) {
  if (e instanceof Oe) return e;
  if (Ce(e)) return new Oe(e);
...
var jr = ["contentManagementSyncState", "save"];
function Fc(e) {
  return jr.some((t) => t === e);
}
function Rs(e) {
  let t = Lt(e);
  for (let r of jr) {
...
function St(e, t, r) {
  ...
  if (e.added) {
    if (!Gr(e.to)) return;
    if (!t.has(e.id)) {
      let T = Kr(t.getCanvasTreeProxy(), e.id, e.added, e.to);
  ...
  if (e.to.parentid || e.position !== e.fromPosition) {
    ...
    u && u !== X && r.moveNode(e.id, u, e.position);
  }
...
function Ss(e, t, r, s, i) {
  let o = t.to.parentid;
  if (!o) return !1;
  let d = e.get(o);
  return !d || (_t(d) && !d.isLoaded()) || r.getParentId(t.id) === X
    ? !1
    : bt(e, t.id, o, t.position, r, s, t.to, i);
}
function bt(e, t, r, s, i, o, d, T) {
  if (e.has(t)) return !0;
  let u = i.getObject(t);
  if (!u || typeof u.__class != "string") return !1;
  let { children: A, parentid: p, id: _, ...C } = u,
    R = { ...C, ...d, ...T?.getEditedNodeFor(t), parentid: r };
  if (!Pt(e, t, u.__class, R, s)) return !1;
  for (let D of i.getChildrenIds(t))
    o.has(D) || (i.getParentId(D) !== X && bt(e, D, t, void 0, i, o, void 0, T));
  return !0;
}
function Ds(e, t, r, s) {
  let i = new Set(),
...
function Ls(e, t, r, s, i) {
  ...
  for (; A.length > 0; ) {
    ...
    for (let _ of A) {
      ...
      if (r && s && !e.has(C))
        if (_.added) {
          let R = s.get(_.to.parentid);
          if (!R) {
            p.push(_);
            continue;
          }
          let D = s.getScopeNodeFor(R)?.id,
            I = e.get(D);
          if (I && !I.isLoaded()) {
            o || St(_, s, r);
            continue;
      ...
      if (_.added) {
        if (e.has(C)) ie(e, C, _, !0);
        else if (Pt(e, C, _.added, _.to, _.position) && r && !o)
          for (let D of r.getChildrenIds(C))
            d.has(D) || (r.getParentId(D) !== X && bt(e, D, C, void 0, r, d, void 0, s));
      } else ie(e, C, _, !0);
    }
  ...
  for (let p of T) {
    if (u.has(p.id) || !Le(p.id)) continue;
    let [_, C] = gt(p.id);
    if (!_ || !C) continue;
    let R = e.get(_);
    if (!R && o) continue;
    let D = R ? null : s?.get(_),
      I = R ?? D;
    if (!I) {
      x(r, "Store must be defined to write data-only changes");
      let F = Rs(Qr(p.to, X));
      r.updateNestedObject([_, "replicaInfo", "overrides", C], F);
      continue;
    }
    let S = R ? e : s?.getCanvasTreeProxy();
    (x(S), Ot(S, I, C, p.to));
  }
  e.applyingDiffs = !1;
}
function xc(e, t, r, s, i) {
  let o = t
    .map((d) => {
      let T = d.id,
        u = d.added,
...
function ye(e, t, r) {
  return (
    ...
    Xt(e) || G(e) ? r(e) : { type: "LiteralValue", value: mt(t, void 0) }
  );
}
function ys(e, t, r, s) {
  function i(o) {
    return G(o) ? s(o) : { type: "LiteralValue", value: o };
  }
  switch ((x(tt(e.name), `Transform is not a valid expression: ${e.name}`), e.name)) {
    case "contains":
        ...
        o.has(T.from) ||
          (r.options.includes(T.from) &&
            ...
            d.push({
              ...
              then: ye(T.to, e.outputType, i),
            })));
      return { type: "Case", value: t, conditions: d, else: ye(e.default, e.outputType, i) };
    }
...
function Bs(e, t, r, s, i, o) {
  if (!e.collectionFilters) return;
  let d = e.collectionFilters.filters,
    T = [];
  for (let { itemKey: p, transforms: _ } of d) {
    let I = function (O) {
      return (Ms(O, t) && D.push(O), i(O));
    };
    var A = I;
    if (!p) continue;
    let R = t?.get(e.getPrimaryId())?.get(p);
    if (!R || (r.add(p), R.type !== "boolean" && _.length === 0)) continue;
    let D = [],
      S = _.some((O) => {
        if (!rt(O.name) || !tt(O.name)) return !1;
        switch (O.name) {
          case "convertFromEnum":
          case "convertFromString":
          case "endsWith":
      ...
      F = Me(p, R, r, s, o, S);
    for (let O of _) rt(O.name) && (F = ys(O, F, R, I));
    T.push({ expression: F, optionalVariables: D });
  }
  let u = e.collectionFiltersOperator ?? Ar;
  switch (u) {
    case "all":
      return ks(T, i);
    case "any":
...
function ks(e, t) {
  if (e.length !== 0)
    return e.reduce(
      (r, s) => {
        let i = xs(s.expression, s.optionalVariables, t);
...
function Fs(e, t) {
  ...
  let r = e.reduce(
    (o, d) => {
      let T = Hs(d.expression, d.optionalVariables, t);
...
function vs(e, t, r, s, i, o) {
  if (e.collectionOrder && e.collectionOrder.length > 0) {
    ...
    for (let { itemKey: T, direction: u } of e.collectionOrder) {
      ...
      if (!A) continue;
      let p = Me(T, A, r, s, o);
      (u === "desc" && (p.direction = "desc"), d.push(p));
    }
    return d;
  }
  if (e.collectionFilters && e.collectionFilters.filters.length === 1) {
    ...
    if ((x(d, "filter should exist"), d.itemKey)) {
      let T = t.get(d.itemKey),
        u = Me(d.itemKey, T, r, s, o),
        A = ws(e, d.transforms, u, T, i);
      if (A) return [A];
    }
  }
...
function ws(e, t, r, s, i) {
  ...
  let o = t[0];
  if ((x(o, "Transform must exist"), o.name === "isIncludedIn" && G(o.value)))
    return {
      type: "FunctionCall",
...
function Ys(e, t, r, s, i) {
  ...
  for (let T of r) {
    ...
    for (let A = 1; A < u.length; A++) {
      let p = u.slice(0, A).join("."),
        _ = t.get(p);
      if (_?.type !== "collectionreference") continue;
      let C = _.dataIdentifier;
      d.set(p, C);
    }
  }
  for (let [T, u] of d) {
...
function el(e, t, r, s, i) {
  ...
  let p = Vs(u, r, d, T, i);
  return { from: Ys(e.dataIdentifier, u, d, T, i), select: p, ...o };
}
function Me(e, t, r, s, i, o = !0) {
  (o && t?.type === "collectionreference" && !Nr(e) && (e += ".id"), r.add(e));
  let [d, T] = qr(e, s);
...
function Ks(e) {
  return !K(e) || e.type !== "object"
    ...
    : e.value === null
      ? !0
      : Object.values(e.value).every(Qs);
}
function Tl(e) {
  return zt(e) && e.every((t) => pr(t) && Ks(t));
}
var Gs = new Set([
  ...
  xe = class {
    ...
    _processSurrogate(t) {
      if (this.pos !== this.html.length - 1) {
        ...
        if (Jr(r)) return (this.pos++, this._addGap(), Zr(t, r));
...
function z(e) {
  var t;
  return (t = qs.get(e)) !== null && t !== void 0 ? t : n.UNKNOWN;
}
var m = n,
  en = {
    [f.HTML]: new Set([
  ...
  ae = new Set([m.H1, m.H2, m.H3, m.H4, m.H5, m.H6]),
  _l = new Set([E.STYLE, E.SCRIPT, E.XMP, E.IFRAME, E.NOEMBED, E.NOFRAMES, E.PLAINTEXT]);
var c;
(function (e) {
  ((e[(e.DATA = 0)] = "DATA"),
    (e[(e.RCDATA = 1)] = "RCDATA"),
...
var ce = class {
  ...
  _emitCodePoint(t) {
    let r = nn(t) ? N.WHITESPACE_CHARACTER : t === a.NULL ? N.NULL_CHARACTER : N.CHARACTER;
  ...
  _startCharacterReference() {
    ((this.returnState = this.state),
      ...
      this.entityDecoder.startEntity(
        this._isCharacterReferenceInAttribute() ? st.Attribute : st.Legacy
      ));
  }
  ...
  _stateTagOpen(t) {
    if (W(t)) (this._createStartTagToken(), (this.state = c.TAG_NAME), this._stateTagName(t));
    else
      switch (t) {
  ...
  _stateEndTagOpen(t) {
    if (W(t)) (this._createEndTagToken(), (this.state = c.TAG_NAME), this._stateTagName(t));
    else
      switch (t) {
  ...
  _stateTagName(t) {
    ...
    switch (t) {
      ...
      default:
        r.tagName += String.fromCodePoint(oe(t) ? Ue(t) : t);
    }
  }
  ...
  _stateScriptDataDoubleEscapeStart(t) {
    if (this.preprocessor.startsWith(M.SCRIPT, !1) && rn(this.preprocessor.peek(M.SCRIPT.length))) {
      this._emitCodePoint(t);
  ...
  _stateAttributeName(t) {
    switch (t) {
      ...
      default:
        this.currentAttr.name += String.fromCodePoint(oe(t) ? Ue(t) : t);
    }
  }
  ...
  _stateDoctypeName(t) {
    ...
    switch (t) {
      ...
      default:
        r.name += String.fromCodePoint(oe(t) ? Ue(t) : t);
    }
  }
  ...
  _stateCharacterReference() {
    ...
    t === 0
      ? ((this.preprocessor.pos = this.entityStartPos),
        ...
        (this.state =
          !this._isCharacterReferenceInAttribute() && tn(this.preprocessor.peek(1))
...
var cn = new Set([n.DD, n.DT, n.LI, n.OPTGROUP, n.OPTION, n.P, n.RB, n.RP, n.RT, n.RTC]),
  sn = new Set([...cn, n.CAPTION, n.COLGROUP, n.TBODY, n.TD, n.TFOOT, n.TH, n.THEAD, n.TR]),
  ve = new Set([n.APPLET, n.CAPTION, n.HTML, n.MARQUEE, n.OBJECT, n.TABLE, n.TD, n.TEMPLATE, n.TH]),
  ti = new Set([...ve, n.OL, n.UL]),
  ri = new Set([...ve, n.BUTTON]),
  an = new Set([n.ANNOTATION_XML, n.MI, n.MN, n.MO, n.MS, n.MTEXT]),
  on = new Set([n.DESC, n.FOREIGN_OBJECT, n.TITLE]),
  ...
  we = class {
    ...
    popUntilNumberedHeaderPopped() {
      this.popUntilPopped(ae, f.HTML);
    }
    popUntilTableCellPopped() {
      this.popUntilPopped(ai, f.HTML);
    }
    ...
    hasInListItemScope(t) {
      return this.hasInDynamicScope(t, ti);
    }
    hasInButtonScope(t) {
      return this.hasInDynamicScope(t, ri);
    }
    ...
    generateImpliedEndTagsWithExclusion(t) {
      for (; this.currentTagId !== void 0 && this.currentTagId !== t && sn.has(this.currentTagId); )
        this.pop();
    }
  };
var H;
...
var ln = { type: H.Marker },
  Ye = class {
    ...
    insertMarker() {
      this.entries.unshift(ln);
    }
    pushElement(t, r) {
      (this._ensureNoahArkCondition(t),
        this.entries.unshift({ type: H.Element, element: t, token: r }));
    }
    insertElementAfterBookmark(t, r) {
      let s = this.entries.indexOf(this.bookmark);
      this.entries.splice(s, 0, { type: H.Element, element: t, token: r });
    }
    removeEntry(t) {
    ...
    clearToLastMarker() {
      let t = this.entries.indexOf(ln);
      t === -1 ? (this.entries.length = 0) : this.entries.splice(0, t + 1);
    }
    getElementEntryInScopeWithTagName(t) {
      let r = this.entries.find(
        (s) => s.type === H.Marker || this.treeAdapter.getTagName(s.element) === t
      );
      return r && r.type === H.Element ? r : null;
    }
    getElementEntry(t) {
      return this.entries.find((r) => r.type === H.Element && r.element === t);
    }
  };
var k = {
  createDocument() {
...
var Tn = "html",
  oi = "about:legacy-compat",
  ci = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd",
  En = [
  ...
  li = [...En, "-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"],
  di = new Set([
    "-//w3o//dtd w3 html strict 3.0//en//",
    "-/w3c/dtd html 4.0 transitional/en",
    "html",
  ]),
  hn = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"],
  Ti = [...hn, "-//w3c//dtd html 4.01 frameset//", "-//w3c//dtd html 4.01 transitional//"];
function dn(e, t) {
  return t.some((r) => e.startsWith(r));
}
function un(e) {
  return e.name === Tn && e.publicId === null && (e.systemId === null || e.systemId === oi);
}
function fn(e) {
  if (e.name !== Tn) return B.QUIRKS;
  let { systemId: t } = e;
  if (t && t.toLowerCase() === ci) return B.QUIRKS;
  let { publicId: r } = e;
  if (r !== null) {
    if (((r = r.toLowerCase()), di.has(r))) return B.QUIRKS;
    let s = t === null ? li : En;
    if (dn(r, s)) return B.QUIRKS;
    if (((s = t === null ? hn : Ti), dn(r, s))) return B.LIMITED_QUIRKS;
  }
  return B.NO_QUIRKS;
}
...
function pn(e) {
  let t = _i.get(e.tagName);
  t != null && ((e.tagName = t), (e.tagID = z(e.tagName)));
}
function Ai(e, t) {
...
function An(e, t, r, s) {
  return ((!s || s === f.HTML) && Ci(e, t, r)) || ((!s || s === f.MATHML) && Ai(e, t));
}
var Ni = "hidden",
  Ii = 8,
  gi = 3,
...
var Oi = { startLine: -1, startCol: -1, startOffset: -1, endLine: -1, endCol: -1, endOffset: -1 },
  On = new Set([n.TABLE, n.TBODY, n.TFOOT, n.THEAD, n.TR]),
  Nn = { scriptingEnabled: !0, sourceCodeLocationInfo: !1, treeAdapter: k, onParseError: null },
  me = class {
    constructor(t, r, s = null, i = null) {
      ((this.fragmentContext = s),
        ...
        (this.tokenizer = new ce(this.options, this)),
        (this.activeFormattingElements = new Ye(this.treeAdapter)),
        (this.fragmentContextID = s ? z(this.treeAdapter.getTagName(s)) : n.UNKNOWN),
    ...
    _err(t, r, s) {
      ...
      let o = (i = t.location) !== null && i !== void 0 ? i : Oi,
        d = {
          code: r,
    ...
    _insertCharacters(t) {
      ...
      if (this.treeAdapter.getNodeSourceCodeLocation(d)) {
        let { endLine: u, endCol: A, endOffset: p } = t.location;
        this.treeAdapter.updateNodeSourceCodeLocation(d, { endLine: u, endCol: A, endOffset: p });
      } else
        this.options.sourceCodeLocationInfo &&
    ...
    _reconstructActiveFormattingElements() {
      ...
      if (t) {
        let r = this.activeFormattingElements.entries.findIndex(
            (i) => i.type === H.Marker || this.openElements.contains(i.element)
          ),
          s = r === -1 ? t - 1 : r - 1;
        for (let i = s; i >= 0; i--) {
...
function xt(e, t) {
  for (let r = 0; r < Ii; r++) {
    ...
    let o = Di(e, i, s.element),
      d = e.openElements.getCommonAncestor(s.element);
    (e.treeAdapter.detachNode(o), d && Pi(e, d, o), bi(e, i, s));
  }
}
function kt(e, t) {
...
function Bi(e, t) {
  ...
  let r = t.forceQuirks ? B.QUIRKS : fn(t);
  (un(t) || e._err(t, h.nonConformingDoctype),
...
function ki(e, t) {
  t.tagID === n.HTML ? (e._insertElement(t, f.HTML), (e.insertionMode = l.BEFORE_HEAD)) : Te(e, t);
}
function Fi(e, t) {
  let r = t.tagID;
  (r === n.HTML || r === n.HEAD || r === n.BODY || r === n.BR) && Te(e, t);
}
function Te(e, t) {
...
function Xi(e, t) {
  (e.openElements.hasInButtonScope(n.P) && e._closePElement(),
    e.openElements.currentTagId !== void 0 &&
      ae.has(e.openElements.currentTagId) &&
      e.openElements.pop(),
    e._insertElement(t, f.HTML));
}
function zi(e, t) {
...
function Zi(e, t) {
  ...
  (r && (xt(e, t), e.openElements.remove(r.element), e.activeFormattingElements.removeEntry(r)),
    e._reconstructActiveFormattingElements(),
    e._insertElement(t, f.HTML),
...
function ta(e, t) {
  (e._reconstructActiveFormattingElements(),
    e.openElements.hasInScope(n.NOBR) && (xt(e, t), e._reconstructActiveFormattingElements()),
    e._insertElement(t, f.HTML),
    e.activeFormattingElements.pushElement(e.openElements.current, t));
}
function ra(e, t) {
...
function Ln(e) {
  let t = He(e, Y.TYPE);
  return t != null && t.toLowerCase() === Ni;
}
function sa(e, t) {
  (e._reconstructActiveFormattingElements(),
    e._appendElement(t, f.HTML),
...
function oa(e, t) {
  ((t.tagName = E.IMG), (t.tagID = n.IMG), Dn(e, t));
}
function ca(e, t) {
  (e._insertElement(t, f.HTML),
    (e.skipNextNewLine = !0),
...
function b(e, t) {
  switch (t.tagID) {
    ...
    case n.NOSCRIPT: {
      e.options.scriptingEnabled ? In(e, t) : gn(e, t);
      break;
    }
    case n.PLAINTEXT: {
      $i(e, t);
...
function pa(e, t) {
  e.openElements.hasInScope(n.BODY) && ((e.insertionMode = l.AFTER_BODY), Un(e, t));
}
function Aa(e, t) {
  let r = t.tagID;
...
function bn(e, t) {
  e.tmplInsertionModeStack.length > 0 ? Hn(e, t) : Ht(e, t);
}
function Da(e, t) {
  var r;
  (t.tagID === n.SCRIPT &&
...
function Bt(e, t) {
  if (e.openElements.currentTagId !== void 0 && On.has(e.openElements.currentTagId))
    switch (
...
function Fa(e, t) {
  (Ln(t) ? e._appendElement(t, f.HTML) : pe(e, t), (t.ackSelfClosing = !0));
}
function xa(e, t) {
  !e.formElement &&
    e.openElements.tmplCount === 0 &&
...
function de(e, t) {
  ...
  if (e.hasNonWhitespacePendingCharacterToken)
    for (; r < e.pendingCharacterTokens.length; r++) pe(e, e.pendingCharacterTokens[r]);
  else
    for (; r < e.pendingCharacterTokens.length; r++)
      e._insertCharacters(e.pendingCharacterTokens[r]);
  ((e.insertionMode = e.originalInsertionMode), e._processToken(t));
}
var Bn = new Set([n.CAPTION, n.COL, n.COLGROUP, n.TBODY, n.TD, n.TFOOT, n.TH, n.THEAD, n.TR]);
function Ha(e, t) {
  let r = t.tagID;
  Bn.has(r)
...
function Ya(e, t) {
  ...
  switch (r) {
    ...
    case n.THEAD:
    case n.TR: {
      e.openElements.hasInTableScope(r) && (e._closeTableCell(), kn(e, t));
      break;
    }
    case n.BODY:
    case n.CAPTION:
...
function Qa(e, t) {
  switch (t.tagID) {
    ...
    case n.TFOOT:
    case n.THEAD: {
      ((e.tmplInsertionModeStack[0] = l.IN_TABLE), (e.insertionMode = l.IN_TABLE), ee(e, t));
      break;
    }
    case n.COL: {
    ...
    default:
      ((e.tmplInsertionModeStack[0] = l.IN_BODY), (e.insertionMode = l.IN_BODY), b(e, t));
  }
}
function Ka(e, t) {
...
function to(e, t) {
  if (_n(t)) (vn(e), e._startTagOutsideForeignContent(t));
  else {
    let r = e._getAdjustedCurrentElement(),
      s = e.treeAdapter.getNamespaceURI(r);
    (s === f.MATHML ? yt(t) : s === f.SVG && (pn(t), Mt(t)),
      Ve(t),
...
function ro(e, t) {
  if (t.tagID === n.P || t.tagID === n.BR) {
    (vn(e), e._endTagOutsideForeignContent(t));
    return;
  }
...
function wn(e, t, r) {
  ...
  let s = me.getFragmentParser(e, r);
  return (s.tokenizer.write(t, !0), s.getFragment());
}
var no = "data-framer-link",
  Yn = "data-framer-open-in-new-tab",
  Vn = "data-framer-smooth-scroll",
  so = "data-framer-click-tracking-id",
  Wn = "data-framer-rel",
  io = "data-framer-preserve-params",
  ao = "framer-module",
  oo = "data-module-identifier",
  co = "data-module-props",
  lo = "data-module-width",
  To = "data-module-alignment",
  Eo = /\s+/u;
function qn(e, t) {
  let r = wn(e),
    s = { id: L(), type: "richText", variant: t, childNodes: $e(r) };
  return Z(s);
}
function ho(e) {
  let t = [];
...
function uo(e) {
  ...
  switch (e.tagName) {
    ...
    case "img":
      return Qn(t, "image");
    case "video":
      return vt(t, "framer-image") || t.get("src") ? Qn(t, "video") : void 0;
    case ao:
    case "template":
      return Ao(t);
    case "table":
      return Kn(e);
    case "figure": {
      if (!vt(t, "framer-table-wrapper")) return;
      let s = re(e).find((i) => i.tagName === "table");
      return s ? Kn(s) : void 0;
    }
  }
}
function fo(e, t, r) {
  return {
    ...
    type: "textBlock",
    tag: e.tagName,
    textDirection: Yt(t, r),
    childNodes: go(qe(e), {}),
  };
}
function mo(e, t, r) {
  return { id: L(), type: "bulletedList", textDirection: Yt(t, r), childNodes: $n(e) };
}
function _o(e, t, r) {
  let s = bo(t.get("start")) ?? 1,
    i = Lo(e, r);
  return {
    id: L(),
    type: "numberedList",
...
function $n(e) {
  return re(e)
    ...
    .map((t) => ({ id: L(), type: "listItem", childNodes: $e(t) }));
}
function po(e) {
  return { id: L(), type: "blockquote", childNodes: $e(e) };
}
function Qn(e, t) {
  ...
  if (t === "image") {
    let i = e.get("alt");
    i !== void 0 && (r.alt = i);
    let o = jn(e.get("data-framer-width"));
    o !== void 0 && (r.pixelWidth = o);
    let d = jn(e.get("data-framer-height"));
...
function No(e) {
  let t = [];
  for (let r of re(e)) (r.tagName !== "td" && r.tagName !== "th") || t.push(Io(r));
...
function Jn(e, t, r) {
  for (let s of e) {
    ...
    if (!Vt(s)) continue;
    if (s.tagName === "br") {
      if (vt(Je(s), "trailing-break")) continue;
      r.push(Do());
      continue;
    }
    let i = Oo(s, t);
...
function Zn(e) {
  ...
  if (r === void 0) return;
  let s = te(e.get(Wn)) ?? te(e.get("rel")) ?? Gn(e.get("rel")) ?? Gn(e.get(Wn)) ?? [],
    i = {
      id: L(),
      link: r,
      openInNewTab: te(e.get(Yn)) ?? zn(e.get(Yn)),
      smoothScroll: te(e.get(Vn)) ?? zn(e.get(Vn)),
      relValues: s,
    },
    o = e.get(so);
  o && (i.clickTrackingId = te(o) ?? o);
  let d = e.get(io);
  return (d !== void 0 && (i.preserveParams = te(d) ?? d !== "false"), i);
}
function Gn(e) {
...
function Lo(e, t) {
  ...
  return (i && es(Je(i).get("style")).get("list-style-type")) || "decimal";
}
function te(e) {
...
function Mo(e) {
  return !yo(e) || typeof e.type != "string"
    ? !1
    : e.type === "url"
      ? typeof e.url == "string"
      : e.type === "webPage"
...
function ud(e, t) {
  ...
  if (typeof e != "string") return Wt(t);
  try {
    return qn(e, t);
  } catch (r) {
    return (et(r), Wt(t));
...
function fd(e) {
  return typeof e == "string"
    ? ct(e)
    : J(e)
      ? dr(Z(e), { preserveTrailingEmptyBlockNewLine: !0 })
      : "";
}
function md(e) {
  return typeof e == "string" ? ct(e).length === 0 : J(e) ? !Bo(Z(e)) : !0;
}
function Bo(e) {
  return (
    Cr(e, {
...
function ts(e, t, r) {
  ...
  ((t.cache.parentDirected = e.layout),
    ...
    Ce(e.stackDirection) && r
      ? (t.cache.parentDirection = e.resolveValue("stackDirection") ?? $t)
      : (t.cache.parentDirection = e.stackDirection ?? null),
    tr(e) && ((t.cache.parentWidthType = e.widthType), (t.cache.parentHeightType = e.heightType)));
}
function Id(e, t) {
  ts(e, t, !1);
}
...
function Fo(e, t) {
  if (lt(e)) {
    if (xo(e.value)) return { ...e, type: "rich-text", value: e.value };
    if (e.type === "rich-text" && Ae(e.value)) return { ...e, type: "rich-text", value: e.value };
    if (Ae(e.value)) return { ...e, type: "rich-text", value: Re(t, e.value) };
  }
}
function yd(e, t, r) {
  switch (e) {
...
function xo(e) {
  return J(e) && rr(e.variant);
}
var Qt = "[a-z1-9]+(?:-[a-z1-9]+)*",
  Ho = `${Qt}="[^"]*"`,
  Uo = String.raw`(?:\s+${Ho})*`,
  vo = String.raw`<${Qt}${Uo}\s*>`,
  wo = `(?:${vo})+`,
  Yo = String.raw`<\/\s*${Qt}\s*>`,
  Vo = `(?:${Yo})+`,
  Wo = "[^<>]*",
  rs = String.raw`\s*`,
  Qo = new RegExp(`^${rs}${wo}${Wo}${Vo}${rs}$`, "iu");
function kd(e) {
  return jt.isOn("localizedLinks") && e.includes("</a>")
    ? "rich-text"
    : Qo.test(e)
      ? "text"
      : "rich-text";
  ...
  s.doc.descendants((I) => {
    ...
    if (at(I)) {
      let S = !1,
        ...
        w,
        Q;
      for (let y of I.marks)
        ((S ||= ot(y)),
          (F ||= ht(y)),
          or(y) && (w ??= y.attrs),
          cr(y) && (Q ??= y.attrs),
          Tt(y) && o.push(y.attrs.linkStylePreset),
          Et(y) && d.push(y.attrs.inlineCodeStylePreset),
          sr(y) && (O = y.attrs.inlineStyles));
      (A.push(w), p.push(Q), S && T.push(O), F && u.push(O));
    }
  });
  let _ = ut(Ko(t, r), r),
    C = _.tr,
    R = new Map();
  _.doc.descendants((I, S, F) => {
    if (it(I)) {
      let O = i[I.attrs.tag] ?? [],
        w = O.length > 1 ? O.shift() : O[0];
      w && (R.set(I, w.inlineStyles), C.setNodeMarkup(S, I.type, { ...I.attrs, ...w }));
    }
    if (at(I)) {
      let O = !1,
        w = !1,
        Q = F ? R.get(F) : void 0;
      for (let q of I.marks) {
        if (((O ||= ot(q)), (w ||= ht(q)), Tt(q))) {
          let Ze = o.length > 1 ? o.shift() : o[0];
          C.addMark(S, S + I.nodeSize, r.marks.link.create({ ...q.attrs, linkStylePreset: Ze }));
        }
        if (Et(q)) {
          ...
          C.addMark(
            S,
            S + I.nodeSize,
            r.marks.inlineCode.create({ ...q.attrs, inlineCodeStylePreset: Ze })
          );
        }
      }
      (O && (Q = T.length > 1 ? T.shift() : T[0]),
        w && (Q = u.length > 1 ? u.shift() : u[0]),
        Q && C.addMark(S, S + I.nodeSize, r.marks.inlineStyles.create({ inlineStyles: Q })));
      let y = A.length > 1 ? A.shift() : A[0];
      y && C.addMark(S, S + I.nodeSize, r.marks.backgroundMask.create(y));
      let Kt = p.length > 1 ? p.shift() : p[0];
      Kt && C.addMark(S, S + I.nodeSize, r.marks.backgroundStyles.create(Kt));
    }
  });
  let D = _.apply(C);
  return hr(D.doc, r);
...
function Ko(e, t) {
  return typeof e == "string" ? e : Fr(e, t);
}
function Jd(e, t) {
...
//# sourceMappingURL=chunk-BNJBFYWR.mjs.map
