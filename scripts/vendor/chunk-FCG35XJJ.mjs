import { b as I, c as E } from "chunk-4JY5UMT2.mjs";
...
var et = /Mac/u,
  tt = /Win/u,
  rt = /iPhone|iPod|iPad/iu,
  nt = /MacIntel/iu,
  ot = /android/iu;
function le() {
  let e = h();
  return e ? et.test(e.platform) : !1;
}
function it() {
  let e = h();
  return e ? tt.test(e.platform) : !1;
}
function ue() {
  let e = h();
  return e
    ? rt.test(e.platform)
      ? !0
      : nt.test(e.platform) && e.maxTouchPoints != null && e.maxTouchPoints > 2
    : !1;
}
function de() {
  return le() || ue();
...
function st() {
  let e = h();
  return e ? ot.test(e.userAgent) : !1;
}
var at = /Edg\//u;
function K() {
  let e = h();
  return e ? at.test(e.userAgent) : !1;
}
var lt = /Chrome/u,
  ut = /Google Inc/u;
function ce() {
  let e = h();
  return e ? lt.test(e.userAgent) && ut.test(e.vendor) && !K() : !1;
}
var dt = /AppleWebKit\//u;
function ct() {
  let e = h();
  return e ? dt.test(e.userAgent) && !ce() && !K() : !1;
}
var ft = /Safari/u,
  pt = /Apple Computer/u;
function fe() {
  let e = h();
  return e ? ft.test(e.userAgent) && pt.test(e.vendor) : !1;
}
function gt() {
  return fe() && !pe();
}
var xt = /Firefox\/\d+\.\d+$/u;
function mt() {
  let e = h();
  return e ? xt.test(e.userAgent) : !1;
}
function ht() {
...
function Et() {
  let e = h();
  if (!e) return -1;
  let t = It.exec(e.userAgent);
  return t?.[1] ? parseFloat(t[1]) : -1;
}
var bt = /FramerX/u;
function wt() {
  let e = h();
  return e ? bt.test(e.userAgent) : !1;
}
function Tt() {
  let e = h();
...
var Pt = /tablet|iPad|Nexus 9/iu,
  Rt = /mobi/iu;
function C() {
  let e = h();
  return e && Pt.test(e.userAgent) ? "tablet" : e && Rt.test(e.userAgent) ? "phone" : "desktop";
}
function Ot() {
  return C() === "desktop";
}
...
var Dt = /Instagram|FB_IAB\/FB4A|FBAN\/FBIOS|BytedanceWebview|Twitter|LinkedIn/iu;
function Nt() {
  let e = h();
  return e ? Dt.test(e.userAgent) : !1;
}
var Ft = /^[a-z]{1,8}:\/\/.*$/iu;
function $t(e) {
  return !Ft.test(e);
...
var Ct = /[a-z]{1,8}:\/\/127\.0\.0\.1/iu,
  _t = /[a-zA-Z]{1,8}:\/\/localhost/u;
function he(e) {
  return Ct.test(e) || _t.test(e);
}
function jt(e) {
  return !!(me(e) || he(e));
}
function Vt(e) {
  return de() ? e.metaKey : e.ctrlKey;
}
var z,
  ye = !1;
function Wt(e) {
...
function Me({ error: e, tags: t, extras: r, critical: n, caller: i }) {
  let o = _(e, i);
  return (
    z
      ? z({ error: o, tags: { ...o.tags, ...t }, extras: { ...o.extras, ...r }, critical: !!n })
      : ye ||
        ((ye = !0),
        console.error(
...
function _(e, t = _) {
  return e instanceof Error ? e : new U(e, t);
}
...
var k = typeof window < "u" && !("Deno" in globalThis) ? window.location.hostname : void 0,
  Ee = !!(k && ["web.framerlocal.com", "localhost", "127.0.0.1", "[::1]"].includes(k)),
  H = (() => {
    if (!k) return;
    if (Ee) return { main: k, previewLink: void 0 };
  ...
  G = {
    hosts: H,
    isDevelopment: H?.main === "development.framer.com",
    isProduction: H?.main === "framer.com",
    isLocal: Ee,
  },
  Kt = /^(?:[a-z]+:\/\/)?(?:[^@/]*@)?(\[[^\]]+\]|[^:/\s?#]+)/iu,
  zt = new Set(["localhost", "127.0.0.1", "[::1]"]);
function Ut(e) {
  return ((e.includes(":") || e.includes("/")) && (e = Kt.exec(e)?.[1] ?? ""), zt.has(e));
}
function P(e, t = 0, r = new Set()) {
  if (e === null) return e;
  ...
  r.add(e);
  try {
    if ("toJSON" in e && typeof e.toJSON == "function") return P(e.toJSON(), t + 1, r);
    if (Array.isArray(e)) return e.map((n) => P(n, t + 1, r));
    if (Object.getPrototypeOf(e) !== Object.prototype)
      return `[Object: ${("__class" in e && e.__class) || e.constructor?.name}]`;
    {
      let n = {};
      for (let [i, o] of Object.entries(e)) n[i] = P(o, t + 1, r);
      return n;
    }
  } catch (n) {
...
var q = ["trace", "debug", "info", "warn", "error"],
  Ht = ["\u{1F50D}", "\u{1F9EA}", "\u2139\uFE0F", "\u26A0\uFE0F", "\u274C"],
  Gt = [":trace", ":debug", ":info", ":warn", ":error"],
  Te = "logTimestamps",
  qt = /^T?\d{2}:\d{2}:\d{2}\.\d{3}Z /u;
function Se(e) {
...
function Le(e, t) {
  ...
  for (let n of e.split(/[ ,]/u)) {
    ...
    let a = new RegExp("^" + Ae(i).replace(/\\\*/gu, ".*") + "$"),
      u = 0;
    for (let c of t) c.id.match(a) && ((c.level = o), ++u);
    u === 0 && r.push(n);
  }
  return r;
}
var R = class e {
    constructor(t, r, n) {
      ...
      this.level = r;
      this.parts = n;
      ((this.id = e.nextId++), (this.time = Date.now()));
    }
    logger;
    level;
    parts;
    ...
    toMessage() {
      ...
      let t = [q[this.level] + ": [" + this.logger.id + "]"];
      (O && t.unshift(Se(this.time)), (this.stringPrefix = t.join(" ")));
      let r = this.parts[0];
      if (typeof r == "string") {
        let n = nr(r, this.logger.id, this.level);
        this.cachedMessage = [
  ...
  M = "*:app:info,app:info",
  O = !0,
  ve = typeof process < "u" && !!process.kill,
  Jt = ve && !1;
Jt ? (M = "-:warn") : ve && (M = "");
try {
  typeof window < "u" &&
    window.localStorage &&
    ((M = window.localStorage.logLevel || M), (O = window.localStorage[Te] !== "false"));
} catch {}
try {
  typeof process < "u" && (M = process.env.DEBUG || M);
} catch {}
try {
  typeof window < "u" && Object.assign(window, { setLogLevel: Re, setLogTimestamps: Oe });
} catch {}
try {
  typeof window < "u" &&
    window.postMessage &&
...
try {
  typeof window < "u" &&
    ...
    (Z = (e) => {
      try {
        let t = e.toMessage().map((s) => P(s)),
          r = e.logger,
          n = e.level,
          i = r.level <= e.level,
          o = { loggerId: r.id, level: n, parts: t, printed: i };
        window.parent?.postMessage(o, v().app);
      } catch {}
    });
} catch {}
var j = {},
...
function b(e, t, r) {
  let n = new R(e, t, r);
  for (y.push(n), Z?.(n); y.length > ke; ) y.shift();
  return n;
}
function Pe(e) {
  return (typeof e == "number" && (ke = e), y);
}
var Xt = /\/(?<filename>[^/.]+)(?=\.(?:debug\.)?html$)/u,
  be;
function Yt() {
  if (!(typeof window > "u" || !window.location))
    return ((be ??= Xt.exec(window.location.pathname)?.groups?.filename), be);
}
function A(e) {
  let t = Yt();
  e = (t ? t + ":" : "") + e;
  ...
  if (r) return r;
  let n = new V(e);
  return ((j[e] = n), Le(M, [n]), Z?.(new R(n, -1, [])), n);
}
function Qt() {
...
function Oe(e) {
  let t = O;
  O = e;
  for (let r of y) r.resetMessagePrefix();
  try {
    typeof window < "u" && window.localStorage && (window.localStorage[Te] = String(e));
  } catch {}
  return t;
}
function er() {
...
`),
  ...
  V = class {
    ...
    getBufferedMessages() {
      return y.filter((t) => t.logger === this);
    }
    setLevel(t) {
      let r = this.level;
    ...
    reportError = (t, r, n, i) => {
      let [o, s] = this.reportWithoutLogging(t, r, n, i),
        a = [s, o, n].filter(Boolean);
      this.error(...a);
    };
    reportErrorWithThrottle = (t, r, n, i, o) => {
      if (!rr(r)) return;
      let s = this.didLog[r.message];
      (s && s > Date.now()) ||
        ((this.didLog[r.message] = Date.now() + t), this.reportError(r, n, i, o));
    };
    reportErrorOncePerMinute = (t, r, n, i) => this.reportErrorWithThrottle(1e3 * 60, t, r, n, i);
    reportErrorOnceEveryTenMinutes = (t, r, n, i) =>
      this.reportErrorWithThrottle(1e3 * 60 * 10, t, r, n, i);
    reportCriticalError = (t, r, n) => this.reportError(t, r, n, !0);
  };
function rr(e) {
...
var or = /^local-module:([a-zA-Z\d]+\/[^:]+)(?::(.+))?$/u,
  ir = /^module:([a-zA-Z\d]{20})\/([a-zA-Z\d]{20})\/([^:]+)(?::(.+))?$/u;
function dn(e) {
  try {
    let t = e;
    switch (t) {
...
function D(e) {
  ...
  let t = e.match(or);
  if (t) {
    I(t[1], "The localId match from the module identifier should be defined.");
    let n = t[1],
      i = t[2];
    return w(n, i);
  }
  ...
  if (r) {
    let [, n, i, o, s] = r;
    return (
      I(n, "The moduleId match from the module identifier should be defined."),
      I(i, "The saveId match from the module identifier should be defined."),
      I(o, "The path match from the module identifier should be defined."),
      S(n, i, o, s)
    );
  }
}
function fr(e, t, r, n) {
  if (e.kind === "localModule") return S(t, r, n);
  if (e.kind === "localModuleExport") return S(t, r, n, e.exportSpecifier);
  E(e);
}
function pr(e, t) {
  if (e.kind === "externalModule") return w(t);
  if (e.kind === "externalModuleExport") return w(t, e.exportSpecifier);
  E(e);
}
function gr(e, t) {
  if (e.kind === "externalModule" || e.kind === "externalModuleExport")
    return S(e.moduleId, e.saveId, e.file, t);
  if (e.kind === "localModule" || e.kind === "localModuleExport") return w(e.localId, t);
  E(e);
}
function xr(e) {
  if (e.kind === "externalModule" || e.kind === "localModule") return e;
  if (e.kind === "externalModuleExport") return S(e.moduleId, e.saveId, e.file);
  if (e.kind === "localModuleExport") return w(e.localId);
  E(e);
}
function mr(e, t) {
...
function yr(e) {
  ...
  for (; s < i; ) {
    ...
    (++s,
      (u = ((u & 65535) * 3432918353 + ((((u >>> 16) * 3432918353) & 65535) << 16)) & 4294967295),
      (u = (u << 15) | (u >>> 17)),
      (u = ((u & 65535) * 461845907 + ((((u >>> 16) * 461845907) & 65535) << 16)) & 4294967295),
      (o ^= u),
      (o = (o << 13) | (o >>> 19)));
    let c = ((o & 65535) * 5 + ((((o >>> 16) * 5) & 65535) << 16)) & 4294967295;
    o = (c & 65535) + 27492 + ((((c >>> 16) + 58964) & 65535) << 16);
  }
  let a = 0;
  return (
...
var br = "text/html",
  N = "data-framer-html-import-extension";
function wr(e, t) {
  let r = {};
  if ((t.includes("text/html") && (r["text/html"] = e), !Sr(e))) return r;
  let i = new DOMParser().parseFromString(e, br);
  if (t.includes("application/x-framer-html-import-extension")) {
    let s = i.querySelectorAll(`[${N}]`);
    if (s) {
      let a = document.createElement("body");
      (s.forEach((u) => {
        let c = u.getAttribute(N);
        c && !a.getAttribute(N) && a.setAttribute(N, c);
        let x = u.firstChild;
        x && a.appendChild(x);
      }),
    ...
    o.length === 0 ||
      o.forEach((s) => {
        let a = s.dataset.framerPasteboard,
          u = s.dataset.framerPasteboardType;
        if (!a || !u || !t.includes(u)) return;
        let c = JSON.parse(a);
        r[u] = c;
      }),
    r
...
function Sr(e) {
  return e.includes(N) || e.includes("data-framer-pasteboard");
}
function Lr(e, t) {
  let r,
    n,
...
var _e = new Set();
function Q(e, ...t) {
  _e.has(e) || (_e.add(e), console.warn(e, ...t));
}
function vr(e, t, r) {
...
var $ = Symbol("missing"),
  ee = class {
    ...
    report(t, r, n, i) {
      ...
      let u = t.length > 0 ? t.join(".") : "(top)";
      this.results.push(`${u}: ${te(r)} != ${te(n)}${o}`);
    }
    reportDiff(t, r, n) {
...
`);
    ...
    diff(t, r, n, i) {
      ...
      if (o === "function") {
        ...
        for (let a = 0, u = Math.max(r.length, n.length); a < u; a++) {
          let c = r[a],
            x = n[a];
          if (c === x) continue;
          let T = c === void 0 && r.length <= a,
            m = x === void 0 && n.length <= a;
          if (T || m) {
            if (
              this.options.ignoreMissingOrUndefined &&
              ((T && x === void 0) || (m && c === void 0))
            )
              continue;
            this.report(t.concat(String(a)), T ? $ : c, m ? $ : x, i);
          } else this.diff(t.concat(String(a)), c, x, void 0);
        }
      } else if (o === "object") {
        if (!this.options.ignorePrototypes) {
          let m = Object.getPrototypeOf(r),
            d = Object.getPrototypeOf(n);
          m !== d && this.reportDiff(t.concat("prototype"), je(m), je(d));
        }
        let a,
          u,
          c = Ve,
          x = Ve;
        (F(r) ? ((a = r.keys()), (c = We)) : (a = Object.keys(r)),
          F(n) ? ((u = n.keys()), (x = We)) : (u = Object.keys(n)));
        let T = new Set([...a, ...u]);
        for (let m of T) {
          if (this.options.ignoreKeys?.(m)) continue;
          let d = !c(r, m),
            l = !x(n, m),
            f = r[m],
            p = n[m];
          if (d || l) {
            if (
              (this.options.ignoreMissingOrUndefined &&
                ((d && p === void 0) || (l && f === void 0))) ||
              (this.options.ignoreKnownDynamicKeys &&
                (m.startsWith("$control__") ||
                  m.startsWith("$componentPreset__") ||
                  m.startsWith("$plugin__")))
            )
              continue;
            this.report(t.concat(m), d ? $ : f, l ? $ : p, r);
          } else this.diff(t.concat(m), f, p, r);
        }
...
function je(e) {
  return e?.constructor?.name ?? te(e);
}
...
var Rr = Object.freeze(new Set());
function Or() {
  return Rr;
}
var Ar = Object.freeze(new Map());
function Dr() {
  return Ar;
}
function Nr(e) {
...
function zr(e = {}) {
  ...
  return (
    ...
    G.isLocal && t.get("duplicate") === "starter-template-empty-site" && t.delete("duplicate"),
...
((m) => {
  ...
  function n(d, l, ...f) {
    let p = d.length;
    if (l < 0 || l > p) throw Error("index out of range: " + l);
    let g = d.slice();
    return (g.splice(l, 0, ...f), g);
  }
  m.insert = n;
  function i(d, l, f) {
    let p = d.length;
    if (l < 0 || l >= p) throw Error("index out of range: " + l);
    let g = Array.isArray(f) ? f : [f],
      L = d.slice();
    return (L.splice(l, 1, ...g), L);
  }
  m.replace = i;
  function o(d, l) {
    let f = d.length;
    if (l < 0 || l >= f) throw Error("index out of range: " + l);
    let p = d.slice();
    return (p.splice(l, 1), p);
  }
  m.remove = o;
  function s(d, l, f) {
    let p = d.length;
    if (l < 0 || l >= p) throw Error("from index out of range: " + l);
    if (f < 0 || f >= p) throw Error("to index out of range: " + f);
    let g = d.slice();
    if (f === l) return g;
    let L = g[l];
    return (
      l < f ? (g.splice(f + 1, 0, L), g.splice(l, 1)) : (g.splice(l, 1), g.splice(f, 0, L)),
      g
    );
  }
  m.move = s;
  function a(d, l) {
    let f = [],
      p = Math.min(d.length, l.length);
    for (let g = 0; g < p; g++) f.push([d[g], l[g]]);
    return f;
  }
  m.zip = a;
  function u(d, l, f) {
...
((n) => {
  function e(i, o, s) {
    for (let a of Object.keys(i)) Hr(o, a) || delete i[a];
...
((i) => {
  ...
  function t(o, ...s) {
    let a = new Set(o);
    for (let u of s) a.delete(u);
    return a;
  }
  i.remove = t;
  function r(...o) {
    let s = new Set();
    for (let a of o) for (let u of a) s.add(u);
    return s;
  }
  i.union = r;
  function n(o, s) {
...
((n) => {
  function e(i, ...o) {
    let s = new Map();
    i.forEach((u, c) => s.set(c, u));
    let a = !1;
    for (let u of o) u && (u.forEach((c, x) => s.set(x, c)), (a = !0));
    return a ? s : i;
  }
  n.merge = e;
  function t(i, o, s) {
...
function re(e, t, r) {
  ...
  if (Array.isArray(e)) {
    for (let o = 0; o < e.length; o++) (re(e[o], t, r), t.push(","));
    return;
  }
  let i = F(e) ? e.keys() : Object.keys(e);
  i.sort();
  for (let o of i) {
    let s = e[o];
    (r && ((s = r(o, s, e)), s === void 0)) || (t.push(o), t.push(":"), re(s, t, r), t.push(","));
  }
}
function Zr(e, t) {
  let r = [];
  return (re(e, r, t), r.join(""));
}
var ne = A("task-queue"),
  oe = class {
    constructor(t, r) {
  ...
  ie = class {
    ...
    scheduleNewTasks(t) {
      ...
      ne.debug("scheduling:", this.name, this.incoming.length);
      let r = t + this.delay;
    ...
    run(t) {
      ...
      ne.debug("running:", this.name, n.length);
  ...
  se = class {
    ...
    setPriority(t) {
      return t === this.currentPriority
        ? this
        : (ne.debug("set priority:", this.currentPriority, "->", t),
    ...
    getTaskQueue(t, r) {
      ...
      if (n) {
        ...
        return (I(o, () => `queue ${t} with different options already exists`), n);
      }
      let i = new ie(this, t, r);
...
var ae = class {
  ...
  cancel() {
    (this.#e && (clearTimeout(this.#e), (this.#e = void 0)), (this.#t = void 0));
  }
  debounce(t = this.#n) {
    if (!this.#i) return;
    (this.#e && clearTimeout(this.#e),
      qe(this.#o) && qe(this.#t) && performance.now() - this.#t > this.#o
        ? ((this.#e = void 0), (this.#t = void 0), this.#r())
        : ((this.#e = window.setTimeout(() => {
            ((this.#e = void 0), (this.#t = void 0), this.#r());
          }, t)),
          (this.#t = this.#t ?? performance.now())));
  }
};
function Jr(e) {
  let t = new Map();
...
//# sourceMappingURL=chunk-FCG35XJJ.mjs.map
