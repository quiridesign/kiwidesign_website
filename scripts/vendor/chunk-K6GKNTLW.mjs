import { e as h, j as u, m as f, n as v } from "chunk-7BDHOKUE.mjs";
import { ne as C, zd as g } from "chunk-TNCOHSRV.mjs";
import { ia as T } from "chunk-FVJDO2XD.mjs";
import { b as a } from "chunk-4JY5UMT2.mjs";
var d = T("remote:verify");
function x(s, e, t, o) {
  let r = s.getPartialDocumentForPageIds(t),
    i = [],
    m = d.isLoggingTraceMessages() ? [] : void 0,
    c = g(r, null, { extraChecksAndFixes: !0, errors: i, warnings: m });
  (h("parsingRootNode"), a(c, () => `error loading root node: ${r.id} ${JSON.stringify(i)}`));
  for (let p of c.children ?? []) p.children && p.children.length > 0 && f(p, i);
  (i.length > 0 &&
    d.warn(
...
export { x as a, S as b, F as c, l as d, A as e };
//# sourceMappingURL=chunk-K6GKNTLW.mjs.map
