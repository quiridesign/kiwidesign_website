...
function $a(e) {
  let [t, r] = Zi(),
    i = n(Ns);
  return b(Bf, { ...e, layoutGroup: i, switchLayoutGroup: n(gf), isPresent: t, safeToRemove: r });
}
function eo(e, t, n) {
  let { props: r } = e;
...
function ws({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...a }, o) {
  ...
  return b(s, {
    ...
    ref: m,
    ignoreStrict: !0,
    children: b(Ap.Provider, { value: p, children: e }),
  });
}
function Ts(e, t) {
  ...
  return b(u, {
    ...
    onDrag: (e, t) => {
      let { velocity: n, point: i } = t,
        o = f[m].get();
      (g(r, o, n[m]), As(_.current, i[m], m, n[m]), a && a(e, t));
    },
    onDragEnd: (e, t) => {
      (Es(), o && o(e, t));
    },
    ...
    (o(),
      ...
      (tf = ({
        ...
        return (
          ...
          b(Fs.Provider, { value: _, children: e })
        );
      }),
      (nf = (e) => e.key || ``),
      (rf = ({
      ...
      (cf = ({ children: e, id: t, inherit: r = !0 }) => {
        ...
        return b(Ns.Provider, { value: d, children: e });
      }),
      (lf = a({ strict: !1 })),
      (uf = {
        animation: [
...
//# sourceMappingURL=motion.COIfRbRd.mjs.map
