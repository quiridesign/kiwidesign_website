import { a as x, b as _, d as B, e as V } from "chunk-SYDGG44Y.mjs";
import {
  d as w,
  e as A,
  f as k,
  ...
  o as j,
  p as N,
} from "chunk-CDVTF2SS.mjs";
import { Ia as U } from "chunk-SC3EIR2W.mjs";
import { f as m } from "chunk-TJWSXW2U.mjs";
import { q as L } from "chunk-F4RHXZMY.mjs";
import { i as D } from "chunk-BNJBFYWR.mjs";
import { Hd as g, k as l } from "chunk-YEI3MERI.mjs";
import { f as C } from "chunk-GWGM5D6M.mjs";
import { mn as b } from "chunk-QIEZ7GMD.mjs";
import { ca as T } from "chunk-DHUNMEBO.mjs";
import { a as I } from "chunk-F3T3XR66.mjs";
import { X as v, _a as y, ia as p, k as R } from "chunk-FCG35XJJ.mjs";
...
var h = class {
  ...
  redo(n) {
    this.changes.length !== 0 && n.applyChanges(this.changes);
  }
  undo(n) {
    this.changes.length !== 0 && n.applyReverseChanges(this.changes);
  }
};
var Q = class extends w {
  processScheduledEndUndoGroup(n) {
    ...
    this.undoBuffer.push(new h(D(t), n));
  }
};
var d = p("RemoteConnection"),
  ...
  u = class extends m.default {
    ...
    connect(n) {
      ...
      if (
        (e.searchParams.set("v", String(E)),
        e.searchParams.set("tunnel", I() ?? ""),
        e.searchParams.set("treeSchema", String(l)),
        e.searchParams.set("treeVersion", String(n)),
    ...
    async openSocketAsync(n, e) {
      ...
      e.aborted || this.openSocket(n, t);
    }
    openSocket(n, e) {
      let t = new WebSocket(n, e),
        o = new A();
      ...
      (t.addEventListener("open", () => {
        ...
        t.addEventListener("message", (s) => {
          ...
          let r = s.data,
            a = H(r);
          if ((o.received(r), a.type === "ack")) return o.acked();
  ...
  G = class extends m.default {
    constructor(e, t, o, c, s, r) {
      ...
      ((this.connection = new u(this.projectId, s)),
        ...
        (this.assetService = new T(this.api)),
        ...
        r?.addEventListener("abort", () => this.disconnect(), { once: !0 }));
    }
    treeStore;
    componentLoader;
    userId;
    ...
    createDataHandler() {
      ...
      return this.treeStore.mode === "crdt"
        ...
        : new j(this.treeStore.timeline, this.componentLoader, this.projectId, e, "on_page");
    }
    connect() {
    ...
    onDisconnect(e) {
      ...
      if ((this.shouldReconnect || F.warn("Disconnect:", e), this.shouldReconnect && M(e))) {
        let { delay: t, nextReconnectAttempt: o } = P(e, this.reconnectAttempt);
    ...
    downloadDocument(e, t) {
      ...
      let c = this.treeStore.mode,
        ...
        r = o.createLoader(e, t, s);
      ((this.documentLoader = r),
        r.on("loadedFirstData", (a) => {
          (a.setService("metadata", { projectId: this.projectId }),
            b(a, g(this.treeMode)),
            r.pauseLoadingScopes());
          let z = { isLoading: !0 };
          (o.setTree(a, t, z),
            o.processRemoteUpdates(),
            this.loadedPromise.resolve(),
            r.canvasTreeVersion < l && this.emit("disconnect", "ClientTooNew"),
            r.canvasTreeVersion > l && this.emit("disconnect", "ClientNeedsUpdate"));
        }),
        r.on("loadedAllData", () => {
...
export { h as a, Q as b, G as c, Ae as d };
//# sourceMappingURL=chunk-HHTXQWUR.mjs.map
