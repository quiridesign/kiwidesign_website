  ...
  let m = l(N, {
    children: l(M, {
      children: l(F, {
        ...
        collectionUtils: G,
        framerSiteId: K,
        notFoundPage: x(() => import(`./shared-lib.CrgGqxko.mjs`).then((e) => (e.i(), e.r))),
        ...
        loadSnippetsModule: new R(
          () => import(`./aohXcfCEH7eLshUz3Ru8hwERbjwVtxq5cCDnwgn579k.CYq1qmSc.mjs`)
        ),
  ...
  if (
    ...
    (U = {
      augiA20Il: {
        ...
        page: x(() => import(`./ekVYscVvFVtVo2nhksdXzAopUIe70HfHd9t8zPW_sPg.CR1tq5pt.mjs`)),
        path: `/`,
      },
    }),
    ...
    q &&
      v(() => {
        _(
          ...
          l(d, {}, l(p(() => import(`./shared-lib.CrgGqxko.mjs`).then((e) => (e.n(), e.t)))))
        );
      });
  })();
})();
export { B as getPageRoot };
//# sourceMappingURL=script_main.DboWPXd5.mjs.map
