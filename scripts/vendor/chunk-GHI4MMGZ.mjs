import { Fh as ve, Gh as be, qh as k, rh as we, th as A } from "chunk-KN3JEK6R.mjs";
import { a as pe } from "chunk-NFXHK276.mjs";
import {
  a as he,
  b as le,
  d as _,
  ...
  m as N,
  n as q,
} from "chunk-5XUSMOUJ.mjs";
import { a as $, b as fe, c as me, d as ge } from "chunk-427GIMUU.mjs";
import { a as ye } from "chunk-XF3FFSPM.mjs";
import { a as H, c as Se } from "chunk-QH5BKXZN.mjs";
import { Bd as T, Rd as ce, Td as O, pe as U } from "chunk-K6WOFN2G.mjs";
import { i as V, j as x, q as de } from "chunk-XO3S5WOW.mjs";
import { a as y } from "chunk-M5XSLRLD.mjs";
import { f as ne } from "chunk-2XMXWGLC.mjs";
import { a as j } from "chunk-CNMLD24G.mjs";
import { bs as E, hJ as ie, mn as ae, pd as oe, qd as se } from "chunk-IXMBKHRL.mjs";
import { y as z } from "chunk-YTTFBDRE.mjs";
import { e as re } from "chunk-LA34HORX.mjs";
import { j as te } from "chunk-FZGWLIPZ.mjs";
import { Ya as ee, ia as b } from "chunk-FVJDO2XD.mjs";
  ...
  Ie = class extends F {
    ...
    loadFirstCrdtTreeFromStore(e) {
      ...
      return (
        M(h, w) &&
          (w.forEach((l) => {
            (t.push(`${l.id}: code component links itself via ${l.stack}`), q(h, l.id, l.stack));
          }),
    ...
    async loadCrdtData(e = []) {
      ...
      for (let o = 0; o < I; ++o)
        try {
          ...
          if (!(s instanceof H) || !s.isTemporary || o === I - 1) throw s;
    ...
    resetForCrashRecovery(e) {
      ...
      return (
        M(a, u) &&
          (u.forEach((h) => {
            (t.push(`${h.id}: code component links itself via ${h.stack}`), q(a, h.id, h.stack));
          }),
...
//# sourceMappingURL=chunk-GHI4MMGZ.mjs.map
