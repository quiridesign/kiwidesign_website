import { b as v, c as I, e as q, f as E } from "chunk-SJOZY3GV.mjs";
import { a as T } from "chunk-NEU3O2NE.mjs";
import { a as N } from "chunk-K6L5GVTR.mjs";
import { f as w } from "chunk-GWGM5D6M.mjs";
import { Be as _, Zf as y, te as O, ze as m } from "chunk-VTFV5KUU.mjs";
import { a as p } from "chunk-QFU6OGL3.mjs";
import { i as k, k as d } from "chunk-MUZUMAGY.mjs";
import { a as b } from "chunk-JTCAKYEM.mjs";
import { b as h } from "chunk-LA34HORX.mjs";
import { a as V } from "chunk-W774OHJB.mjs";
import { q as f } from "chunk-FCG35XJJ.mjs";
...
function D({ href: e, actionText: t, tooltipId: r, content: o, image: a }) {
  return (0, i.jsx)(q, {
    icon: (0, i.jsx)(O, { className: z, title: "", children: (0, i.jsx)(A, {}) }),
    direction: "right",
    actions: e
      ? (0, i.jsx)(_, { as: "a", href: e, target: "_blank", onClick: () => C(r), children: t })
      : void 0,
    variant: "education",
    ...o,
    image: a,
...
function te({ href: e, actionText: t, tooltipId: r, content: o, image: a }) {
  let n = (0, $.useRef)(null),
    { triggerProps: c, tooltipProps: l } = y({
      className: F,
      direction: "top",
      interactive: !0,
      offset: ee,
...
//# sourceMappingURL=chunk-WBYI2HHK.mjs.map
