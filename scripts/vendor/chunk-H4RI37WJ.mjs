...
var l = { None: 0, Mutable: 1, Watching: 2, RecursedCheck: 4, Recursed: 8, Dirty: 16, Pending: 32 };
function P({ update: r, notify: e, unwatched: t }) {
  return { link: d, unlink: p, propagate: f, checkDirty: g, shallowPropagate: m };
  function d(n, i, a) {
    let u = i.depsTail;
...
var E = M(U(), 1),
  ...
  R = class {
    ...
    get() {
      ...
      if (this.flags & l.Dirty && this.update()) {
        let t = this.subs;
        t !== void 0 && F(t);
      }
    ...
    set(e) {
      ...
      ((this.pendingValue = e), (this.flags = l.Mutable | l.Dirty));
      let t = this.subs;
      return (t !== void 0 && N(t, !1), !0);
    }
    update() {
      return (
        (this.flags = l.Mutable),
...
var V = class {
  ...
  get() {
    ...
    let e = this.flags;
    if (e === l.None || e & l.Dirty) this.updateAndPropagate();
    else if (e & l.Pending) {
      let t = this.deps;
      t !== void 0 && W(t, this) ? this.updateAndPropagate() : (this.flags = e & ~l.Pending);
    }
  ...
  update() {
    let e = y;
    ((y = this), (this.depsTail = void 0), (this.flags = l.Mutable | l.RecursedCheck));
    try {
      T++;
      let t = this.compute();
      ...
      ((y = e), (this.flags &= ~l.RecursedCheck));
      let t = this.depsTail,
        d = t !== void 0 ? t.nextDep : this.deps;
      for (; d !== void 0; ) d = w(d, this);
    }
  }
  unwatch() {
...
var B = class {
  ...
  watch(e) {
    ...
    (e !== void 0 && k(e, this, T), this.deps !== void 0 && (this.flags = l.Watching));
  }
  unwatch(e) {
    ...
    for (; t !== void 0; ) {
      let d = t.prevDep;
      (t.dep === e && w(t, this), (t = d));
    }
    this.deps === void 0 && (this.flags = l.None);
  }
  notify() {
    this.flags = l.None;
    let e = S;
...
function $() {
  let r = x();
  return (v(H(r), "Expected VekterEngine"), r);
}
function H(r) {
  return r.name === "VekterEngine";
}
export { A as a, x as b, $ as c, H as d, P as e, z as f, J as g, q as h, Q as i };
//# sourceMappingURL=chunk-H4RI37WJ.mjs.map
