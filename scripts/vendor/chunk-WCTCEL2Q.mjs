...
var k = class {
  ...
  p = class {
    ...
    request(e, t, o) {
      ...
      if (r.signal) {
        if (r.signal.aborted) return Promise.reject(m());
...
function w(s, e, t) {
  ...
  return (
    ...
    L.request(s, { signal: r.signal }, async () => {
      ...
      (await t(r.signal), u[s] === r && delete u[s]);
    })
  );
}
export { q as a, L as b, w as c };
//# sourceMappingURL=chunk-WCTCEL2Q.mjs.map
