...
import { a as B } from "chunk-4QQP7OCQ.mjs";
import {
  EJ as ce,
  Id as Y,
  Kk as F,
...
import { j as v } from "chunk-SPICCGE6.mjs";
import { $ as _ } from "chunk-FCG35XJJ.mjs";
...
function uo(e, o, n) {
  ...
  return (
    ge(a, f) &&
      (f.forEach((s) => {
        (n.push(`${s.id}: code component links itself via ${s.stack}`), De(a, s.id, s.stack));
      }),
      (a = a.commit(o))),
    a
  );
...
function L(e, o, n, t) {
  ...
  e.set(n.id, n);
  let r = n.children;
  if (r) for (let i of r) L(e, o, i, n.id);
}
function be(e, o, n) {
  for (let t of o.walk())
    (P(t.isMutable()),
      I(t) && ye(e, t.id, new Set([t.id]), t, n),
      w(t) && Ce(e, t, t, n),
      M(t) && (Se(e, t, n), Ie(e, t, n)),
      T(t) && Me(t, n));
}
function Ee(e, o, n) {
  for (let t of o.walk()) (P(t.isMutable()), M(t) ? Ie(e, t, n) : T(t) && Me(t, n));
}
function ye(e, o, n, t, r) {
  function i(s) {
    if (!h(s)) return !1;
...
function Ce(e, o, n, t) {
  for (let r of n.walk())
    if (r !== n && H(r) && M(r)) {
      ...
      if (!i) continue;
      if (o === i) {
        (t.push(`${o.id}: template component links itself via ${n.id}`), K(r));
        continue;
      }
      Ce(e, o, i, t);
    }
  ...
  return r
    ? w(r)
      ? (o.originalid !== t &&
          ...
          (o.originalid = t)),
        r)
      : (n.push(`${o.id}: template references a node that is not a master: ${t}`), K(o), null)
    : (n.push(`${o.id}: template references a master that doesn't exist: ${t}`), K(o), null);
}
function Ie(e, o, n) {
...
function Io(e, o = xe()) {
  ...
  (B(e, R, n, t), (R = n), C?.emit("performance:mark", e, o));
}
function Mo(e, o, n = xe()) {
  if (!x()) return;
  let t = performance.now();
  (B(e, R, t, "post-loading"),
    (R = t),
...
//# sourceMappingURL=chunk-TJWSXW2U.mjs.map
