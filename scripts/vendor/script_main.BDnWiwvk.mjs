  ...
  let m = l(N, {
    children: l(M, {
      children: l(F, {
        ...
        collectionUtils: G,
        framerSiteId: K,
        notFoundPage: x(() => import(`./shared-lib.D5NU37tA.mjs`).then((e) => (e.i(), e.r))),
        ...
        loadSnippetsModule: new R(
          () => import(`./aohXcfCEH7eLshUz3Ru8hwERbjwVtxq5cCDnwgn579k.BWDL33o1.mjs`)
        ),
  ...
  if (
    ...
    (U = {
      augiA20Il: {
        ...
        page: x(() => import(`./m1X85NMBdRe_UgBCM8reInh043XXnwA7NDIH6HfVVl8.eWJb8GoB.mjs`)),
        path: `/`,
      },
    }),
    ...
    q &&
      v(() => {
        _(
          ...
          l(d, {}, l(p(() => import(`./shared-lib.D5NU37tA.mjs`).then((e) => (e.n(), e.t)))))
        );
      });
  })();
})();
export { B as getPageRoot };
//# sourceMappingURL=script_main.BDnWiwvk.mjs.map
