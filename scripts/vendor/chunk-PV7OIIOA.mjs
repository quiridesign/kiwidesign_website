import { a as ra } from "chunk-TWBE2LKT.mjs";
import { e as ta } from "chunk-S367SKHB.mjs";
import { a as nf } from "chunk-JO5QQGW4.mjs";
import {
  Ff as Js,
  Je as qs,
  Ke as Gs,
...
import { c as Ws, d as js } from "chunk-N3XW6TDN.mjs";
import { a as oa } from "chunk-42UZX245.mjs";
import { a as le } from "chunk-QFU6OGL3.mjs";
import { d as Bs } from "chunk-5WDLMAA7.mjs";
import { k as Yt } from "chunk-UCEQWTGT.mjs";
import { a as ri } from "chunk-KWIZ6NK4.mjs";
import { a as be } from "chunk-JTCAKYEM.mjs";
import { b as Qr, e as Vs, h as Ls, m as At, o as Dt, s as Ns } from "chunk-LA34HORX.mjs";
import { a as J } from "chunk-W774OHJB.mjs";
import { H as Jr, I as Fs, Y as Hs, q as $e } from "chunk-FVJDO2XD.mjs";
import { b as ti, c as _s } from "chunk-4JY5UMT2.mjs";
...
var sf = Object.defineProperty,
  ...
  Q = (e, t) => {
    for (var o in t || (t = {})) ia.call(t, o) && na(e, o, t[o]);
    if (en) for (var o of en(t)) sa.call(t, o) && na(e, o, t[o]);
    return e;
  },
  ae = (e, t) => af(e, uf(t)),
  Er = (e, t) => {
    var o = {};
    for (var r in e) ia.call(e, r) && t.indexOf(r) < 0 && (o[r] = e[r]);
    if (e != null && en) for (var r of en(e)) t.indexOf(r) < 0 && sa.call(e, r) && (o[r] = e[r]);
    return o;
  };
function Tt(...e) {}
function Zr(e, t) {
...
function Me(e, ...t) {
  let o = e,
    ...
    P = (R, k, _ = !1) => {
      ...
      let B = Zr(k, o[R]);
      if (B === o[R]) return;
      if (!_) for (let E of t) (F = E?.setState) == null || F.call(E, R, B);
      let b = o;
      o = ae(Q({}, o), { [R]: B });
      let O = Symbol();
      ((n = O), a.add(R));
    ...
    M = {
      getState: w,
      setState: P,
      __unstableInternals: { setup: d, init: v, subscribe: x, sync: h, batch: g, pick: S, omit: y },
    };
  return M;
}
function Se(e, ...t) {
...
var ff = Object.defineProperty,
  ...
  C = (e, t) => {
    ...
    if (tn) for (var o of tn(t)) ca.call(t, o) && aa(e, o, t[o]);
    return e;
  },
  D = (e, t) => mf(e, df(t)),
  j = (e, t) => {
    ...
    if (e != null && tn) for (var r of tn(e)) t.indexOf(r) < 0 && ca.call(e, r) && (o[r] = e[r]);
    return o;
  };
var la = H(J(), 1);
function no(e, t) {
...
function pf(e) {
  return !e || !(0, la.isValidElement)(e) ? !1 : "ref" in e.props || "ref" in e;
}
function fa(e) {
...
function Mr(e) {
  ...
  if (Te(e)) ((t = e.selectionStart || 0), (o = e.selectionEnd || 0));
    ...
    if (r?.rangeCount && r.anchorNode && fe(e, r.anchorNode) && r.focusNode && fe(e, r.focusNode)) {
...
function on(e) {
  return !!(e.currentTarget && !fe(e.currentTarget, e.target));
}
function Re(e) {
...
function fn(e, t, o) {
  let r = e.onLoadedMetadataCapture,
    n = (0, pe.useMemo)(() => Object.assign(() => {}, D(C({}, r), { [t]: o })), [r, t, o]);
...
var pi = !1,
  ...
  xa = 0;
function yf(e) {
  let t = e.movementX || e.screenX - ga,
    o = e.movementY || e.screenY - xa;
  return ((ga = e.screenX), (xa = e.screenY), t || o || !1);
}
function wf(e) {
  yf(e) && (pi = !0);
}
...
var je = H(J(), 1),
  mr = H(be(), 1);
function W(e) {
  let t = je.forwardRef((o, r) => e(D(C({}, o), { ref: r })));
...
function Ee(e = [], t = []) {
  let o = je.createContext(void 0),
    ...
    a = (c) =>
      e.reduceRight(
        (f, m) => (0, mr.jsx)(m, D(C({}, c), { children: f })),
...
var mo = Ee(),
  ...
  Pa = mo.ContextProvider,
  Ea = mo.ScopedContextProvider;
var vi = H(J(), 1),
  po = Ee([Pa], [Ea]),
  Vt = po.useContext,
  bv = po.useScopedContext,
  Ia = po.useProviderContext,
  xt = po.ContextProvider,
  er = po.ScopedContextProvider,
  Ma = (0, vi.createContext)(void 0),
...
var Lt = U(function (t) {
    ...
    ((0, Ze.useEffect)(() => {
      r && (za || (xe("mousedown", Ff, !0), xe("keydown", Hf, !0), (za = !0)));
    }, [r]),
      Wa &&
        (0, Ze.useEffect)(() => {
          if (!r) return;
          ...
          let A = Af(E);
          if (!A) return;
          let z = () => queueMicrotask(() => E.focus());
          for (let I of A) I.addEventListener("mouseup", z);
          return () => {
            for (let I of A) I.removeEventListener("mouseup", z);
          };
        }, [r]));
    let c = r && lt(a),
      f = !!c && !n,
    ...
    let d = yi(a.onKeyPressCapture, c),
      ...
      h = $((E) => {
        ...
        let N = Va(A.parentElement);
        (ja(N, !0),
          gt(A, "mouseup", () => {
            (A.removeEventListener("focusin", I, !0), ja(N, !1), !z && bn(A));
          }));
      }),
      g = (E, A) => {
        if ((A && (E.currentTarget = A), !r)) return;
        let z = E.currentTarget;
        z && nt(z) && (s?.(E), !E.defaultPrevented && ((z.dataset.focusVisible = "true"), l(!0)));
      },
      S = a.onKeyDownCapture,
      y = $((E) => {
        if ((S?.(E), E.defaultPrevented || !r || m || E.metaKey || E.altKey || E.ctrlKey || !Re(E)))
          return;
        let A = E.currentTarget;
        gt(A, "focusout", () => g(E, A));
      }),
      ...
      P = $((E) => {
        ...
        let A = E.currentTarget,
          z = () => g(E, A);
        wi || Rf(E.target) ? gt(E.target, "focusout", z) : l(!1);
      }),
      M = a.onBlur,
      R = $((E) => {
      ...
      b = r && Tf(F),
      O = a.style,
      T = (0, Ze.useMemo)(() => (f ? C({ pointerEvents: "none" }, O) : O), [f, O]);
    return (
      (a = D(
        C(
          {
...
var Lf = Symbol("command"),
  bo = U(function (t) {
    ...
    let [c, f] = (0, tr.useState)(!1),
      ...
      x = $((S) => {
        p?.(S);
        let y = S.currentTarget;
        if (S.defaultPrevented || d || l || !Re(S) || Te(y) || y.isContentEditable) return;
        let w = r && S.key === "Enter",
          P = n && S.key === " ",
          M = S.key === "Enter" && !r,
          R = S.key === " " && !n;
          ...
          if (w) {
            if (!k) {
              ...
              let _ = S,
                ...
                B = j(_, ["view"]),
                b = () => mi(y, B);
              li() ? gt(y, "keyup", b) : queueMicrotask(b);
            }
          } else P && ((m.current = !0), k || (S.preventDefault(), f(!0)));
        }
      }),
      h = i.onKeyUp,
      g = $((S) => {
        if ((h?.(S), S.defaultPrevented || d || l || S.metaKey)) return;
        let y = n && S.key === " ";
        if (m.current && y && ((m.current = !1), !qa(S))) {
          (S.preventDefault(), f(!1));
          let w = S.currentTarget,
            P = S,
            { view: M } = P,
            R = j(P, ["view"]);
          queueMicrotask(() => mi(w, R));
        }
      });
    return (
      (i = D(C(C({ "data-active": c || void 0, type: a ? "button" : void 0 }, v), i), {
        ref: ee(s, i.ref),
        onKeyDown: x,
        onKeyUp: g,
      })),
...
var wt = H(J(), 1),
  Ga = H(nf(), 1),
  { useSyncExternalStore: Ya } = Ga.default,
  Xa = () => () => {};
function ce(e, t = to) {
  let o = wt.useCallback((n) => (e ? Xt(e, null, n) : Xa()), [e]),
    r = () => {
...
function ho(e, t) {
  let o = wt.useRef({}),
    r = wt.useCallback((i) => (e ? Xt(e, null, i) : Xa()), [e]),
    n = () => {
      let i = e?.getState(),
        s = !1,
        a = o.current;
...
function Ke(e, t) {
  ...
  let n = wt.useCallback((a) => ce(o, a), [o]),
    i = wt.useMemo(() => D(C({}, o), { useState: n }), [o, n]),
    s = $(() => {
...
var Tr = U(function (t) {
    ...
    let d = Ae(m.id),
      ...
      _ = (0, Nt.useRef)(!1),
      F = $((I) => {
        if ((k?.(I), I.defaultPrevented || on(I) || !d || !r || Kf(I, r))) return;
        let { virtualFocus: q, baseElement: N } = r.getState();
        if (
          (r.setActiveId(d),
          uo(I.currentTarget) && Da(I.currentTarget),
          !q || !Re(I) || Bf(I.currentTarget) || !N?.isConnected)
        )
          return;
        (Ht() &&
          ...
          (_.current = !0),
          I.relatedTarget === N || dr(r, I.relatedTarget) ? Ta(N) : N.focus());
      }),
      B = m.onBlurCapture,
      b = $((I) => {
      ...
      A = $((I) => {
        ...
        let { currentTarget: q } = I,
          ...
          X = N.orientation !== "vertical",
          Oe = () => !!(Ce || X || !N.baseElement || !Te(N.baseElement)),
          Ue = {
            ArrowUp: (Ce || ye) && r.up,
            ArrowRight: (Ce || X) && r.next,
            ArrowDown: (Ce || ye) && r.down,
            ArrowLeft: (Ce || X) && r.previous,
            Home: () => {
            ...
            PageUp: () => Ja(q, r, r?.up, !0),
            PageDown: () => Ja(q, r, r?.down),
          }[I.key];
        if (Ue) {
          if (uo(q)) {
            let Ne = Mr(q),
              Ot = X && I.key === "ArrowLeft",
              $t = X && I.key === "ArrowRight",
              ct = ye && I.key === "ArrowUp",
      ...
      z = (0, Nt.useMemo)(() => ({ id: d, baseElement: S }), [d, S]);
    return (
      (m = ue(m, (I) => (0, Qa.jsx)(Ma.Provider, { value: z, children: I }), [z])),
      (m = D(C({ id: d, "data-active-item": y || void 0 }, m), {
        ref: ee(v, m.ref),
      ...
      (m = bo(m)),
      (m = hi(
        D(C({ store: r }, m), { getItem: R, shouldRegisterItem: d ? m.shouldRegisterItem : !1 })
      )),
      We(D(C({}, m), { "aria-setsize": w, "aria-posinset": P }))
    );
  }),
  Ci = Zt(
    W(function (t) {
...
function Za(e, t, o) {
  return $((r) => {
    var n;
    if ((t?.(r), r.defaultPrevented || r.isPropagationStopped() || !Re(r) || qf(r) || $f(r)))
      return;
    let i = e.getState(),
    ...
    let a = r,
      ...
      f = o?.current;
    (s !== f && s.focus(),
      pa(s, r.type, c) || r.preventDefault(),
      r.currentTarget.contains(s) && r.stopPropagation());
  });
}
function Gf(e) {
  return Ra(go(_r(Aa(e))));
}
function Yf(e) {
...
var Fr = U(function (t) {
    ...
    let x = Za(r, a.onKeyDownCapture, f),
      h = Za(r, a.onKeyUpCapture, f),
      g = a.onFocusCapture,
      S = $((b) => {
      ...
      M = $((b) => {
        ...
        ((f.current = null),
          Re(b) && I
            ? (z === A ? q && q !== z && fr(q, b) : A ? fr(A, b) : q && fr(q, b),
              b.stopPropagation())
    ...
    a = ue(a, (b) => (0, eu.jsx)(xt, { value: r, children: b }), [r]);
    let F = r.useState((b) => {
      var O;
      if (r && n && b.virtualFocus) return (O = yt(r, b.activeId)) == null ? void 0 : O.id;
    });
    a = D(C({ "aria-activedescendant": F }, a), {
      ref: ee(c, d, a.ref),
      onKeyDownCapture: x,
      onKeyUpCapture: h,
      onFocusCapture: S,
...
var xo = Ee(),
  ...
  tu = xo.ContextProvider,
  ru = xo.ScopedContextProvider;
var Pi = H(J(), 1),
  wo = Ee([tu], [ru]),
  Wb = wo.useContext,
  jb = wo.useScopedContext,
  Hr = wo.useProviderContext,
  ou = wo.ContextProvider,
  Vr = wo.ScopedContextProvider,
  nu = (0, Pi.createContext)(void 0),
...
var Co = U(function (t) {
    ...
    (Z(() => {
      ...
      Z(() => {
        let S;
        return (
          r?.setState("animated", (y) => ((S = y), !0)),
          () => {
            S !== void 0 && r?.setState("animated", S);
          }
        );
      }, [r]),
      Z(() => {
      ...
      Z(() => {
        if (!r || !d || !c || !v) return;
        let S = () => r?.setState("animating", !1),
          y = () => (0, uu.flushSync)(S);
        if ((c === "leave" && m) || (c === "enter" && !m)) return;
        if (typeof d == "number") return su(d, y);
        let {
          ...
          T = b + O;
        if (!T) {
          (c === "enter" && r.setState("animated", !1), S());
          return;
        }
        let E = 1e3 / 60,
          A = Math.max(T - E, 0);
      ...
      (i = ue(i, (S) => (0, Ei.jsx)(Vr, { value: r, children: S }), [r])));
    let x = pr(l, i.hidden, n),
      h = i.style,
      g = (0, Lr.useMemo)(() => (x ? D(C({}, h), { display: "none" }) : h), [x, h]);
    return (
      (i = D(
        C(
          {
...
function fu(e, t, o) {
  return (ot(t, [o.store]), me(e, o, "items", "setItems"), e);
}
var rm = { id: null };
function Bt(e, t) {
  return e.find((o) => (t ? !o.disabled && o.id !== t : !o.disabled));
...
function br(e = {}) {
  ...
  let a = (u = "next", c = {}) => {
    ...
    let l = s.getState(),
      {
        ...
        renderedItems: S = l.renderedItems,
        rtl: y = l.rtl,
      } = c,
      w = u === "up" || u === "down",
      P = u === "next" || u === "down",
    ...
    let T = x && (w ? x !== "horizontal" : x !== "vertical"),
      E = F && h && (w ? h !== "horizontal" : h !== "vertical"),
      A = P ? (!F || w) && T && g : w ? g : !1;
    if (T) {
      let I = E && !A ? k : mu(k, _.rowId),
        q = nm(I, v, A),
        N = Bt(q, v);
      return N?.id;
    }
...
function Nr(e, t, o) {
  return (
    (e = fu(e, t, o)),
    me(e, o, "activeId", "setActiveId"),
    me(e, o, "includesBaseElement"),
    me(e, o, "virtualFocus"),
    me(e, o, "orientation"),
    me(e, o, "rtl"),
    me(e, o, "focusLoop"),
...
var xn = H(J(), 1),
  ...
  vu = Eo.ContextProvider,
  bu = Eo.ScopedContextProvider,
  hu = (0, xn.createContext)(void 0),
  gu = (0, xn.createContext)(!1);
var cm = "hr",
  ki = U(function (t) {
    var o = t,
...
var lm = "hr",
  Ri = U(function (t) {
    ...
    return ((n = ki(D(C({}, n), { orientation: s }))), n);
  }),
  fm = W(function (t) {
    let o = Ri(t);
    return K(lm, o);
...
var Hi = U(function (t) {
    ...
    return (
      ...
      (0, et.useEffect)(() => {
        ...
        let y = 0,
          w = (P) => {
            ...
            if ((cancelAnimationFrame(y), M)) return Na(l);
      ...
      (u = ue(
        u,
        (y) => {
          if (((y = (0, Le.jsx)(Ti.Provider, { value: l || m, children: y })), !a)) return y;
          if (!l)
            ...
            children: [
              r &&
                ...
                (0, Le.jsx)(Oo, {
                  ...
                  onFocus: (P) => {
                    !(P.relatedTarget === S.current) && ht(P, l) ? or(h.current) : or(xi());
                  },
                }),
...
var wu = H(J(), 1),
  Vi = (0, wu.createContext)(0);
var Cu = H(J(), 1),
  Su = H(be(), 1);
function Pu({ level: e, children: t }) {
  let o = (0, Cu.useContext)(Vi),
    r = Math.max(Math.min(e || o + 1, 6), 1);
  return (0, Su.jsx)(Vi.Provider, { value: r, children: t });
}
var Eu = H(be(), 1),
  wm = "div",
  Li = U(function (t) {
    ...
    return ((n = ue(n, (i) => (0, Eu.jsx)(dn.Provider, { value: r, children: i }), [r])), n);
  }),
  Pg = W(function (t) {
    let o = Li(t);
    return K(wm, o);
...
function Pm(e, t, o) {
  return Cm.includes(t.tagName) || !Sm(e, t) ? !1 : !o.some((r) => r && fe(t, r));
}
function Ao(e, t, o, r) {
  for (let n of t) {
...
function Em(e, t = "") {
  return he(St(e, Wr(), !0), St(e, Wr(t), !0));
}
function Wi(e, t = "") {
  return he(St(e, Wr("", !0), !0), St(e, Wr(t, !0), !0));
}
function Do(e, t) {
  let o = Wr(t, !0);
  if (e[o]) return !0;
...
var Mn = H(J(), 1);
function Im(e) {
  return e.tagName === "HTML" ? !0 : fe(re(e).body, e);
}
function Mm(e, t) {
  if (!e) return !1;
  if (fe(e, t)) return !0;
...
var ft = H(J(), 1),
  Du = H(be(), 1),
  Au = (0, ft.createContext)({});
function Tu(e) {
  let t = (0, ft.useContext)(Au),
    [o, r] = (0, ft.useState)([]),
    n = (0, ft.useCallback)(
      (a) => {
        var u;
  ...
  return {
    wrapElement: (0, ft.useCallback)(
      (a) => (0, Du.jsx)(Au.Provider, { value: i, children: a }),
      [i]
    ),
    nestedDialogs: o,
  };
...
var On = H(J(), 1),
  _u = H(ri(), 1);
function Fu({ attribute: e, contentId: t, contentElement: o, enabled: r }) {
  let [n, i] = ln(),
    s = (0, On.useCallback)(() => {
      if (!r || !o) return !1;
      let { body: a } = re(o),
  ...
  return (
    (0, On.useEffect)(() => {
      ...
      let u = new MutationObserver(() => (0, _u.flushSync)(i));
...
function Vu(e, t, o) {
  ...
  (0, Hu.useEffect)(() => {
    ...
    let n = re(e),
      ...
      f = () => Ou(s, "--scrollbar-width", `${c}px`),
      m = km(s),
      l = () => Ro(a, { overflow: "hidden", [m]: `${c}px` }),
      d = () => {
        var p, x;
        let { scrollX: h, scrollY: g, visualViewport: S } = i,
          y = (p = S?.offsetLeft) != null ? p : 0,
          w = (x = S?.offsetTop) != null ? x : 0,
          P = Ro(a, {
            position: "fixed",
            overflow: "hidden",
...
function Ui(e, t) {
  ...
  if (kn()) return St(e, "inert", !0);
  let r = vo(e, !0).map((n) => {
    if (t?.some((s) => s && fe(s, n))) return Tt;
    let i = Br(
      n,
      "focus",
      () => (
  ...
  return he(...r, Nu(e), Ro(e, { pointerEvents: "none", userSelect: "none", cursor: "default" }));
}
function Bu(e, t) {
  let o = [],
    r = t.map((i) => i?.id);
  return (
    Ao(
      ...
      t,
      (i) => {
        In(i, ...r) || Lu(i, ...r) || o.unshift(Ui(i, t));
      },
      (i) => {
        i.hasAttribute("role") &&
          (t.some((s) => s && fe(s, i)) || o.unshift(ko(i, "role", "none")));
      }
    ),
    () => {
      for (let i of o) i();
...
var Kr = H(J(), 1),
  Rn = H(be(), 1);
function Wu({ store: e, backdrop: t, alwaysVisible: o, hidden: r }) {
  ...
  if (!t) return null;
  if ((0, Kr.isValidElement)(t)) return (0, Rn.jsx)(jr, D(C({}, a), { render: t }));
  let u = typeof t != "boolean" ? t : "div";
  return (0, Rn.jsx)(jr, D(C({}, a), { render: (0, Rn.jsx)(u, {}) }));
}
function To(e = {}) {
  return So(e);
}
...
var qi = U(function (t) {
  ...
  (Vu(T, B, d && !E), Ru(M, m, k));
  let { wrapElement: A, nestedDialogs: z } = Tu(M);
  ((y = ue(y, A, [A])),
    Z(() => {
      if (!b) return;
      let G = P.current,
        oe = Je(G, !0);
      oe && oe.tagName !== "BODY" && ((G && fe(G, oe)) || M.setDisclosureElement(oe));
    }, [M, b]),
    Ku &&
      (0, De.useEffect)(() => {
        if (!O) return;
    ...
    (0, De.useEffect)(() => {
      if (!a || !O || !k) return;
      let G = P.current;
      if (!(!G || G.querySelector("[data-dialog-dismiss]"))) return Iu(G, M.hide);
    }, [M, a, O, k]),
    Z(() => {
      if (!kn() || b || !O || !k) return;
      let G = P.current;
  ...
  Z(() => {
    ...
    let { disclosureElement: G } = M.getState(),
      oe = P.current,
      ke = q() || [],
      se = [oe, ...ke, ...z.map((Be) => Be.getState().contentElement)];
    return a ? he(ji(B, se), Bu(B, se)) : ji(B, [G, ...se]);
  }, [B, M, I, q, z, a, S]);
  let N = !!v,
    ve = ie(v),
    [Ce, ye] = (0, De.useState)(!1);
  (0, De.useEffect)(() => {
    if (!b || !N || !k || !T?.isConnected) return;
    let G =
        zu(x, !0) || T.querySelector("[data-autofocus=true],[autofocus]") || Ha(T, !0, u && F) || T,
      oe = Qe(G);
    ve(oe ? G : null) &&
      (ye(!0),
      queueMicrotask(() => {
        (G.focus(), Ku && oe && G.scrollIntoView({ block: "nearest", inline: "nearest" }));
      }));
  }, [b, N, k, T, x, u, F, ve]);
  let X = !!p,
    Oe = ie(p),
    [vt, Ue] = (0, De.useState)(!1);
  (0, De.useEffect)(() => {
      ...
      !k || !O
        ...
        : xe(
            ...
            (oe) => {
              ...
              (se.tagName === "BODY" || fe(ke, se) || !Be || fe(Be, se)) && Ot(oe) && M.hide();
            },
            !0
          ),
    [M, k, O, Ot]
  ),
    (y = ue(y, (G) => (0, mt.jsx)(Pu, { level: a ? 1 : void 0, children: G }), [a])));
  let $t = y.hidden,
    ct = y.alwaysVisible;
  y = ue(
    y,
    (G) =>
      c
        ? (0, mt.jsxs)(mt.Fragment, {
            children: [
              (0, mt.jsx)(Wu, { store: M, backdrop: c, hidden: $t, alwaysVisible: ct }),
              G,
            ],
          })
        : G,
  ...
  return (
    (y = ue(
      ...
      (G) =>
        (0, mt.jsx)(Vr, {
          value: M,
          children: (0, mt.jsx)(nu.Provider, {
            value: qt,
            children: (0, mt.jsx)(iu.Provider, { value: Gt, children: G }),
          }),
        }),
      [M]
    )),
    ...
    (y = Li(D(C({}, y), { autoFocusOnShow: Ce }))),
    (y = Co(C({ store: M }, y))),
    (y = Lt(D(C({}, y), { focusable: s }))),
    (y = Hi(D(C({ portal: u }, y), { portalRef: R, preserveTabOrder: F }))),
    y
  );
});
function hr(e, t = Hr) {
  ...
  let { x: r, y: n, platform: i, rects: s, elements: a, strategy: u } = e,
    ...
    g =
      m === "floating"
        ...
        : s.reference,
    S = await (i.getOffsetParent == null ? void 0 : i.getOffsetParent(a.floating)),
    y = (await (i.isElement == null ? void 0 : i.isElement(S)))
...
var Xu = (e) => ({
  ...
  async fn(t) {
    ...
    let R = y / 2 - w / 2,
      ...
      T = Dn(B, O, b),
      E =
        !u.arrow && gr(n) != null && O !== T && i.reference[v] / 2 - (O < B ? _ : F) - p[v] / 2 < 0,
      A = E ? (O < B ? O - B : O - b) : 0;
    return {
      [d]: l[d] + A,
              ...
              case "bestFit": {
                ...
                let A =
                  (b = _.filter((z) => {
                    ...
                    .map((z) => [
                      z.placement,
                      z.overflows.filter((I) => I > 0).reduce((I, q) => I + q, 0),
                    ])
    ...
    return (
      e === void 0 && (e = {}),
      {
        ...
        fn(t) {
          ...
          if (u) {
            let S = l === "y" ? "height" : "width",
              y = i.reference[l] - i.floating[S] + x.mainAxis,
              w = i.reference[l] + i.reference[S] - x.mainAxis;
            d < y ? (d = y) : d > w && (d = w);
          }
          if (c) {
            var h, g;
            let S = l === "y" ? "width" : "height",
      ...
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          ...
          let x = d - u.top - u.bottom,
            ...
            w = g,
            P = S;
          if ((m ? (P = f || y ? st(S, h) : h) : (w = f || y ? st(g, x) : x), y && !f)) {
            let R = ze(u.left, 0),
              k = ze(u.right, 0),
              _ = ze(u.top, 0),
              F = ze(u.bottom, 0);
            m
              ? (P = l - 2 * (R !== 0 || k !== 0 ? R + k : ze(u.left, u.right)))
...
function Et(e) {
  var t;
  return (t = (oc(e) ? e.ownerDocument : e.document) || window.document) == null
    ? void 0
    : t.documentElement;
}
function oc(e) {
...
function zt(e) {
  ...
  let t = e.assignedSlot || e.parentNode || (rc(e) && e.host) || Et(e);
  return rc(t) ? t.host : t;
}
function sc(e) {
  let t = zt(e);
  return wr(t) ? (e.ownerDocument ? e.ownerDocument.body : e.body) : dt(t) && Ur(t) ? t : sc(t);
}
function zr(e, t, o) {
  var r;
  ...
  if (i) {
    ...
    for (; p && r && d !== v; ) {
      let x = $r(p),
        ...
        g = ut(p),
        S = h.left + (p.clientLeft + parseFloat(g.paddingLeft)) * x.x,
...
function mc(e, t) {
  let o = zt(e);
  return o === t || !at(o) || wr(o) ? !1 : ut(o).position === "fixed" || mc(o, t);
}
function qm(e, t) {
  let o = t.get(e);
  if (o) return o;
...
function dc(e, t) {
  ...
  let r = uc(e, t);
  for (; r && nc(r) && Yi(r); ) r = uc(r, t);
  return r && wr(r) && Yi(r) && !Vn(r) ? o : r || ic(e) || o;
}
var Jm = async function (e) {
  let t = this.getOffsetParent || dc,
...
var yc = ec,
  wc = (e, t, o) => {
    let r = new Map(),
      n = { platform: Zm, ...o },
      i = { ...n.platform, _c: r };
    return Yu(e, t, { ...n, platform: i });
  };
var Nn = H(J(), 1),
  Ji = H(be(), 1),
  td = "div";
function Cc(e = 0, t = 0, o = 0, r = 0) {
...
function sd(e) {
  ...
  return (te(!t || t.every(nd), !1), hc({ padding: e.overflowPadding, fallbackPlacements: t }));
}
function ad(e) {
...
function cd(e, t) {
  if (e) return xc({ element: e, padding: t.arrowPadding });
}
var Qi = U(function (t) {
    var o = t,
      {
    ...
    let M = r.useState("arrowElement"),
      ...
      T = (0, Nn.useRef)(null),
      [E, A] = (0, Nn.useState)(!1),
      { portalRef: z, domReady: I } = Rr(i, w.portalRef),
      q = $(S),
      N = $(y),
      ve = !!y;
    (Z(() => {
      ...
      let ye = od(R, q),
        X = async () => {
          ...
          let Ue = M || T.current,
            Xe = [
              id(Ue, { gutter: x, shift: m }),
              sd({ flip: f, overflowPadding: g }),
              ad({ slide: l, shift: m, overlap: d, overflowPadding: g }),
              cd(Ue, { arrowPadding: h }),
              ud({ sameWidth: v, fitViewport: p, overflowPadding: g }),
            ],
            Ne = await wc(ye, _, {
              placement: B,
        ...
        vt = pc(
          ...
          _,
          async () => {
            ve ? (await N({ updatePosition: X }), A(!0)) : await X();
          },
    ...
    }, [r, O, _, M, R, _, B, b, I, c, f, m, l, d, v, p, x, h, g, q, ve, N]),
      Z(() => {
        if (!b || !I || !_?.isConnected || !F?.isConnected) return;
        let ye = () => {
          _.style.zIndex = getComputedStyle(F).zIndex;
        };
        ye();
        let X = requestAnimationFrame(() => {
          X = requestAnimationFrame(ye);
        });
    ...
    return (
      ...
      (w = ue(w, (ye) => (0, Ji.jsx)(rr, { value: r, children: ye }), [r])),
      (w = D(C({ "data-placing": !E || void 0 }, w), {
...
var Pe = H(J(), 1),
  ...
  ld = "div";
function Ec(e, t, o, r) {
  return it(t) ? !0 : e ? !!(fe(t, e) || (o && fe(o, e)) || r?.some((n) => Ec(e, n, o))) : !1;
}
function fd(e) {
  var t = e,
    { store: o } = t,
...
var Pc = (0, Pe.createContext)(null),
  Bn = U(function (t) {
    var o = t,
      {
        store: r,
      ...
      return b
        ? he(
            xe(
              ...
              (T) => {
                if (!r || !g()) return;
                let { anchorElement: E, hideTimeout: A, timeout: z } = r.getState(),
                  I = p.current,
                  [q] = T.composedPath(),
                  N = E;
                if (Ec(q, b, N, l)) {
                  ((p.current = q && N && fe(N, q) ? Pn(T) : null),
    ...
    let _ = (0, Pe.useContext)(Pc);
    Z(() => {
      if (n || !i || !R || !h) return;
      let b = m.current;
      if (b) return _?.(b);
    }, [n, i, R, h]);
    let F = (0, Pe.useCallback)(
      (b) => {
        d((T) => [...T, b]);
        let O = _?.(b);
        return () => {
    ...
    ((c = ue(
      ...
      (b) =>
        (0, Zi.jsx)(Sn, {
          value: r,
          children: (0, Zi.jsx)(Pc.Provider, { value: F, children: b }),
        }),
      [r, F]
    )),
      (c = D(C({}, c), { ref: ee(m, c.ref) })),
      (c = fd(C({ store: r }, c))));
    let B = r.useState((b) => n || b.autoFocusOnShow);
    return (
      (c = Qi(
        D(C({ store: r, modal: n, portal: i, autoFocusOnShow: B }, c), {
          portalRef: x,
          hideOnEscape(b) {
            return ur(s, b)
              ? !1
  ...
  es = U(function (t) {
    ...
    let c = i.onMouseMove,
      ...
      l = $((x) => {
        ...
        let { showTimeout: g, timeout: S } = r.getState(),
          y = () => {
            ((u.current = 0),
              m() &&
    ...
    return ((i = D(C({}, i), { ref: ee(p, i.ref), onMouseMove: l, onClick: v })), (i = Lt(i)), i);
  }),
  dd = W(function (t) {
    let o = es(t);
    return K(md, o);
...
function jn(e, t, o) {
  return (ot(t, [o.popover]), me(e, o, "placement"), $i(e, t, o));
}
function Bo(e = {}) {
  var t;
  let o = (t = e.store) == null ? void 0 : t.getState(),
...
function Kn(e, t, o) {
  return (me(e, o, "timeout"), me(e, o, "showTimeout"), me(e, o, "hideTimeout"), jn(e, t, o));
}
function Wo(e = {}) {
  let [t, o] = Ke(Bo, e);
  return Kn(t, o, e);
...
var vd = "div",
  Ko = U(function (t) {
    var o = t,
      ...
      n = j(o, ["store"]);
    let i = vr();
    return ((r = r || i), (n = D(C({}, n), { ref: ee(r?.setAnchorElement, n.ref) })), n);
  }),
  Dw = W(function (t) {
    let o = Ko(t);
    return K(vd, o);
...
var qr = H(J(), 1),
  ...
  ts = U(function (t) {
    ...
    return (
      ...
      (t = D(C({ role: !n && r !== "a" ? "button" : void 0 }, t), { ref: ee(o, t.ref) })),
      (t = bo(t)),
      t
    );
  }),
...
var Gr = H(J(), 1),
  ...
  rs = U(function (t) {
    ...
    return (
      (i = D(C(C({ "aria-expanded": u, "aria-controls": h?.id }, p), i), {
        ref: ee(a, i.ref),
        onClick: x,
      })),
      (i = ts(i)),
...
var Rc = H(be(), 1),
  ...
  ns = U(function (t) {
    ...
    return (
      (n = ue(n, (u) => (0, Rc.jsx)(rr, { value: r, children: u }), [r])),
      (n = D(C({}, n), { onClick: a })),
      (n = Ko(C({ store: r }, n))),
      (n = os(C({ store: r }, n))),
      n
...
var zo = U(function (t) {
    ...
    let a = i.onKeyDownCapture,
      ...
      c = $((f) => {
        ...
        if ((g.length && (p = fo(p, (w) => w.element)), !Cd(f, p))) return is();
        (f.preventDefault(),
          window.clearTimeout(u.current),
          (u.current = window.setTimeout(() => {
            Ut = "";
          }, 500)));
        let S = f.key.toLowerCase();
        ((Ut += S), (p = Pd(p, S, d)));
        let y = p.find((w) => zn(w, Ut));
        y ? r.move(y.id) : is();
      });
    return ((i = D(C({}, i), { onKeyDownCapture: c })), We(i));
  }),
  Ed = W(function (t) {
    let o = zo(t);
    return K(yd, o);
...
function Md(e) {
  let t = Tc(e);
  return t ? fe(e.currentTarget, t) : !1;
}
...
var Uo = U(function (t) {
    ...
    let u = Ar(),
      ...
      p = (0, Dc.useCallback)((x) => {
        x && (x[ss] = !0);
      }, []);
    return ((s = D(C({}, s), { ref: ee(p, s.ref), onMouseMove: m, onMouseLeave: v })), We(s));
  }),
  kd = Zt(
    W(function (t) {
      let o = Uo(t);
...
var Rd = (0, _c.createContext)(void 0);
var Un = H(J(), 1),
  Fc = H(be(), 1),
  Ad = "div";
function Dd(e) {
...
var cs = U(function (t) {
    ...
    s = ue(s, (M) => (0, Fc.jsx)(us, { value: r, children: M }), [r]);
    let g = Dd(C({ store: r }, s)),
      S = r.useState("mounted"),
      y = pr(S, s.hidden, n),
      w = y ? D(C({}, s.style), { display: "none" }) : s.style;
    s = D(C({ id: m, "aria-labelledby": g, hidden: y }, s), {
...
var It = H(J(), 1),
  ...
  Fd = U(function (t) {
      ...
      return (
        w((A) => {
          ...
          switch (M) {
            case "first":
              N.current =
                ((I = k.find((ve) => !ve.disabled && ve.element)) == null ? void 0 : I.element) ||
                null;
              break;
            case "last":
              N.current =
                ((q = [...k].reverse().find((ve) => !ve.disabled && ve.element)) == null
                  ? void 0
                  : q.element) || null;
              break;
            default:
    ...
    return (
      T !== void 0 && (f = C({ preserveTabOrderAnchor: T }, f)),
      (f = Bn(
        D(
          C(
            { store: r, alwaysVisible: c, initialFocus: y, autoFocusOnShow: F ? B && a : P || !!_ },
            f
          ),
          {
            hideOnEscape(E) {
            ...
            hideOnHoverOutside(E) {
              ...
              return (typeof u == "function" ? u(E) : (u ?? (p ? !0 : x ? (A ? !it(A) : !0) : !1)))
                ? E.defaultPrevented || !p || !A || (da(A, "mouseout", E), !it(A))
                  ? !0
                  : (requestAnimationFrame(() => {
                      it(A) || r?.hide();
                    }),
...
var Ld = U(function (t) {
    ...
    let c = (0, Vc.useRef)(null),
      ...
      h = $((F) => {
        ...
        Hc(B, F.currentTarget) && p();
      }),
      g = ce(r, (F) => F.placement.split("-")[0]),
      S = a.onKeyDown,
      y = $((F) => {
        if ((S?.(F), v || F.defaultPrevented)) return;
        let B = Vd(F, g);
    ...
    ((a = ue(a, (F) => (0, ls.jsx)(qo, { value: r, children: F }), [r])),
      l && (a = D(C({}, a), { render: (0, ls.jsx)(jr.div, { render: a.render }) })));
    let M = Ae(a.id),
      R = ce(f?.combobox || f, "contentElement"),
      k = l || d ? co(R, "menuitem") : void 0,
      _ = r.useState("contentElement");
    return (
      (a = D(C({ id: M, role: k, "aria-haspopup": Qt(_, "menu") }, a), {
        ref: ee(c, a.ref),
        onFocus: h,
        onKeyDown: y,
        onClick: P,
...
function Gn(e = {}) {
  let t = Pr(e);
  return (0, jc.jsx)(qo, { value: t, children: e.children });
}
var jd = "hr",
  Kd = U(function (t) {
    var o = t,
...
var Gd = U(function (t) {
    ...
    ((0, _e.useEffect)(() => {
      ...
      (0, _e.useEffect)(() => {
        if (!_ || !F || !T || !Kc(E, T, k) || !zc(b, T)) return;
        let ne = Tt;
        return (
          queueMicrotask(() => {
            let we = y.current;
    ...
    ((0, _e.useEffect)(() => {
      ...
      let ne = () => {
        ...
        we = () => {
          ...
          rt !== null && rt !== ve.current && (M.current = !1);
        },
    ...
    (ot(() => {
      ...
      if (!(Ie && !nt(Ie))) {
        ...
        if (k && we) {
          let Ve = N(E),
            sr = Ve !== void 0 ? Ve : (V = qd(E)) != null ? V : r.first();
          ((ve.current = sr), r.move(sr ?? null));
        } else {
    ...
    let ye = (V) => V.currentTarget.value.length >= u,
      ...
      vt = ie(a ?? !r.tag),
      Ue = $((V) => {
        if ((X?.(V), V.defaultPrevented || !r)) return;
        let ne = V.currentTarget,
          { value: we, selectionStart: Ie, selectionEnd: rt } = ne,
          Rt = V.nativeEvent;
        if (
          ((M.current = !0), Ud(Rt) && (Rt.isComposing && ((M.current = !1), (R.current = !0)), _))
        ) {
...
var Uc = U(function (t) {
    ...
    (x && h != null && (l = C({ "aria-selected": h }, l)),
      (l = ue(
        l,
        (b) =>
          (0, fs.jsx)(hu.Provider, {
            value: n,
            children: (0, fs.jsx)(gu.Provider, { value: h ?? !1, children: b }),
          }),
        [n, h]
      )));
    let F = (0, Jn.useContext)(yn);
    l = D(C({ role: Jd(F), children: n }, l), { onClick: R, onKeyDown: _ });
    let B = ie(f);
    return (
      (l = Tr(
        D(C({ store: r }, l), {
...
var Qn = H(J(), 1),
  ...
  $c = U(function (t) {
    ...
    let c = (0, Qn.useRef)(null),
      ...
      l = pr(m, i.hidden, n),
      d = l ? D(C({}, i.style), { display: "none" }) : i.style,
    ...
    (Z(() => {
      ...
      if (!P || y !== P) return;
      let M = () => {
          S(!!P.querySelector("[role='listbox']"));
        },
      ...
      g || (i = C({ role: "listbox", "aria-multiselectable": h }, i)),
      (i = ue(
        i,
        (P) =>
          (0, ms.jsx)(bu, {
            value: r,
            children: (0, ms.jsx)(yn.Provider, { value: p, children: P }),
          }),
        [r, p]
      )));
    let w = f && (!s || !u) ? r.setContentElement : null;
    return ((i = D(C({ id: f, hidden: l }, i), { ref: ee(w, c, i.ref), style: d })), We(i));
  }),
  Xo = W(function (t) {
    let o = $c(t);
    return K(Qd, o);
...
function tp(e) {
  let t = qc();
  return ((e = D(C({}, e), { tag: e.tag !== void 0 ? e.tag : t })), gn(e));
}
function rp(e, t, o) {
  return (
    ot(t, [o.tag]),
    me(e, o, "value", "setValue"),
    me(e, o, "selectedValue", "setSelectedValue"),
    me(e, o, "resetValueOnHide"),
    me(e, o, "resetValueOnSelect"),
...
function Zn(e = {}) {
  let t = ps(e);
  return (0, Yc.jsx)(vu, { value: t, children: e.children });
}
var He = H(J(), 1);
var Xc = 800,
  Jc = 0.9,
...
var Fe = H(be(), 1),
  ...
  Os = ({ menuHeight: e, children: t }) => {
    ...
    return e > i
      ...
      : (0, Fe.jsx)("div", { className: le(o && Ss), children: t });
  },
  ip = ({ children: e }) => {
    let t = Qo(),
      o = (0, Mt.useRef)(null),
    ...
    (Cs(
      ...
      (0, Mt.useEffect)(() => {
        ...
        return (
          s === "down" ? (p = setInterval(g, jl)) : clearInterval(p),
          s === "up" ? (x = setInterval(S, jl)) : clearInterval(x),
          () => {
    ...
    return (0, Fe.jsxs)("div", {
      className: El,
      children: [
        i && !u && (0, Fe.jsx)(zl, { direction: "up", onMouseEnter: l, onMouseLeave: v }),
        (0, Fe.jsx)(Gs, {
          ref: o,
          onWheel: v,
          className: le(i && Al),
          children: (0, Fe.jsxs)("div", {
            className: Hl,
            children: [
              (0, Fe.jsx)("div", { ref: r, className: Ll }),
              (0, Fe.jsx)("div", { className: le(t && Ss), children: e }),
              (0, Fe.jsx)("div", { ref: n, className: Nl }),
            ],
          }),
        }),
        i && !f && (0, Fe.jsx)(zl, { direction: "down", onMouseEnter: d, onMouseLeave: v }),
      ],
    });
  },
  zl = ({ direction: e, onMouseEnter: t, onMouseLeave: o }) =>
    (0, Fe.jsxs)(Zo, {
      gap: 0,
      className: e === "up" ? kl : Rl,
      children: [
        e === "down" && (0, Fe.jsx)("div", { className: _l }),
        (0, Fe.jsx)("div", {
          role: "presentation",
          ...
          onMouseLeave: o,
          className: Fl,
          children: (0, Fe.jsx)($s, { direction: e }),
        }),
        e === "up" && (0, Fe.jsx)("div", { className: Tl }),
      ],
    });
var ei = H(J(), 1);
var sp = !0;
      ...
      let p = Qr(s) && !!n,
        ...
        S = de.useMemo(() => {
          let P = Jr() ? Yt.values.contentItemHeight : Yt.values.contentItemHeightTouch,
            M = 0,
            R = Zc + Yt.values.menuGap * 2;
          for (let k of t) {
            let F = k.type === "separator" ? R : P;
            M += F;
          }
          return M;
        }, [t]),
        ...
        w = (0, L.jsxs)(Gn, {
          ...
          children: [
              ...
              (0, L.jsxs)(qn, {
                ...
                render: (P) =>
                  (0, L.jsx)(Jl, {
                    ...P,
                    hasSubmenu: !0,
                    className: le(P.className, f && gs, f && f.padding !== "compact" && xs),
                  }),
                children: [
                  d.checked && (0, L.jsx)(ni, { className: vs, children: (0, L.jsx)(oi, {}) }),
                  f && (0, L.jsx)(Xl, { icon: f }),
                  (0, L.jsx)("span", { className: le(Yr, ar), children: o }),
                  m && (0, L.jsx)(Ql, { acceleratorLabelTokens: m }),
                  (0, L.jsx)("span", {
                    className: rl,
                    "aria-hidden": "true",
                    children: (0, L.jsx)(zs, {}),
            ...
            (0, L.jsx)($n, {
              ...
              ...r,
              [Gl]: !0,
              gutter: r?.gutter ?? (x ? Yt.values.menuPadding * 2 : Qc),
              shift: x ? Yt.values.menuPadding * -1 : void 0,
              className: le(pl, y && vl, r?.className, qs),
              style: { width: a },
              ...
              children: (0, L.jsx)(fp, {
                ...
                menuHeight: S,
                withinCombobox: p,
                children: (0, L.jsx)(hp, { items: t, onSelect: i, submenuPlacement: u }),
              }),
            }),
          ],
        });
...
var fp = de.memo(function ({
    ...
    return (
      ...
      i
            ...
            children: (0, L.jsxs)("div", {
              ...
              children: [
                (0, L.jsxs)("div", {
                  className: gl,
                  children: [
                    (0, L.jsx)("div", { className: yl, children: (0, L.jsx)(Us, {}) }),
                    (0, L.jsx)(Xn, {
                      ref: s,
                      autoFocus: !0,
                      autoSelect: !0,
                ...
                (0, L.jsx)(Os, {
                  ...
                  children: (0, L.jsx)(Xo, {
                    children: (0, L.jsx)(ea, {
                      ...
                      children:
                        r === 0
                          ? (0, L.jsx)("div", { className: wl, children: "No search results" })
                          : t,
                    }),
                  }),
                }),
        ...
        : (0, L.jsx)(Is, {
            withinCombobox: i,
            children: (0, L.jsx)(Os, { menuHeight: n, children: t }),
          })
    );
  }),
  mp = (e) => (0, L.jsx)(Yn, { ...e, className: le(dl, e.className) }),
  ql = 14,
  Xl = ({ icon: e }) => {
    let t = { height: e.height ?? ql, width: e.width ?? ql };
    return e.inlineSVG
      ? (0, L.jsx)("span", { className: bs, style: t, dangerouslySetInnerHTML: { __html: e.src } })
      : (0, L.jsx)("span", {
          className: bs,
...
var Jl = de.memo(
    de.forwardRef(function ({ ...t }, o) {
      let r = de.useRef(null);
      return (0, L.jsx)("div", {
        ref: r,
        className: le(el, Js),
        children: (0, L.jsx)(pp, { ref: o, wrapperRef: r, ...t }),
      });
    })
  ),
  pp = de.memo(
    de.forwardRef(function (
      ...
      let { closeOnSelect: y, startTime: w, mouseDidMove: P } = Bl(),
        M = Qo(),
        R = pt(),
        k = ks(l);
      ti(R, "MenuItem must be used inside a Menu");
      let _ = de.useRef(null),
        ...
        E = de.useCallback(
          (X) => {
            if (X.key === "ArrowRight" || X.key === "ArrowLeft")
              switch ((X.stopPropagation(), X.key)) {
                case "ArrowLeft": {
                  let Oe = m ? R?.parent : R;
                  if (Oe?.getState().items.length === 0) break;
                  (X.preventDefault(), Oe?.hide());
                  break;
                }
                case "ArrowRight": {
                  R && (X.preventDefault(), T());
                  break;
                }
                default:
                  _s(X.key);
            ...
            if (B && X.key === "Enter") {
              (X.preventDefault(),
                X.stopPropagation(),
                R.getState().open ? (b?.(dp(X)), R.hideAll()) : T());
              return;
            }
            g.onKeyDownCapture?.(X);
          },
          [m, R, g.onKeyDownCapture, B, T, b]
        ),
        A = de.useCallback(
          (X) => (!y || X.currentTarget.hasAttribute("aria-expanded") ? !1 : (R.hideAll(), !0)),
          [y, R]
        ),
        z = de.useCallback(
          (X) => {
            ...
            !B || !js(X.button) || (As(P, w) && (O.suppressFor(X.currentTarget), b?.(X), A(X)));
          },
          [b, A, w, P, O, B]
        ),
        I = de.useCallback(
          (X) => {
            O.consume(X.currentTarget) || b?.(X);
          },
          [b, O]
        ),
        q = Jr(),
      ...
      (c
        ...
        : u &&
          (N.children = (0, L.jsxs)("span", {
            className: Yr,
            children: [(0, L.jsx)(Xl, { icon: u }), N.children],
          })),
        f &&
          (N.children = (0, L.jsxs)(Zo, {
            ...
            children: [
              ...
              (0, L.jsx)("span", { className: al, children: f }),
            ],
          })),
        s &&
          !m &&
          ...
          (N.children = (0, L.jsxs)("span", {
            className: ul,
            children: [(0, L.jsx)(ni, { className: vs, children: (0, L.jsx)(oi, {}) }), N.children],
          })),
        a
          ? (N.children = (0, L.jsxs)(L.Fragment, {
              children: [
                (0, L.jsx)("span", { className: ar, children: N.children }),
                (0, L.jsx)(Ql, { acceleratorLabelTokens: a }),
              ],
            }))
          : r
            ? (N.children = (0, L.jsxs)(L.Fragment, {
                children: [
                  ...
                  i
                    ...
                    : (0, L.jsx)("span", { className: le(sl, n), children: r }),
                ],
              }))
            : m
              ? (N.children = (0, L.jsx)("span", { className: le(Yr, ar), children: N.children }))
              : (N.children = (0, L.jsx)("span", { className: le(cl, ar), children: N.children })));
      let ve = de.useCallback(
      ...
      let Ce = M
        ? (0, L.jsx)(Yo, { ...N, setValueOnClick: !1, value: o, selectValueOnClick: ve })
        : (0, L.jsx)(Go, { ...N });
      return d
        ? (0, L.jsxs)(L.Fragment, {
            children: [
              Ce,
              (0, L.jsx)(bp, { anchorRef: k && p ? h : _, className: v, children: d }),
            ],
          })
        : Ce;
    })
...
var bp = de.memo(function ({ anchorRef: t, className: o, children: r }) {
  let n = pt();
  ti(n, "MenuItemTooltip must be used inside a Menu");
...
function Ql({ acceleratorLabelTokens: e }) {
  ...
  return (0, L.jsx)("span", {
    ...
    children: e.map((r, n) => {
      ...
      return (0, L.jsxs)(
        "span",
        { className: nl, children: [r, i && (0, L.jsx)("span", { className: il, children: o })] },
        r
      );
    }),
  });
}
var hp = de.memo(({ items: e, onSelect: t, submenuPlacement: o }) => {
  let r = e.some((n) => n.type !== "separator" && n.checked === !0 && !n.icon);
  return e.map((n) => {
    let i = n.path.join("+");
    if (n.type === "separator") return (0, L.jsx)(mp, {}, i);
    let s = le(r && n.checked !== !0 && !n.icon && fl),
      a = xp(n);
    if (n.submenu) {
          ...
          wp(() => {
            ...
            (M && r?.(M),
              e?.config.onSelect
                ...
                : P.click
                  ? P.click()
                  : P.role && ta(P.role, { fromContextMenu: !0 }));
          }, o);
      },
      [e, r, o]
    ),
    S = (0, He.useCallback)((w) => a(w), []),
    y = (0, He.useMemo)(
      () => ({
        store: l,
        getAnchorRect: h,
        gutter: e?.config.gutter,
        className: le(bl, e?.config?.className),
        onKeyDown: n,
        onKeyUp: i,
      }),
...
//# sourceMappingURL=chunk-PV7OIIOA.mjs.map
