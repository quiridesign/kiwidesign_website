import { a as Ce } from "chunk-3PGNPVYW.mjs";
import { b as A } from "chunk-CICVJUAM.mjs";
import { b as fe, c as pe } from "chunk-TK747F2A.mjs";
import { b as de, c as me, d as ce, e as ue } from "chunk-RHLSOZ2K.mjs";
import { u as ie, v as ae, w as se } from "chunk-BNJBFYWR.mjs";
import { Ga as ne } from "chunk-YEI3MERI.mjs";
import { a as D } from "chunk-LAEJRDTJ.mjs";
import { g as le } from "chunk-FABF35V2.mjs";
import {
  Da as h,
  KG as te,
  Ko as Z,
...
import { sa as H, ua as V } from "chunk-FCG35XJJ.mjs";
...
function ve({
  ...
  let n = S(t.dynamicVectorSetIdentifier)
    ...
    s = R(n) ? n?.identifier : b(n) && V(n) ? n : void 0,
    a = V(s),
    l = o.id ?? Y(t.id),
    d = t.isVisible(),
    f = (0, ye.useRef)(null);
...
var W = class {
  ...
  resolveRichText(e) {
    v(T(e), "Pointer must be rich text");
    for (let o of ze(e)) {
...
function z(t, e) {
  if (T(t)) for (let o of Be(t)) e.add(o);
}
function Be(t) {
  if (b(t)) return x(t);
  let e = new Set();
...
//# sourceMappingURL=chunk-K7K4JNNE.mjs.map
