...
import { f as ln, g as cn, h as pn, i as An, k as ft } from "chunk-7R2WVAQG.mjs";
import { r as un } from "chunk-7C3SCFYK.mjs";
import { e as mt } from "chunk-7BDHOKUE.mjs";
import { fa as ht } from "chunk-7R2B67GQ.mjs";
import { h as Yo } from "chunk-Q3WX3LWW.mjs";
import { a as dn } from "chunk-D3SZBJZX.mjs";
import { b as L } from "chunk-O7GKUYSM.mjs";
import { a as $o, b as jo } from "chunk-QH5BKXZN.mjs";
import { cb as Ho, db as Vo, eb as zo } from "chunk-TNCOHSRV.mjs";
import { f as qo } from "chunk-P2KPH35U.mjs";
import { uh as me } from "chunk-XSTGUTXE.mjs";
import { a as ne, b as Bt } from "chunk-WCTCEL2Q.mjs";
import { b as Zo, c as en, e as tn, f as Q, g as yn } from "chunk-NMSN6DQX.mjs";
import { a as nn } from "chunk-CNMLD24G.mjs";
import {
  $A as bo,
  AC as Ro,
  AJ as Ae,
...
import { $ as De, f as ot, j as nt, ma as Se, va as Nr } from "chunk-YTTFBDRE.mjs";
import { o as q } from "chunk-AWX2NFXM.mjs";
import { a as tt } from "chunk-XD24P57D.mjs";
import { a as it } from "chunk-RNHTTH2C.mjs";
...
import { b as E, c as O } from "chunk-4JY5UMT2.mjs";
...
function vn(n, e) {
  ...
  if ((E(typeof t == "number", "fileUploadLimitInMB is not a number"), e / ht >= Yo))
...
function Tr(n) {
  ...
  return (
    E(e !== void 0 && t !== void 0, "Image asset missing width/height"),
...
var se = class {
    ...
    async run(e, t) {
      if (this.#e === this.limit) {
        ...
        (t && (o = Promise.race([o, Lr(t)])), await o);
      }
      (Qn(t), this.#e++);
      try {
        return await e();
...
async function kr(n, e) {
  ...
  (await Promise.allSettled(e), Rr(n.status.failed), L({ type: "remove", key: t }));
}
function Rr(n) {
  n <= 0 ||
    L({
      ...
      secondaryText: (0, _.jsxs)("span", {
        className: me,
        children: [n, " ", (0, wn.default)("image", n), "."],
      }),
      duration: 5e3,
    });
}
var xr = /["&'<>`]/g,
  Ur = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
  Kr = /[\x01-\t\v\f\x0E-\x1F\x7F\x81\x8D\x8F\x90\x9D\xA0-\uFFFF]/g,
  Or = /[|\\{}()[\]^$+*?.]/g,
  Nn = new WeakMap();
function Tn(n, e) {
  if (((n = n.replace(e.subset ? Gr(e.subset) : xr, o)), e.subset || e.escapeOnly)) return n;
  return n.replace(Ur, t).replace(Kr, o);
  function t(r, s, i) {
    return e.format(
...
function Gr(n) {
  let e = Nn.get(n);
  return (e || ((e = Wr(n)), Nn.set(n, e)), e);
}
function Wr(n) {
  let e = [],
    t = -1;
  for (; ++t < n.length; ) e.push(n[t].replace(Or, "\\$&"));
  return new RegExp("(?:" + e.join("|") + ")", "g");
}
var Jr = /[\dA-Fa-f]/;
function bn(n, e, t) {
  let o = "&#x" + n.toString(16).toUpperCase();
  return t && e && !Jr.test(String.fromCharCode(e)) ? o : o + ";";
}
var _r = /\d/;
function Ln(n, e, t) {
  let o = "&#" + String(n);
  return t && e && !_r.test(String.fromCharCode(e)) ? o : o + ";";
}
var Pn = [
  "AElig",
  "AMP",
...
var Rn = {}.hasOwnProperty,
  It = {},
  Pe;
for (Pe in Le) Rn.call(Le, Pe) && (It[Le[Pe]] = Pe);
var Hr = /[^\dA-Za-z]/;
function xn(n, e, t, o) {
  ...
  if (Rn.call(It, r)) {
    ...
    return t &&
      Pn.includes(s) &&
      !kn.includes(s) &&
      (!o || (e && e !== 61 && Hr.test(String.fromCharCode(e))))
      ? i
      : i + ";";
  }
  return "";
...
function Kn(n, e, t, o) {
  return o.settings.bogusComments
    ? "<?" + x(n.value, Object.assign({}, o.settings.characterReferences, { subset: zr })) + ">"
    : "<!--" + n.value.replace(Vr, r) + "-->";
  function r(s) {
    return x(s, Object.assign({}, o.settings.characterReferences, { subset: qr }));
  }
}
function On(n, e, t, o) {
  return (
...
function ke(n) {
  return e;
  function e(t, o, r) {
    return $r.call(n, t.tagName) && n[t.tagName](t, o, r);
  }
}
var he = ke({
  body: Xr,
...
var _n = ke({ body: cs, colgroup: ps, head: ls, html: ds, tbody: As });
function ds(n) {
  let e = T(n, -1);
...
function xe(n, e, t, o) {
  return t && t.type === "element" && (t.tagName === "script" || t.tagName === "style")
    ? n.value
    : x(n.value, Object.assign({}, o.settings.characterReferences, { subset: hs }));
}
function Vn(n, e, t, o) {
...
var qn = Io("type", {
  invalid: gs,
  unknown: Cs,
  handlers: { comment: Kn, doctype: On, element: Hn, raw: Vn, root: zn, text: xe },
});
function gs(n) {
...
function Os(n) {
  return !n || n.length === 0
    ? !1
    : [Ds, Ss, Fs, Qs, ws, Ns, Ts, bs, Ls, Ps, ks, Rs, xs, Us, Ks].some((t) => t.test(n));
}
function rd(n) {
  return Os(n) ? Yn(n) : n;
}
function Yn(n, { singleNewlinesAsHardBreaks: e = !0 } = {}) {
  let t = Et();
  return (
    t.use(Cn),
    e && t.use(Ke),
...
var Gs = [
  ...
  ld = (n, e) => {
    ...
    let t = 1,
      o = n.replace(/_\d+$/u, ""),
      r = n;
    for (; e.includes(r) || Vs(r); ) ((r = `${o}_${t}`), t++);
    return r;
  },
  Vs = (n) => Gs.includes(n) || (window.hasOwnProperty(n) && !Ws.includes(n));
function Qt(n, e) {
  if (!e) return null;
  let t = e.trim();
  ...
  let o = n === "selector" ? "_" : "$";
  if (n === "directory") {
    if (Hs.test(t)) return null;
  } else Js.test(t) || (t = o + t);
  return ((t = t.replace(_s, "_")), (t = t.replace(/_+/gu, "_")), (t = t.replace(/^\$_/u, o)), t);
}
function ie(n) {
...
function Qd(n, e = "component", t = !0) {
  n = n.trim();
  let { dirName: o, name: r, extension: s } = er(n, t);
  if (ae(s) && s !== H) {
    let u = r + s;
    return { path: wt(o, u), content: "" };
  }
  let i = e === "component" ? jn(r) : Xn(r),
    a = js(r + s, i.name);
...
var ei = new Uint8Array(new Uint16Array([1]).buffer)[0] === 1;
function Tt(n, e = "@") {
  if (!S) return bt.then(() => Tt(n));
  let t = n.length + 1,
    o = (S.__heap_base.value || S.__heap_base) + 4 * t - S.memory.buffer.byteLength;
  o > 0 && S.memory.grow(Math.ceil(o / 65536));
  let r = S.sa(t - 1);
  if (((ei ? oi : ti)(n, new Uint16Array(S.memory.buffer, r, t)), !S.parse()))
    throw Object.assign(
      new Error(
        `Parse error ${e}:${
          n.slice(0, S.e()).split(`
...
async function sr(n, e) {
  ...
  for (let { s: i, e: a, d: u } of s) {
    if (u === -2) continue;
    if (u === -1) {
      let C = n.substring(i, a);
      if (!C.startsWith(".")) continue;
      let p = e[C];
      (p === void 0 && (r.add(C), (p = rr(C))), (o = nr(o, p, i, a)));
      continue;
    }
...
function ir(
  ...
  for (let l of e) {
    ...
    if (!c || s?.(c)) continue;
    let g = t(c);
    tt(g, `Dependency module ${c} must exist to replace relative import`);
    let { id: A, files: f, localId: m } = g,
      C = o?.(c) ?? g.saveId,
      p = r?.(c) ?? f.module;
    (tt(W(p), "Must have a module file name to build a local module import map specifier."),
      (u[l] = a ? Me(m, p) : `${d}/${A}/${C}/${p}`));
  }
  return u;
}
function nr(n, e, t, o) {
...
function jd(n) {
  switch (n) {
    ...
    case "webhook":
      return { type: "webhook", webhookUrl: void 0, secret: "", fallbackEmail: Rt.email, id: Fe() };
    case "googlesheet":
      return {
        type: "googlesheet",
...
function ii(n, e) {
  ...
  return t ? [t] : [si("spam_protection")];
}
function rl(n, e, t) {
  let o = ii(n, e);
  return t ? o : o.map((r) => ai(r, t));
}
function ai(n, e) {
...
var xt = "type",
  ui = "provider",
  di = { type: !0, id: !0, emails: !0, subject: !0, body: !0, name: !0 };
function sl(n) {
  for (let e in n) if ((e === xt && n[e] !== "verifiedEmail") || !(e in di)) return !1;
  return !0;
}
var li = { type: !0, id: !0, webhookUrl: !0, fallbackEmail: !0, secret: !0 };
function il(n) {
  for (let e in n) if ((e === xt && n[e] !== "webhook") || !(e in li)) return !1;
  return !0;
}
var ci = { type: !0, id: !0, documentName: !0, documentId: !0, fallbackEmail: !0 };
function al(n) {
  for (let e in n) if ((e === xt && n[e] !== "googlesheet") || !(e in ci)) return !1;
  return !0;
}
var pi = { provider: !0, filtering: !0, mode: !0 };
function ul(n) {
  for (let e in n) if ((e === ui && n[e] !== "spam_protection") || !(e in pi)) return !1;
  return !0;
}
var Ai = "New Submission",
  mi = "You\u2019ve just received a new submission.";
function ll(n, e) {
...
function Ut(n) {
  ...
  if (!n) return e;
  if (ee(n) && go(n)) {
    let t = dr(n.layoutTemplateIdentifier);
    t && e.add(t);
  }
  for (let { node: t, skipChildren: o } of n.walkWithSkipChildren()) {
    ...
    let r = dr(t.codeComponentIdentifier);
    r && e.add(r);
  }
  return e;
}
...
function fi(n) {
  return rt(n, "analysis") && rt(n, "packageConfigs");
}
var Ce = Z("modules-divergence-reporter"),
  gi = 2,
  Ci = [1e3, 2e3, 4e3, 8e3, 16e3, 32e3],
  Ei = 10 * 6e4,
  yi = 1e4;
function Bi(n) {
...
var Je = class {
  ...
  constructor(e) {
    ((this.sample = e.sample),
      ...
      (this.consecutiveThreshold = e.consecutiveThreshold ?? gi),
      (this.settleBackoffMs = e.settleBackoffMs ?? Ci),
      (this.slowIntervalMs = e.slowIntervalMs ?? Ei),
      (this.fastIntervalMs = e.fastIntervalMs ?? yi),
...
var _e = class {
  ...
  getImportUrlForDependency(e, t) {
    let o = e.imports[t];
    if (o) return o;
    let r = Object.keys(e.imports).find((s) => vi(s, t));
...
function Ot(n) {
  return (n instanceof $o || n instanceof z) && n.status === jo.NotFound;
}
function pr(n) {
...
function Ic(n) {
  return n && (n.type === "codeFile" || n.type === "shader")
    ? (E(W(n.sourceContent), `${n.type} module entry is missing source content`), !0)
    : !1;
}
function Gt(n) {
...
var Qi = 1e4,
  ...
  Ve = "update-modules-storage",
  wi = 10,
  Cr = new Set(["codeFile", "shader"]);
function Ni(n) {
  return Cr.has(n) ? Cr : new Set([n]);
}
var Ti = 0;
async function F(n) {
  let e = performance.now(),
    t = `acquire-modules-storage-lock-${Ti++}`;
  return Bt.request(Ve, () => {
    let o = performance.now(),
      r = o - e;
    return (
      nn(t, e, o, "vekter"),
      B.debug("\u{1F513} Acquired the", Ve, "lock in", r.toFixed(2), "ms"),
      r > 1e3 &&
        B.warn("\u2757 Long wait: it took", r.toFixed(0), "ms to acquire the", Ve, "lock."),
      n()
    );
  });
}
var qe = class {
    ...
    get id() {
      ...
      return (E(t, "Module must exist"), t.moduleId);
    }
    get saveId() {
      ...
      return (E(t, "Module must exist"), t.saveId);
    }
    get localSVGIcon() {
      let e = this.storage.getTransientSaveByLocalId(this.localId);
    ...
    externalModuleIdentifier(e = "default") {
      ...
      return (
        E(o?.files.module, "ModulesStorage: Expected module typed file in persisted module."),
    ...
    annotations(e, t) {
      ...
      return (
        e && this.debugModuleStoreAndComponentLoaderRevisionsMatch() && bi(r, e),
        t ? r?.[t] : r
      );
    }
...
function bi(n, e) {
  ...
  (E(Be(t) && Yt(t), "Entity must have an identifier."),
    e.annotations &&
...
var Ht = class extends qe {
  ...
  Er = class {
    ...
    getByLocalId(e) {
      return new Ht(this.storage, e, this.type, this.moduleStoreAndComponentLoaderRevisionsMatch);
    }
    getUniqueName(e) {
...
var yr = { revision: -1, controlsByLocalId: new Map() };
function Br(n, e) {
...
function Pi(n, e) {
  if (q.isOn("crdtModuleControls")) {
    ...
    if (n.propertyControls !== void 0) return ur(n.propertyControls);
...
var Mr = class n {
  ...
  capturePreparedPropertyControlsSnapshot(e) {
    return e ? (this.capturePropertyControlsSnapshot?.() ?? yr) : yr;
  }
  ...
  async sampleModulesTreeBackendDivergences() {
    return F(async () => {
      ...
      return { kind: "sampled", divergences: cr(e, t) };
    });
  }
  ...
  async syncLocalModules() {
    ...
    for (let r of e) {
      ...
      (gr(a, i) && !u) ||
        (Fi(r) && gr(this.dependenciesModule, i)) ||
  ...
  updateNode(e, t, o, r, s) {
    ...
    let a = r.metadata.pluginId,
      ...
      d = on(u?.default?.framerTrackingIds);
    ...
    let l = {
      ...
      name: r.name,
      type: r.type,
      sourceRevision: r.sourceRevision ?? Fr(r.metadata),
      annotations: u,
      propertyControls: Pi(r, i.save.propertyControls),
    ...
    if (
      ...
      g?.children?.forEach((f) => {
        let m = f.sourceNodeId ?? f.scopeId,
          C = so(f.sourceNodeModuleType) || r.type === f.sourceNodeModuleType;
        !m || m !== c || !C || !zo(f.type) || e.remove(f.id);
      }),
      s.length === 0)
    )
      return;
  ...
  async updateDependenciesModule(e) {
    E(Gt(e), "updateDependenciesModule called with non dependencies module data");
  ...
  async refreshLocked() {
    (B.debug("refresh: start"),
      E(this.modulesService, "ModulesStorage.refresh: expected modules service to be initialized"));
  ...
  isProcessing() {
    return !!(!this.initialized || this.transientSaves.size > 0 || Bt.isLocked(Ve));
  }
  hasLocalChanges() {
  ...
  async updateDependenciesSource(e, t, o) {
    await F(async () => {
      E(this.dependenciesModule, "Dependency files must already exist to be updated.");
  ...
  async createLocked(e, t) {
    ...
    let { type: o, name: r, source: s, sourceRevision: i, propertyControls: a, ...u } = e,
      ...
      g = {
        ...
        submoduleContents: fr,
        binaryAssetContents: hr,
        imports: c.imports,
    ...
    (E(!this.readOnlyTree, "modules storage is read only"), E(this.modulesService));
    let { data: f } = await this.modulesService.saveBatch({
        batch: [A],
        copyOnWrite: this.detached,
      }),
      { updatedModuleLocalId: m, nextPersistedModules: C } = this.processTransientSaveData(
  ...
  async update(e, t, o) {
    ...
    E(r, () => `Trying to update an unknown module with localId: ${e}`);
    let { name: s, type: i } = r,
      a = Date.now();
    try {
  ...
  async renameLocked(e, t) {
    ...
    if ((a !== g && ((r = Te(r, a)), (r = re(r, g, s.imports.relative))), d)) {
      ...
      for (let p of A) {
        let h = v(p),
          y = At(h, `${s.type}/${t}`);
        E(y, () => `Failed to create relative path to ${s.type}/${t}`);
        let I = At(h, a);
        E(I);
        ...
        let N = { absolute: p.imports.absolute, bare: p.imports.bare, relative: w },
          M = Dr(p.sourceContent, I, y),
          b = Dr(p.moduleContent, I, y);
        ((c[p.localId] = { sourceContent: M, moduleContent: b, imports: N }), E(p.files.source));
        let $ = {
          type: p.type,
          moduleId: p.id,
          name: p.name,
      ...
      E(!this.readOnlyTree, "modules storage is read only");
      let { data: C } = await this.modulesService.saveBatch({
        batch: m,
        copyOnWrite: this.detached,
      });
      l = C;
    ...
    ((o = Q(o, (A) => {
      if (this.updateTreeNode(e, i, u)) {
        ...
        for (let m of l) {
          let C = m.localId,
            p = A.get(C);
          E(p?.kind === "local", () => `dependent module must be local: ${C}`);
          let h = c[C];
          (E(h, () => `dependent module update must exist: ${C}`),
            this.updateTreeNode(C, i, m) &&
              (A.set(C, {
                ...m,
                kind: "local",
                localId: C,
  ...
  async promoteModuleSaves(e) {
    return F(async () => {
      ...
      t.length !== 0 &&
        (E(this.modulesService), await this.modulesService.promoteSaves({ promotions: t }));
    });
  }
  async delete(e, t) {
  ...
  async deleteLocked(e, t) {
    ...
    let r = o.map((l) => {
        ...
        return (E(c, () => `Trying to delete an unknown module ${l}. It was never persisted.`), c);
      }),
    ...
    (await Promise.all(
      ...
      E(i.length > 0, "Failed to delete module(s)"));
  ...
  async publishLocked(e, { namespace: t, name: o, version: r }) {
    ...
    (E(s, () => `Trying to publish an unknown module ${e}. It was never persisted.`),
      E(!this.readOnlyTree, "modules storage is read only"),
      E(this.modulesService));
    ...
    return F(async () => {
      ...
      i = i.map((g) => {
        ...
        if (f) {
          ...
          E(p, "Import map must contain all dependencies from dependencies map");
          let h = le(p)?.version;
        ...
        if (m !== g) return m;
        let C = ce[A];
        return C ? { ...g, target: `${A}@${C}` } : g;
      });
      let a = await this.getGeneratorTraceCacheForNpmOperation(),
        { importMap: u, resolvedDependencies: d, cache: l } = await Uo(t, i, Y, ce, a),
  ...
  async pruneProjectImportMapFromEntryPoints(e, t = {}) {
    return F(async () => {
      ...
      if (t.additionalImportMap) {
        let { modulesCDN: f } = X(),
          m = dt(o, f),
          { importMap: C, linkedScopes: p } = ko(o, m, Y),
          h = de(C, t.additionalImportMap, "source-wins");
        r = Ro(h, p);
      } else r = o;
  ...
  async updateDependenciesLocked({
    ...
    A && E(f !== "$upsertName", "patchSaveId for dependencies requires a persisted module id");
    let m = {
      moduleId: f,
      name: et,
      saveId: U(),
    ...
    (E(C, "Modules API must return an updated import map after savebatch"),
      this.updateTreeNodeWithOwnTreeVersion(V, C, r));
    let p = {
      kind: "dependencies",
      importMapContent: s,
  ...
  async handleRemoteModuleSaves(e) {
    ...
    if (s) {
      ...
      (E(a, "No dependencies file exists for the remote update!"),
        (r = {
          kind: "dependencies",
          ...s,
          id: s.id,
  ...
  async upsertBatchLocked(e, t, o) {
    ...
    for (let f in e) {
      let m = f,
        C = e[m];
      E(C, () => `No persist params found for ${m}`);
      let p = this.transientSaves.get(m),
        h = p ?? r.get(m);
      E(h, () => `No module found for ${m}`);
      let y = v(h);
      (u.set(y, p?.saveId ?? U()),
        s.set(y, ne(C.name)),
        a.set(y, m),
    ...
    try {
      ...
      if (((A = !0), C.length > 0 && this.didSaveBatchRemapModuleIds(h, y))) {
        let I = this.applyBatchSaveDataWithoutTreeUpdates(p, y, l, t.controlsByLocalId),
          D = this.createRepairSaveIdsForWaves(u, C, I),
          w = [];
        for (let N of C) {
      ...
      let m = this.getTransientSavesBatchId(l),
        C = this.transientSaveRetries.get(m) ?? 0,
        p = o?.kind === "agent" ? o.changeset.getChangeset() : void 0,
        h = p ? { kind: "agent", changeset: new Ge(p) } : o?.kind === "agent" ? void 0 : o,
        { error: y, dropTransient: I } = this.handlePersistenceError(f, C, () => {
          (this.transientSaveRetries.set(m, C + 1),
            setTimeout(
              () => {
  ...
  regenerateTransientSaveIdsForRetry(e) {
    let t = !0,
      o = Q(this.transientSaves, (s) => {
        ...
        for (let i of e.keys()) {
          let a = s.get(i);
          (E(a, () => `Expected transient save while regenerating save IDs: ${i}`),
            (a.saveId = U()),
    ...
    for (let s of e.keys()) {
      let i = o.get(s);
      (E(i, () => `Expected regenerated transient save ID: ${s}`), r.set(s, i));
    }
  ...
  createRepairSaveIdsForWaves(e, t, o) {
    ...
    for (let s of t)
      for (let i of s) {
        let a = o.get(i);
        (E(a, () => `${i} is not found in persistedModules`), r.set(v(a), U()));
      }
    return r;
  }
        ...
        if (!l) {
          ...
          (E(m, () =>
            He({
              ...
              dataLocalIds: t.map((C) => C.localId),
              transientSaveLocalIds: o.keys(),
              persistedModules: a,
            })
          ),
  ...
  applyDependentModuleSaveData(e, t, o, r) {
    if (
      ...
      let s = r.get(o);
      (E(s !== void 0), (e.propertyControls = s));
    }
  }
  async createBatch(e, t, o, r, s, i, a, u) {
    ...
    for (let C in e) {
      let p = C,
        h = e[p];
      E(h, () => `No persist params found for ${p}`);
      ...
      if (!y) {
        ...
        let N = i.get(p);
        (E(N, () => `No save id found for ${p}`), (y = this.getPatchTransientSave(p, w, N)));
      }
      ((y = Li(p, y, u)), t.set(p, y));
      let I = v(y);
    ...
    for (let C of g.values())
      for (let p of C) {
        let h = s.get(p);
        E(h, () => `Cannot find localId for ${p}`);
        let y = o.get(h);
        y?.kind === "server" && A.push(this.createLocalModuleFromModule(y));
      }
    if (A.length > 0) {
      let C = await Promise.all(A);
      o = Q(o, (p) => {
        for (let h of C) p.set(h.localId, h);
      });
    }
    for (let C of g.values()) for (let p of C) i.has(p) || i.set(p, U());
    let f = new Set();
    for (let [C, p] of g) {
      let [h] = we(C);
      for (let y of p) {
  ...
  processTransientSaveData({ nextPersistedModules: e, transientSave: t, data: o }, r, s) {
    ...
    return (
      ...
      E(a, () => `Updated module ${JSON.stringify(t)} is not found in the response`),
  ...
  async createBatchSaveForUpdatedModule(e, t, o, r, s, i) {
    ...
    e === "$new"
      ? E(u === void 0, `Attempted to create ${a} but it already has localId: ${u}`)
      : E(u !== void 0, `The transient save for the provided moduleId: ${e} doesn't have localId`);
    ...
    let K = ne(M),
      Ye = d;
    (C.relative.length > 0 &&
      (Ye = await this.replaceRelativeImportsWithAbsolute(a, d, C.relative, o, r, st(g), s)),
      c &&
        (Ye += `
//# sourceMappingURL=./${K.sourceMap}`));
    ...
    for (let [j, je] of Object.entries(g)) ye.push({ name: j, type: "submodule", content: je });
    for (let [j, je] of Object.entries(A)) ye.push({ name: j, type: "binaryAsset", bytes: je });
    let $e = {};
    if (f || b || m !== void 0)
      if (u) {
        let j = o.get(u);
        (E(j || e === "$upsertName", `Cannot safely update metadata for ${e} (${u})`),
  ...
  async createBatchSaveForDependentModule(e, t, o, r) {
    let s = t.get(e);
    (E(s, () => `${e} is not found in persistedModules`),
      E(s.kind === "local", "persisted module is not a local module"));
    let i = v(s),
      a = ne(s.name),
      u = s.imports,
      d = s.moduleContent;
    u.relative.length > 0 &&
      (d = await this.replaceRelativeImportsWithAbsolute(
        ...
        t,
        o,
        st(s.submoduleContents),
        r
      ));
    let l = o.get(i);
    E(l, () => `newSaveIds don't contain saveId for ${i}`);
    let c = {},
  ...
  ensurePersistedLocalIdsByTypeSlashNameCacheFor(e) {
    ...
    return (t || ((t = Qr(e)), this.persistedLocalIdsByTypeSlashNameCache.set(e, t)), t);
  }
  ...
  async getDependenciesFiles({ baseURL: e, files: t }) {
    ...
    E(o.status === "fulfilled", "The importMap has to exist on the module");
    let s = o.value,
      i;
    return (
  ...
  takeSnapshot() {
    return new Vt(this.persistedModules);
  }
};
function Ri(n, e) {
...
function Wt(n, e, t, o, r, s, i, a, u, d) {
  let l = new Set(s.keys()),
    ...
    [A, f] = yn(s, (p) => {
      for (let h of t.values()) {
        ...
        (Ir(p, I, N), c.delete(y), l.delete(I));
      }
      for (let h of c) {
        let y = o.get(h);
        if ((E(y), !y.localId)) continue;
        let I = ne(y.name),
          D = {
            kind: "local",
            localId: y.localId,
  ...
  return (
    C && C !== e && f.push({ op: e ? "replace" : "add", path: [v(C)], value: C }),
    {
      dependenciesModule: C,
      modules: A,
...
function Ir(n, e, t) {
  ...
  if (o.kind === "server") {
    (E(t.kind === "server"), vr(o, t));
    return;
  }
  (E(t.kind === "local"),
    xi(o.relativeImports, t.relativeImports) || (o.relativeImports = t.relativeImports),
...
function Gi(n, e) {
  for (let t of n) {
    ...
    return Number.isNaN(o) ? !1 : o > Sr.start && o < Sr.end;
  }
  return !1;
}
function Qr(n) {
...
var Vt = class {
  constructor(e) {
    ...
    this.persistedLocalIdsByTypeSlashName = Qr(e);
  }
  persistedModules;
...
function Oc(n, e, t) {
  ...
  return !t || !o
    ? t
    : t.type === "collectionreference" && W(t.value) && !wr(n, o, t.value)
      ? { ...t, value: void 0 }
      : t.type === "multicollectionreference" && Array.isArray(t.value)
        ? { ...t, value: t.value.filter((r) => wr(n, o, r)) }
        : t;
}
function Wi(n) {
...
function Hc(n, e, t, o) {
  ...
  return r === Lo ? s === o : !t || !Ji(r, t) || s !== o ? !1 : ro(e) ? e.includes(i) : e === i;
}
function Vc(n, e, t, o) {
  return e === t && n.id === o;
}
function Zc(n, e = "relative") {
  if (ho(n)) return !0;
  if (!co(n)) return !1;
  switch (e) {
    case "relative":
...
//# sourceMappingURL=chunk-5QLDVUH2.mjs.map
