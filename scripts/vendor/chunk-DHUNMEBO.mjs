...
import { d as ft, k as Ft } from "chunk-BSTISVF5.mjs";
import { E as dt, d as lt, db as pt, e as ct, ia as mt, x as ut } from "chunk-FCG35XJJ.mjs";
import { b as L, c as at } from "chunk-4JY5UMT2.mjs";
...
var Mt = st((Fo, Me) => {
  ...
  (function () {
    ...
    function u(l, f) {
      ...
      return [m, g, d ? l.stretch : "", "100px", f].join(" ");
    }
    ((s.prototype.load = function (l, f) {
      ...
      return new Promise(function (S, V) {
        if (p(m.context) && !h(m.context)) {
          var E = new Promise(function (I, _) {
              function A() {
                new Date().getTime() - N >= x
                  ? _(Error("" + x + "ms timeout exceeded"))
                  : m.context.document.fonts.load(u(m, '"' + m.family + '"'), g).then(function (D) {
          ...
          e(function () {
                ...
                ((b = T != C && T != w && C != w) ||
                  ...
                  (b =
                    ...
                    ((T == ce && C == ce && w == ce) ||
                      ...
                      (T == de && C == de && w == de)))),
                (b = !b)),
                b && (R.parentNode !== null && R.parentNode.removeChild(R), clearTimeout(y), S(m)));
            }
            function _() {
              if (new Date().getTime() - N >= x)
                (R.parentNode !== null && R.parentNode.removeChild(R),
                  V(Error("" + x + "ms timeout exceeded")));
              else {
                var b = m.context.document.hidden;
                ((b === !0 || b === void 0) &&
                  ((T = A.g.offsetWidth), (C = D.g.offsetWidth), (w = P.g.offsetWidth), I()),
                  (y = setTimeout(_, 50)));
              }
            }
            var A = new n(g),
            ...
            ((R.dir = "ltr"),
              ...
              R.appendChild(D.g),
              R.appendChild(P.g),
              m.context.document.body.appendChild(R),
              (ce = A.g.offsetWidth),
              (ue = D.g.offsetWidth),
              (de = P.g.offsetWidth),
              _(),
              ...
              i(D, u(m, '"' + m.family + '",serif')),
              r(P, function (b) {
                ((w = b), I());
              }),
              i(P, u(m, '"' + m.family + '",monospace')));
          });
      });
    }),
      typeof Me == "object"
...
var yi = st((it, ot) => {
  ...
  (function (t, e) {
    ...
    function F(u, l, f) {
      return function (m) {
        var g = m.toLowerCase();
        return l.hasOwnProperty(g) ? s(m, g) : u.hasOwnProperty(g) ? s(m, u[g]) : d(g, m, f);
      };
    }
    function h(u, l, f, m) {
      return function (g) {
        var y = g.toLowerCase();
        return l.hasOwnProperty(y) ? !0 : u.hasOwnProperty(y) ? !1 : d(y, y, f) === y;
      };
    }
    function p(u, l, f) {
      var m = l === 1 ? p.singular(u) : p.plural(u);
      return (f ? l + " " : "") + m;
    }
    return (
      (p.plural = F(o, i, t)),
    ...
    importFonts(e) {
      ...
      for (let i of e) {
        ...
        let { properties: o } = i,
          ...
          d = Array.isArray(c),
          F = d ? "variable" : o.font.fontSubFamily || "regular",
          h = M(i),
          p = J(c),
          u = {
            assetKey: i.key,
            ...
            weight: d ? fn(p, o.font.faceDescriptors?.weight) : Se(F),
            style: It(F),
            cssFamilyName: W(r, d),
          };
...
function Fn(t, e) {
  ...
  let d = o.get(`${n}-italic`);
  return { variantBold: s, variantItalic: d, variantBoldItalic: a };
}
function yn(t, e) {
    ...
    a.style === "normal"
      ? c
        ...
        : d
          ? (r = a)
          : r || (r = a)
      : a.style === "italic" && (c ? (o = a) : d ? (s = a) : s || (s = a));
  }
...
function bn(t) {
  ...
  let o = i ? Le : e.fontSubFamily.trim();
  return o === "" ? n : `${n} ${o}`;
}
  ...
  importFonts(e) {
    ...
    for (let o of e) {
      ...
      let { family: r, variant: s, weight: a, style: c } = xn(o.properties.font),
        d = o.properties.font.variationAxes,
        F = Array.isArray(d),
        ...
        m = this.createFontFamily(r),
        g = t.createSelector(m.name, s),
        y = {
          assetKey: o.key,
          family: m,
          selector: g,
        ...
        x = Sn(m.fonts, y);
      if (x?.projectDuplicate) y.owner === "team" && ((m.fonts[x.index] = y), (n[g] = y));
      else if (x) {
        ...
        (Z || (I && _)) && ((m.fonts[x.index] = y), (n[g] = y));
      } else (m.fonts.push(y), (n[g] = y));
        ...
        for (let l of a) {
          let {
            ...
            N = {
              ...
              variationAxes: l.isVariable ? d : void 0,
              cssFamilyName: W(h.name, l.isVariable),
            };
          (h.fonts.push(N), o.push(N));
        }
      }
      return o;
    }
...
var Un = {
  ...
  ne = class t {
    ...
    static getDraftFontPropertiesBySelector(e) {
      if (!e.startsWith(Lt) && !e.startsWith(Dn)) return null;
      let n = e.split("-"),
        [i, o = ""] = n;
      if (!i) return null;
      ...
      return (
        e.forEach((o) => {
          let { uiFamilyName: r, ...s } = o,
            ...
            c = n?.[a],
            d = this.getFontFamilyByName(r);
          d || (d = this.addFontFamily(r));
          let F = o.selector === o.selectorVariable || o.selector === o.selectorVariableItalic,
            h = { ...s, family: d, variationAxes: F ? c : void 0 };
          (d.fonts.push(h), i.push(h));
        }),
        i
      );
    }
  ...
  ie = class t {
    ...
    async importFonts(e, n, i) {
      ...
      for (let c in s) {
        let d = s[c];
        if (!d) continue;
        this.supportedSubsetsByFamilyName.set(d.family, d.subsets ?? []);
        let F = this.getFontFamilyByName(d.family);
        F || (F = this.addFontFamily(d.family));
        let p = d.variants.map((S) => ({
            ...t.parseVariant(S),
          ...
          l = u?.axes
            ...
            : [],
          f = t.createMetadataSelector(d.family),
          m = i?.[f],
          g = [...p, ...l],
          y = g.filter($),
        ...
        for (let S of g) {
          let { weight: V, style: E, selector: Z, googleFontsVariantName: I } = S,
            ...
            w = {
              ...
              weight: V,
              style: E,
              category: Vn(d.category),
              file: S.file?.replace("http://", "https://"),
              variationAxes: S.isVariable ? m : void 0,
              hasOpenTypeFeatures: N,
  ...
  ve = class {
    ...
    importFonts() {
      ...
      for (let o of Object.keys(Be)) {
        ...
        for (let a of Object.keys(r)) {
          let c = r[a];
          if (!c) continue;
          let { selector: d, weight: F } = c,
            h = { variant: a, selector: d, weight: F, family: s, cssFamilyName: s.name };
          s.fonts.push(h);
        }
        e.push(...s.fonts);
      }
      for (let [o, r] of Object.entries(Pt)) this.addFontAlias(o, r);
    ...
    getSystemFontFamily() {
      let e =
        ...
        n = { name: Nn, fonts: [], source: this.name },
        i = new Map(),
      ...
      for (let s of r)
        for (let a of o) {
          let c = Pn(a, s),
            d = `__SystemDefault-${a}-${s}__`,
            F = { variant: c, selector: d, style: s, weight: a, family: n, cssFamilyName: n.name };
          (n.fonts.push(F), i.set(d, e));
        }
...
var Mn = () => {},
  ...
  To = kn ? window.requestIdleCallback : setTimeout;
function Co(t) {
  return `url('${$n(t)}')`;
}
function $n(t) {
...
async function zt(t, e, n = 0) {
  ...
  if (!_e.has(d) || n > 0) {
    let F = new FontFace(i, `url(${o})`, {
      ...
      h = F.load()
        .then(() => (e.fonts.add(F), ke.set(d, { fontFace: F, doc: e }), We(i, c, a)))
        .catch((p) => {
...
var ze = class {
    ...
    getDraftPropertiesBySelector(e) {
      ...
      if (r) {
        let a = Q.parseVariant(r.variant);
        if ($(a))
          return {
            style: a.style,
            weight: a.weight,
...
function re(t, e = null, n = null, i = null, o = null, r = null) {
  L(t !== "", "Can\u2019t create asset reference for empty identifier");
  let s = new URL(`data:${je}${t}`);
  return (
    n && s.searchParams.set(qt, n),
    e && s.searchParams.set(Zt, e),
    i && s.searchParams.set(Xt, i),
    o && s.searchParams.set(Jt, o),
    r && (s.searchParams.set(Yt, r.width.toString()), s.searchParams.set(Qt, r.height.toString())),
    s.href
  );
}
function jn({
  ...
  if (Kt(t))
    try {
      let e = new URL(t),
        ...
        r = e.searchParams.get(Xt),
        s = e.searchParams.get(Jt),
        a = e.searchParams.get(Yt),
        c = e.searchParams.get(Qt);
      return {
        identifier: n,
        originalFilename: i,
        packageIdentifier: o,
...
var qe = class {
  ...
  getAssetByFilename(e) {
    for (let n of this.currentAssets.values()) if (X(n) === e) return n;
  }
};
var Kn = /^(.*?)(?:([^/])\.([^/.]+))?$/;
function Ze(t) {
...
function Ye(t, e, n) {
  ...
  r !== void 0 &&
    o &&
    ((n ??= Je(o.width, o.height)), n && (i = n.find(({ maxSideSize: a }) => a >= r)));
  let s = i?.maxSideSize;
...
function Jn(t, e) {
  ...
  if (i?.[1] && i?.[2]) {
    let o = i[1],
      r = i[2];
    (L(o, "did not match packageName"), L(r, "did not match filePath"));
    let s = tn(t, o, r);
    if (s) return s;
  }
  return n;
...
function Yn(t, e) {
  return (i, o) => {
    ...
    let r = !1,
      s = se(i);
    if (s) {
      let { identifier: c, packageIdentifier: d } = s;
      if (d) return tn(t, d, c);
      ((r = !0), (i = c));
    } else if (o?.isFramerResourceURL) return Jn(t, i);
...
var ii = new Map([
  ...
  et = (() => {
    let t = new Map();
    for (let [e, n] of ii.entries()) (Qe.has(n) || t.set(n, e), on.add(e), Qe.add(n));
    return t;
  })(),
  qr = [...on],
  tt = [...Qe];
...
async function ci(t, e) {
  ...
  (L(!r, "Writing image/* mimeType is currently not supported"),
    L(!s, "Writing video/* mimeType is currently not supported"),
    L(
  ...
  try {
    ...
    if ((o ? (c = o) : (c = ct(a)), e?.clipboardData))
      ...
      let d = {};
      (n !== void 0 && (d[ae] = new Blob([n], { type: ae })),
        i !== void 0 && (d[le] = new Blob([i], { type: le })),
        c && (d[O] = new Blob([c], { type: O })));
      let F = new window.ClipboardItem(d);
    ...
    if (e?.clipboardData) {
      ...
      if (e.clipboardData.files && e.clipboardData.files.length > 0)
        for (let p of e.clipboardData.files)
          (i && tt.includes(p.type) && c.push(p), o && nt.includes(p.type) && d.push(p));
    } else {
      let p = [];
      try {
...
//# sourceMappingURL=chunk-DHUNMEBO.mjs.map
