...
var Nt = /Instagram|FB_IAB\/FB4A|FBAN\/FBIOS|BytedanceWebview|Twitter|LinkedIn/iu;
function Dt() {
  let e = h();
...
var Er = "text/html",
  D = "data-framer-html-import-extension";
function br(e, t) {
  let r = {};
  if ((t.includes("text/html") && (r["text/html"] = e), !Tr(e))) return r;
  let i = new DOMParser().parseFromString(e, Er);
  if (t.includes("application/x-framer-html-import-extension")) {
    let s = i.querySelectorAll(`[${D}]`);
    if (s) {
      let a = document.createElement("body");
      (s.forEach((u) => {
        let c = u.getAttribute(D);
        c && !a.getAttribute(D) && a.setAttribute(D, c);
        let x = u.firstChild;
        x && a.appendChild(x);
      }),
...
function Tr(e) {
  return e.includes(D) || e.includes("data-framer-pasteboard");
}
function Sr(e, t) {
  let r,
    n,
...
var Pr = Object.freeze(new Set());
function Rr() {
  return Pr;
}
var Or = Object.freeze(new Map());
function Ar() {
  return Or;
}
function Nr(e) {
...
((n) => {
  function e(i, o, s) {
    for (let a of Object.keys(i)) Ur(o, a) || delete i[a];
...
//# sourceMappingURL=chunk-FVJDO2XD.mjs.map
