  ...
  let m = l(N, {
    children: l(M, {
      children: l(F, {
        ...
        collectionUtils: G,
        framerSiteId: K,
        notFoundPage: x(() => import(`./shared-lib.DzRxRYkA.mjs`).then((e) => (e.i(), e.r))),
        ...
        loadSnippetsModule: new R(
          () => import(`./aohXcfCEH7eLshUz3Ru8hwERbjwVtxq5cCDnwgn579k.BTtLKddO.mjs`)
        ),
  ...
  if (
    ...
    (U = {
      augiA20Il: {
        ...
        page: x(() => import(`./p-yucEQL27NpV2thC8WSmUXcDoBfOUS0Wcm5H322U6Y.CPZfUCB0.mjs`)),
        path: `/`,
      },
    }),
    ...
    q &&
      v(() => {
        _(
          ...
          l(d, {}, l(p(() => import(`./shared-lib.DzRxRYkA.mjs`).then((e) => (e.n(), e.t)))))
        );
      });
  })();
})();
export { B as getPageRoot };
//# sourceMappingURL=script_main.BFUZ6Fxz.mjs.map
