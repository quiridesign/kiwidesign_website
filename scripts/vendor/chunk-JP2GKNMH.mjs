...
import { f as un, g as dn, h as ln, i as cn, k as mt } from "chunk-FD4BH2A6.mjs";
import { r as sn } from "chunk-ZGSYAT7B.mjs";
import { e as At } from "chunk-5XUSMOUJ.mjs";
import { fa as ft } from "chunk-OVSWAUGL.mjs";
import { h as zo } from "chunk-Q3WX3LWW.mjs";
import { a as an } from "chunk-D3SZBJZX.mjs";
import { b as L } from "chunk-G4AKBPZO.mjs";
import { a as qo, b as Yo } from "chunk-QH5BKXZN.mjs";
import { eb as Jo, fb as _o, gb as Ho } from "chunk-K6WOFN2G.mjs";
import { f as Vo } from "chunk-2XMXWGLC.mjs";
import { uh as me } from "chunk-Z5RAPOF6.mjs";
import { a as ne, b as yt } from "chunk-WCTCEL2Q.mjs";
import { b as jo, c as Xo, e as Zo, f as Q, g as Cn } from "chunk-NMSN6DQX.mjs";
import { a as tn } from "chunk-CNMLD24G.mjs";
import {
  $C as Wo,
  AC as xo,
  Ac as lo,
...
import { i as Mo } from "chunk-L2QYKMOJ.mjs";
import { f as go } from "chunk-KYPY4QS7.mjs";
import { $ as De, f as tt, j as ot, ma as Se, va as Fr } from "chunk-YTTFBDRE.mjs";
import { o as q } from "chunk-ZA5GQ2BE.mjs";
import { a as et } from "chunk-XD24P57D.mjs";
import { a as st } from "chunk-RNHTTH2C.mjs";
import { a as Ie } from "chunk-5WDLMAA7.mjs";
import { ng as Fe } from "chunk-P3ZYSNII.mjs";
import { a as to } from "chunk-JTCAKYEM.mjs";
import {
  b as W,
  e as oo,
  g as nt,
...
import { c as z } from "chunk-NQLCAFDF.mjs";
import {
  Ba as P,
  Ga as Me,
  Ja as Ze,
...
function Mn(n, e) {
  ...
  if ((C(typeof t == "number", "fileUploadLimitInMB is not a number"), e / ft >= zo))
  ...
  let o = t.toLocaleString() + "MB",
    r =
      (e / ft).toLocaleString(void 0, { minimumFractionDigits: 0, maximumFractionDigits: 1 }) +
      "MB";
  return n.stores.modalStore.set({
    source: "upsell",
    type: "UpsellFeature",
...
var In = Z("UploadUserAssetsService");
function Qr(n) {
    ...
    async uploadImage(e, { silent: t = !1, maxFileSize: o, onExceedsCustomMaxSize: r } = {}) {
      try {
        ...
        (L({
          ...
          In.reportError(s, { fileName: e.name, fileSize: e.size, fileType: e.type }));
      }
    }
      ...
      try {
        let s = t ? st : (u) => L(u),
          [i, a] = await Promise.all([
            un(dn(e), 1e4, "Measuring the video took more than 10 seconds"),
...
var se = class {
    ...
    #t = [];
    async run(e, t) {
      if (this.#e === this.limit) {
        let o = new Promise((r) => {
          this.#t.push(r);
        });
        (t && (o = Promise.race([o, Nr(t)])), await o);
      }
      (Sn(t), this.#e++);
      try {
        return await e();
...
var be = class {
  constructor(e, { concurrency: t = 5, silent: o = !1, assetOwnerType: r = "project" } = {}) {
    ...
    ((this.limiter = new se(t)),
      ...
      (this.assetUploadService = r === "user" ? vn : mt));
  }
  engine;
  uploads = new Map();
  completed = 0;
        ...
        task: async () => {
          try {
            return typeof e == "string"
              ? e.startsWith("data:")
                ? await this.uploadFile(await an(e, "imported"))
  ...
  async uploadFile(e) {
    let t = this.engine.stores.projectStore.resourceLimits?.fileUploadLimitInMB ?? void 0,
      o = {
        silent: this.silent,
        maxFileSize: t,
        onExceedsCustomMaxSize: (s) => Mn(this.engine, s),
        refreshAssetService: !1,
      },
      r;
    if (
  ...
  get active() {
    return [...this.uploads.values()].map(({ resultPromise: e }) => e).filter(so);
  }
  get status() {
  ...
  async results() {
    let e = await Promise.allSettled(this.active).then((t) => t.filter(ao).map((o) => o.value));
    return (await this.engine.stores.assetStore.assetService?.refresh().catch(G), e);
  }
};
var Fn = je(Fr(), 1);
var _ = je(to(), 1);
async function Ma(n, e, t = 1 / 0, o) {
  o ??= new be(n, { silent: !0 });
  let r = [],
    s = [],
    i = [];
  ...
  return (
    r.length > 0 &&
      L({
        ...
        variant: "warning",
        primaryText: (0, _.jsxs)("span", { className: me, children: ["Skipped ", r.length] }),
    ...
    s.length > 0 &&
      L({
        ...
        variant: "warning",
        primaryText: (0, _.jsxs)("span", { className: me, children: ["Skipped ", s.length] }),
        secondaryText: "images over field limit.",
        duration: 1e4,
      }),
    br(o, i).catch(() => {}),
    (await Promise.all(i)).filter(cn)
  );
}
    ...
    L({
      ...
      text: (0, _.jsxs)("span", {
        ...
        children: [
          ...
          (0, _.jsxs)("span", { className: `toast-progress-value ${me}`, children: [r, "/", s] }),
        ],
      }),
    });
...
var Pn = {}.hasOwnProperty,
  Mt = {},
  Pe;
for (Pe in Le) Pn.call(Le, Pe) && (Mt[Le[Pe]] = Pe);
var Wr = /[^\dA-Za-z]/;
function kn(n, e, t, o) {
...
function xn(n, e, t, o) {
  ...
  function r(s) {
    return x(s, Object.assign({}, o.settings.characterReferences, { subset: Hr }));
  }
}
function Un(n, e, t, o) {
  return (
...
function Jn(n, e, t, o) {
  let r = o.schema,
    ...
    a = [],
    u;
  r.space === "html" && n.tagName === "svg" && (o.schema = ve);
...
function ps(n, e, t) {
  ...
  return t === !0 ||
    ((t = Array.isArray(t)
      ? (o.commaSeparated ? yo : Bo)(t, { padLeft: !n.settings.tightCommaSeparatedLists })
      : String(t)),
    ...
    : (n.settings.preferUnquoted &&
      ...
      a !== t &&
        (n.settings.quoteSmart && ht(t, i) > ht(t, n.alternative) && (i = n.alternative),
        (a =
          i +
          x(
            t,
...
var Vn = Mo("type", {
  invalid: ms,
  unknown: fs,
  handlers: { comment: xn, doctype: Un, element: Jn, raw: _n, root: Hn, text: xe },
});
function ms(n) {
...
function Oe(n) {
  ...
  e.compiler = t;
  function t(o) {
    return An(o, { ...e.data("settings"), ...n, extensions: e.data("toMarkdownExtensions") || [] });
  }
}
var Ms = /^(#{1,6})\s+(.+)$/m,
  Is = /\*\*(.*?)\*\*/,
...
function od(n, e) {
  ...
  return ((o.innerHTML = t), go.fromSchema(e).parseSlice(o, { preserveWhitespace: !0 }));
}
function nd(n, e, t) {
  let o = {},
    r;
  ...
  let a = Io(n, { schema: t, nodeHandlers: o, markHandlers: s });
  return Ct()
    .use(gt)
    .use(Oe, {
      handlers: {
        text(...u) {
          let [d] = u;
          return d.data?.avoidEscaping ? d.value : pn.text(...u);
        },
      },
      bullet: "-",
      emphasis: "_",
...
function qn(n) {
  return Ft("directory", n);
}
function Yn(n) {
  let t = ie(n) || "MyComponent",
    o = t + H,
    r = _s(t);
...
function qs(n, e) {
  if (ae(n)) return n;
  let [t, o] = De(e);
  return (o && (o = `.${o}`), (!o || !ae(o)) && (o = H), n + o);
}
function vd(n, e = "codeFile") {
  return e === "shader"
    ? n.endsWith(".ts")
      ? n
      : (ae(n) && (n = n.slice(0, n.lastIndexOf("."))), n + ".ts")
    : (ae(n) || (n += ".tsx"), n);
}
function Ys(n) {
  let e = n.lastIndexOf("/");
...
function Xn(n, e = !0) {
  ...
  return (
    (!ae(o) || o === H) && e && (s = uo(s)),
    { path: Qt(r, s + o), dirName: r, name: s, extension: o }
  );
}
function Dd(n, e = "component", t = !0) {
  n = n.trim();
  let { dirName: o, name: r, extension: s } = Xn(n, t);
  if (ae(s) && s !== H) {
    let u = r + s;
    return { path: Qt(o, u), content: "" };
  }
  let i = e === "component" ? Yn(r) : $n(r),
    a = qs(r + s, i.name);
  return { path: Qt(o, a), content: i.content };
}
function Zn(n, e) {
  if (!n.has(e)) return e;
  let t = 1,
...
function Nt(n, e = "@") {
  if (!S) return Tt.then(() => Nt(n));
  let t = n.length + 1,
    o = (S.__heap_base.value || S.__heap_base) + 4 * t - S.memory.buffer.byteLength;
  o > 0 && S.memory.grow(Math.ceil(o / 65536));
  let r = S.sa(t - 1);
  if (((js ? Zs : Xs)(n, new Uint16Array(S.memory.buffer, r, t)), !S.parse()))
    throw Object.assign(
      new Error(
        `Parse error ${e}:${
          n.slice(0, S.e()).split(`
...
`,
  ...
  for (; S.ri(); ) {
    let u = S.is(),
      ...
      f = S.se(),
      m;
    (S.ip() && (m = a(n.slice(g === -1 ? u - 1 : u, g === -1 ? d + 1 : d))),
...
var S,
  Tt = WebAssembly.compile(
    ...
    typeof Buffer < "u"
      ? Buffer.from(wt, "base64")
      : Uint8Array.from(atob(wt), (n) => n.charCodeAt(0)))
  )
...
async function nr(n, e) {
  ...
  for (let { s: i, e: a, d: u } of s) {
    if (u === -2) continue;
    if (u === -1) {
      let y = n.substring(i, a);
      if (!y.startsWith(".")) continue;
      let p = e[y];
      (p === void 0 && (r.add(y), (p = or(y))), (o = tr(o, p, i, a)));
      continue;
    }
    ...
    let m = d.replace(new RegExp(Pt(g), "g"), JSON.stringify(f));
    o = tr(o, m, i, a);
  }
  return r.size > 0
    ? Lt({ partiallyProcessedCode: o, unresolvedRelativeImports: r, parsedImports: t })
    : bt(o);
}
function rr(
  n,
  ...
  for (let l of e) {
    ...
    if (!c || s?.(c)) continue;
    let g = t(c);
    et(g, `Dependency module ${c} must exist to replace relative import`);
    let { id: A, files: f, localId: m } = g,
      y = o?.(c) ?? g.saveId,
      p = r?.(c) ?? f.module;
    (et(W(p), "Must have a module file name to build a local module import map specifier."),
      (u[l] = a ? Me(m, p) : `${d}/${A}/${y}/${p}`));
  }
  return u;
}
function tr(n, e, t, o) {
...
var kt = window?.framerUser;
function _d(n) {
  switch (n) {
    case "verifiedEmail":
      return {
        type: "verifiedEmail",
        emails: [{ email: kt.email, verified: !0 }],
        name: "Framer",
        subject: di,
        body: li,
        id: Fe(),
    ...
    case "webhook":
      return { type: "webhook", webhookUrl: void 0, secret: "", fallbackEmail: kt.email, id: Fe() };
    case "googlesheet":
      return {
        type: "googlesheet",
        fallbackEmail: kt.email,
        documentId: void 0,
        documentName: void 0,
        id: Fe(),
      };
...
function oi(n, e) {
  ...
  return t ? [t] : [ti("spam_protection")];
}
function jd(n, e, t) {
  let o = oi(n, e);
  return t ? o : o.map((r) => ni(r, t));
}
function ni(n, e) {
...
var Rt = "type",
  ri = "provider",
  si = { type: !0, id: !0, emails: !0, subject: !0, body: !0, name: !0 };
function Xd(n) {
  for (let e in n) if ((e === Rt && n[e] !== "verifiedEmail") || !(e in si)) return !1;
  return !0;
}
var ii = { type: !0, id: !0, webhookUrl: !0, fallbackEmail: !0, secret: !0 };
function Zd(n) {
  for (let e in n) if ((e === Rt && n[e] !== "webhook") || !(e in ii)) return !1;
  return !0;
}
var ai = { type: !0, id: !0, documentName: !0, documentId: !0, fallbackEmail: !0 };
function el(n) {
  for (let e in n) if ((e === Rt && n[e] !== "googlesheet") || !(e in ai)) return !1;
  return !0;
}
var ui = { provider: !0, filtering: !0, mode: !0 };
function tl(n) {
  for (let e in n) if ((e === ri && n[e] !== "spam_protection") || !(e in ui)) return !1;
  return !0;
}
var di = "New Submission",
  li = "You\u2019ve just received a new submission.";
function nl(n, e) {
...
function xt(n) {
  ...
  if (!n) return e;
  if (ee(n) && ho(n)) {
    let t = ir(n.layoutTemplateIdentifier);
    t && e.add(t);
  }
  for (let { node: t, skipChildren: o } of n.walkWithSkipChildren()) {
    ...
    let r = ir(t.codeComponentIdentifier);
    r && e.add(r);
  }
  return e;
}
function ir(n) {
  let e = P(n);
  if (!(!e || !Be(e))) return v({ type: e.type, name: e.localIdName });
}
function Ut(n) {
  try {
    let e = JSON.parse(n);
...
function ci(n) {
  return nt(n, "analysis") && nt(n, "packageConfigs");
}
var Ce = Z("modules-divergence-reporter"),
  Ai = 2,
  mi = [1e3, 2e3, 4e3, 8e3, 16e3, 32e3],
  fi = 10 * 6e4,
  hi = 1e4;
function gi(n) {
...
var Je = class {
  ...
  constructor(e) {
    ((this.sample = e.sample),
      ...
      (this.consecutiveThreshold = e.consecutiveThreshold ?? Ai),
      (this.settleBackoffMs = e.settleBackoffMs ?? mi),
      (this.slowIntervalMs = e.slowIntervalMs ?? fi),
      (this.fastIntervalMs = e.fastIntervalMs ?? hi),
  ...
  async runSample() {
    ...
    try {
      ...
      (Ce.debug("failed to sample modules divergence", { error: t }), this.handleNotSettled());
      return;
    }
  ...
  handleNotSettled() {
    ...
    if (e === void 0) {
      (Ce.debug("sample notSettled, backoff exhausted, waiting slow interval", {
    ...
    (Ce.debug("sample notSettled, retrying with backoff", {
...
var _e = class {
  ...
  getImportUrlForDependency(e, t) {
    let o = e.imports[t];
    if (o) return o;
    let r = Object.keys(e.imports).find((s) => yi(s, t));
...
function Kt(n) {
  return (n instanceof qo || n instanceof z) && n.status === Yo.NotFound;
}
function dr(n) {
...
var vi = 1e4,
  ...
  Di = 10,
  fr = new Set(["codeFile", "shader"]);
function Si(n) {
  return fr.has(n) ? fr : new Set([n]);
}
var Fi = 0;
async function F(n) {
  let e = performance.now(),
    t = `acquire-modules-storage-lock-${Fi++}`;
  return yt.request(He, () => {
...
var ze = class {
    ...
    externalModuleIdentifier(e = "default") {
      ...
      if (t) {
        let r = ne(t.name);
        return Xe(this.id, t.saveId, r.module, e);
      }
      ...
      return (
        ...
        Xe(this.id, o.saveId, o.files.module, e)
      );
    }
    delete(e) {
    ...
    annotations(e, t) {
      ...
      return (
        e && this.debugModuleStoreAndComponentLoaderRevisionsMatch() && Qi(r, e),
        t ? r?.[t] : r
      );
    }
    ...
    currentSourceEquals(t, o) {
      ...
      return !r ||
        ...
        (o.propertyControls !== void 0 &&
          (r.kind !== "local" || !Ie(r.propertyControls, o.propertyControls)))
        ? !1
        : r.sourceContent === t;
    }
    updateSource(t, o = {}) {
...
function Qi(n, e) {
  ...
  (C(Be(t) && qt(t), "Entity must have an identifier."),
    e.annotations &&
      t.exportSpecifier in n &&
      !Ie(n[t.exportSpecifier], pe({ default: e.annotations }).default, !0) &&
...
var _t = class extends ze {
  ...
  hr = class {
    ...
    getByLocalId(e) {
      return new _t(this.storage, e, this.type, this.moduleStoreAndComponentLoaderRevisionsMatch);
    }
    getUniqueName(e) {
      return this.storage.getUniqueNameForType(this.type, e);
    }
  },
  gr = { revision: -1, controlsByLocalId: new Map() };
function Cr(n, e) {
  if (q.isOn("crdtModuleControls") && n === "codeFile") return e ?? null;
}
function wi(n, e, t) {
...
function Ni(n, e) {
  if (q.isOn("crdtModuleControls")) {
    ...
    if (n.propertyControls !== void 0) return sr(n.propertyControls);
...
var Er = class n {
  ...
  async changeScope(e) {
    ...
    !t ||
      ...
      (await F(async () => {
        ...
        for (let [u, d] of this.lazyServerModulesForTransientSaves) fe(r, u, d, t, o);
        let s = [];
        for (let u of o) {
  ...
  async makeVisibleDependentServerModulesLocal(e) {
    ...
    for (let u of e) {
      ...
      (fe(c, l, s, r, o), this.lazyServerModulesForTransientSaves.set(l, s), o.delete(l));
    }
    let i = [];
    for (let u of o) {
      let d = this.getModuleWithTypeSlashName(u);
  ...
  capturePreparedPropertyControlsSnapshot(e) {
    return e ? (this.capturePropertyControlsSnapshot?.() ?? gr) : gr;
  }
  async prepareAndPersistBatch(e, t, o) {
    ...
    return F(() => this.upsertBatchLocked(e, i, o));
  }
  ...
  codeModuleIdsAffectedByPersistence(e) {
    ...
    for (let r in e) {
      ...
      if (!s) continue;
      let i = v(s);
      (t.add(i), fe(this.lastSnapshot.depsGraph, i, t));
    }
    let o = [];
    for (let r of t) {
  ...
  async initializeInternal() {
    ...
    (At("modulesStorageInit"), B.debug("listing modules took:", performance.now() - o, "millis"));
    let r = t.data.find(Ot);
  ...
  async sampleModulesTreeBackendDivergences() {
    return F(async () => {
      ...
      return { kind: "sampled", divergences: ur(e, t) };
    });
  }
  ...
  async syncLocalModules() {
    ...
    for (let r of e) {
      ...
      (mr(a, i) && !u) ||
        (Ii(r) && mr(this.dependenciesModule, i)) ||
  ...
  updateNode(e, t, o, r, s) {
    ...
    let a = r.metadata.pluginId,
      u = r.annotations ? pe(r.annotations) : i.save.annotations,
      d = en(u?.default?.framerTrackingIds);
    ...
    let l = {
      ...
      name: r.name,
      type: r.type,
      sourceRevision: r.sourceRevision ?? vr(r.metadata),
      annotations: u,
      propertyControls: Ni(r, i.save.propertyControls),
    ...
    if (
      ...
      g?.children?.forEach((f) => {
        let m = f.sourceNodeId ?? f.scopeId,
          y = ro(f.sourceNodeModuleType) || r.type === f.sourceNodeModuleType;
        !m || m !== c || !y || !Ho(f.type) || e.remove(f.id);
      }),
      s.length === 0)
    )
      return;
  ...
  getModuleTreeData(e) {
    return this.treeStore.tree.getNodeWithTrait(e, Ne)?.save;
  }
  createLocalModulesListNodeIfNeeded(e) {
    if (e.has(te) || !this.canWriteTree()) return;
    (B.debug("ensureAllModulesExistInTree:", this.persistedModules.size), e.insertNode(new Ae()));
    let t = this.treeStore.remoteTreeVersion;
    (this.persistedModules.forEach((o) => {
      this.updateNode(e, o.localId, t, o);
    }),
      this.dependenciesModule && this.updateNode(e, V, t, this.dependenciesModule));
  }
  ...
  async updateDependenciesModule(e) {
    C(Ot(e), "updateDependenciesModule called with non dependencies module data");
  ...
  withCurrentNameFromTree(e) {
    ...
    let t = this.treeStore.tree.getNodeWithTrait(e.localId, Ne);
    if (!t) return e;
    let { save: o } = t;
  ...
  async refresh() {
    if (this.initialized && !this.useTreeAsLocalModuleList)
      return (B.debug("refresh: acquiring lock"), F(() => this.refreshLocked()));
  }
  async refreshLocked() {
  ...
  async whenIdle() {
    await Promise.all([this.whenInitialized(), F(() => {})]);
  }
  isProcessing() {
    return !!(!this.initialized || this.transientSaves.size > 0 || yt.isLocked(He));
  }
  hasLocalChanges() {
  ...
  async updateDependenciesSource(e, t, o) {
    await F(async () => {
      ...
      let r = e === Xt ? t : this.dependenciesModule.importMapContent,
        s = e === Zt ? t : this.dependenciesModule.dependenciesMapContent;
  ...
  async updateSourceLocked(
    ...
    let A = this.typeAndNameFromLocalId(e, s),
      ...
      m = await this.compile({
        ...
        source: t,
        type: A.type,
        includeSourceMap: Wt(A.type),
        telemetrySession: u,
      }),
      y = pr;
    o && (y = await this.compileSubmodules(A.type, o));
    let p = re(this.lastSnapshot.depsGraph, f, m.imports.relative);
    if (a && Bn(p, f)) throw new Ve();
    let h = Ri(A.type, m.annotations),
      E = Cr(A.type, g),
      I = Q(this.transientSaves, (N) => {
        ...
        let Ee = h?.framerIntrinsicHeight;
        if (
          (Ee && (b = { ...b, intrinsicHeight: Number.parseInt(Ee, 10) }),
          (b = {
            ...b,
          ...
          ((M.saveId = U()),
            ...
            (M.propertyControls = E !== void 0 ? E : M.propertyControls),
          ...
          let K = {
            ...
            sourceRevision: l,
            svgIcon: c,
            propertyControls: E !== void 0 ? E : void 0,
    ...
    if (!D) return;
    let w = pe(m.annotations);
    Ie(this.getModuleTreeData(e)?.annotations, w) ||
      this.process(() => {
        this.readOnlyTree ||
  ...
  async createWithUniqueName(e, t) {
    return F(() => this.createWithUniqueNameLocked(e, t));
  }
  ...
  async createLocked(e, t) {
    ...
    let { type: o, name: r, source: s, sourceRevision: i, propertyControls: a, ...u } = e,
      d = Cr(o, a),
      l = v({ type: o, name: r }),
      c = await this.compile({ name: l, source: s, type: o, includeSourceMap: Wt(o) }),
      g = {
        localId: void 0,
        type: o,
        name: r,
        ...
        submoduleContents: pr,
        binaryAssetContents: Ar,
        imports: c.imports,
    ...
    let { data: f } = await this.modulesService.saveBatch({
      ...
      { updatedModuleLocalId: m, nextPersistedModules: y } = this.processTransientSaveData(
  ...
  async update(e, t, o) {
    let r = this.persistedModules.get(e);
    C(r, () => `Trying to update an unknown module with localId: ${e}`);
    let s = Date.now();
    try {
      return await this.prepareAndPersistBatch(
        { [e]: { ...t, name: r.name, type: r.type } },
        r.type,
        o
      );
    } finally {
      let i = Date.now() - s;
      B.debug("\u23F1 update", e, "in", i, "ms");
    }
  }
  async rename(e, t) {
    return F(() => this.renameLocked(e, t));
  }
  async renameLocked(e, t) {
    ...
    if ((a !== g && ((r = Te(r, a)), (r = re(r, g, s.imports.relative))), d)) {
      ...
      if (f.length > 0) {
        ...
        o = Q(o, (h) => {
          for (let E of p) (h.set(E.localId, E), A.push(E));
        });
      }
      let m = [];
      for (let p of A) {
        let h = v(p),
          E = pt(h, `${s.type}/${t}`);
        C(E, () => `Failed to create relative path to ${s.type}/${t}`);
        let I = pt(h, a);
        C(I);
        ...
        let N = { absolute: p.imports.absolute, bare: p.imports.bare, relative: w },
          M = Mr(p.sourceContent, I, E),
          b = Mr(p.moduleContent, I, E);
    ...
    ((o = Q(o, (A) => {
      if (this.updateTreeNode(e, i, u)) {
        ...
        for (let m of l) {
          let y = m.localId,
            p = A.get(y);
          C(p?.kind === "local", () => `dependent module must be local: ${y}`);
          let h = c[y];
          (C(h, () => `dependent module update must exist: ${y}`),
            this.updateTreeNode(y, i, m) &&
              (A.set(y, {
                ...m,
                kind: "local",
                localId: y,
  ...
  async delete(e, t) {
    return F(() => this.deleteLocked(e, t));
  }
  ...
  async publish(e, t) {
    return F(() => this.publishLocked(e, t));
  }
  ...
  async addNpmDependencies(e) {
    return F(async () => {
      ...
      if (
        ((i = i.filter((g) => {
          if (Y.has(g.target) || xo(g.target)) return !1;
          let A = bo(g);
      ...
      let a = await this.getGeneratorTraceCacheForNpmOperation(),
        { importMap: u, resolvedDependencies: d, cache: l } = await Ro(t, i, Y, ce, a),
        c = await this.extendCurrentDependenciesMap(d);
      return (
        d.forEach(({ name: g, version: A }) => Vo("npm_dependency_add", { name: g, semver: A })),
  ...
  async uninstallBlockedNpmDependencies() {
    return F(async () => {
      let { currentImportMap: e, currentDependenciesMap: t } = this.getCurrentDependencies(),
        ...
        { importMap: s, cache: i } = await Uo(e, r);
      return (
        await this.updateDependenciesLocked({
          newImportMap: s,
  ...
  createLocalModuleImportMap() {
    ...
    for (let t of this.persistedModules.values()) {
      let o = t;
      if (W(o.files.module)) {
        let r = Me(o.localId, o.files.module);
        e[r] = o.moduleURL;
      }
    }
    return { imports: e };
  ...
  async scopeExternalImportMap(e, t) {
    let o = await this.getGeneratorTraceCacheForNpmOperation(),
      { importMap: r } = await ct(e, Y, ce, t, o);
    return r;
  }
  async generatePrunedImportMapFromEntryPoints(e, t, o) {
    let r = await this.getGeneratorTraceCacheForNpmOperation(),
      { importMap: s, cache: i } = await ct(e, Y, ce, t, r, o),
      { modulesCDN: a } = X(),
      u = ko(s, { providedDependencyNames: Y, localScopeUrls: ut(t, a) });
    return (Ko(u), { importMap: u, cache: i });
  }
  async pruneProjectImportMapFromEntryPoints(e, t = {}) {
    return F(async () => {
      ...
      if (t.additionalImportMap) {
        let { modulesCDN: f } = X(),
          m = ut(o, f),
          { importMap: y, linkedScopes: p } = Lo(o, m, Y),
          h = de(y, t.additionalImportMap, "source-wins");
        r = Po(h, p);
      } else r = o;
  ...
  async updateDependenciesLocked({
    ...
    (C(y, "Modules API must return an updated import map after savebatch"),
      this.updateTreeNodeWithOwnTreeVersion(V, y, r));
    let p = {
      kind: "dependencies",
      importMapContent: s,
  ...
  async handleRemoteModuleDeletes(e) {
    await F(async () => {
      ...
      let r = Q(this.persistedModules, (a) => {
        ...
        i = yn(this.lastSnapshot.depsGraph, o);
      this.setNextInternalState({
        dependenciesModule: this.dependenciesModule,
        persistedModules: r,
        transientSaves: s,
  ...
  async handleRemoteModuleSaves(e) {
    let t = [],
      o = [];
    for (let i of e) v(i) === V ? t.push(i) : o.push(i);
    let r,
  ...
  async upsertBatchLocked(e, t, o) {
    ...
    for (let f in e) {
      let m = f,
        y = e[m];
      C(y, () => `No persist params found for ${m}`);
    ...
    try {
      let {
        primaryBatch: f,
        dependentBatch: m,
        repairLocalIdWaves: y,
        nextPersistedModules: p,
      } = await this.createBatch(e, l, r, d, a, u, s, t);
      (C(!this.readOnlyTree, "modules storage is read only"), C(this.modulesService));
      let h = f.concat(m),
        { data: E } = await this.modulesService.saveBatch({ batch: h, copyOnWrite: this.detached });
      if (((A = !0), y.length > 0 && this.didSaveBatchRemapModuleIds(h, E))) {
        let I = this.applyBatchSaveDataWithoutTreeUpdates(p, E, l, t.controlsByLocalId),
          D = this.createRepairSaveIdsForWaves(u, y, I),
          w = [];
        for (let N of y) {
        ...
        r = this.applyBatchSaveDataToPersistedModules({
          nextPersistedModules: p,
          data: this.combineLatestSaveData(E, w),
          transientSaves: l,
          sources: e,
      ...
      let m = this.getTransientSavesBatchId(l),
        y = this.transientSaveRetries.get(m) ?? 0,
        p = o?.kind === "agent" ? o.changeset.getChangeset() : void 0,
        h = p ? { kind: "agent", changeset: new Ge(p) } : o?.kind === "agent" ? void 0 : o,
        { error: E, dropTransient: I } = this.handlePersistenceError(f, y, () => {
          (this.transientSaveRetries.set(m, y + 1),
            setTimeout(
              () => {
    ...
    return Q(e, (s) => {
      for (let i of t) {
        ...
        if (u) s.set(a, this.createPersistedLocalModuleFromSaveData(i, u));
          ...
          let d = s.get(a);
          (C(d, () => `${a} is not in persistedModules`),
  ...
  applyDependentSaveDataWithoutTreeUpdates(e, t, o) {
    return Q(e, (r) => {
      for (let s of t) {
        let i = s.localId,
          a = r.get(i);
        (C(a, () => `${i} is not in persistedModules`),
  ...
  applyBatchSaveDataToPersistedModules({
    ...
    return Q(e, (a) => {
      for (let u of t) {
        ...
        if (!l) {
          let m = a.get(d);
          (C(m, () => `${d} is not in persistedModules`),
  ...
  async createBatch(e, t, o, r, s, i, a, u) {
    ...
    for (let y in e) {
      ...
      let E = this.transientSaves.get(p);
      if (!E) {
        let w = o.get(p);
        (C(
          w,
        ...
        let N = i.get(p);
        (C(N, () => `No save id found for ${p}`), (E = this.getPatchTransientSave(p, w, N)));
      }
      ((E = wi(p, E, u)), t.set(p, E));
      let I = v(E);
      E.imports.relative.length > 0 && !this.moduleUsesLocalImportMapSpecifiers(I) && c.add(I);
    ...
    for (let y of g.values())
      for (let p of y) {
        ...
        let E = o.get(h);
        E?.kind === "server" && A.push(this.createLocalModuleFromModule(E));
      }
    if (A.length > 0) {
      let y = await Promise.all(A);
      o = Q(o, (p) => {
        for (let h of y) p.set(h.localId, h);
      });
    }
    for (let y of g.values()) for (let p of y) i.has(p) || i.set(p, U());
    let f = new Set();
    for (let [y, p] of g) {
      let [h] = we(y);
      for (let E of p) {
        let I = s.get(E);
        if (
          (C(I, () => `Cannot find localId for ${E}`),
          t.has(I) ||
            f.has(E) ||
            (o.get(I)?.metadata.localModuleImportMapEntries === !0 &&
              this.moduleUsesLocalImportMapSpecifiers(E) &&
              (h !== "codeFile" || !r[E]?.dependencies.has(y))))
        )
          continue;
        (f.add(E), c.add(E));
      ...
      (e = Q(e, (u) => {
        ...
        if (this.updateTreeNode(l.localId, i, c, r, s)) {
          ...
          for (let A of d) {
            ...
            (C(f, () => `${A.localId} is not in persistedModules`),
  ...
  async createBatchSaveForUpdatedModule(e, t, o, r, s, i) {
    ...
    let { type: N, name: M, metadata: b, files: $, ...Ee } = i;
    C(
      N === p && M === h,
    ...
    let K = ne(M),
      qe = d;
    (y.relative.length > 0 &&
      (qe = await this.replaceRelativeImportsWithAbsolute(a, d, y.relative, o, r, rt(g), s)),
      c &&
        (qe += `
//# sourceMappingURL=./${K.sourceMap}`));
    let ye = ($ ?? []).concat([
      { name: K.module, type: "module", content: qe },
      { name: K.source, type: "source", content: l },
    ]);
    c && ye.push({ name: K.sourceMap, type: "sourceMap", content: c });
    for (let [j, $e] of Object.entries(g)) ye.push({ name: j, type: "submodule", content: $e });
    for (let [j, $e] of Object.entries(A)) ye.push({ name: j, type: "binaryAsset", bytes: $e });
    let Ye = {};
    if (f || b || m !== void 0)
      if (u) {
        let j = o.get(u);
        (C(j || e === "$upsertName", `Cannot safely update metadata for ${e} (${u})`),
          (Ye.metadata = { ...j?.metadata, ...f, ...b, sourceRevision: m }));
      } else Ye.metadata = { ...f, ...b, sourceRevision: m };
    return {
      ...w,
      moduleId: e,
      type: N,
  ...
  ensurePersistedLocalIdsByTypeSlashNameCacheFor(e) {
    ...
    return (t || ((t = Dr(e)), this.persistedLocalIdsByTypeSlashNameCache.set(e, t)), t);
  }
  async replaceRelativeImportsWithAbsolute(e, t, o, r, s, i, a) {
    ...
    for (let A of l.error.unresolvedRelativeImports) {
      ...
      if (!f) continue;
      let [m] = we(f);
      if (!(m === "codeFile" || !g.getNodeWithTrait(f, Ne))) {
        c.add(f);
        break;
      }
    }
  ...
  async getGeneratorTraceCacheForNpmOperation() {
    if (this.dependenciesModule?.generatorTraceCacheContent) {
      let o = Ut(this.dependenciesModule.generatorTraceCacheContent);
      if (o) return o;
...
function Gt(n, e, t, o, r, s, i, a, u, d) {
  let l = new Set(s.keys()),
    ...
    [A, f] = Cn(s, (p) => {
      for (let h of t.values()) {
        ...
        (yr(p, I, N), c.delete(E), l.delete(I));
      }
      for (let h of c) {
        let E = o.get(h);
        if ((C(E), !E.localId)) continue;
        let I = ne(E.name),
          D = {
            kind: "local",
            localId: E.localId,
            type: E.type,
            name: E.name,
            moduleURL: `./transient/${E.saveId}/${I.module}`,
  ...
  return (
    y && y !== e && f.push({ op: e ? "replace" : "add", path: [v(y)], value: y }),
    {
...
function yr(n, e, t) {
  ...
  if (o.kind === "server") {
    (C(t.kind === "server"), Br(o, t));
    return;
  }
  (C(t.kind === "local"),
    Li(o.relativeImports, t.relativeImports) || (o.relativeImports = t.relativeImports),
    vo(o.files, t.files) || (o.files = t.files));
...
function Mr(n, e, t) {
  return n.replace(new RegExp(`\\b(from\\s*)(["'])${Pt(e)}\\2`, "g"), `$1${JSON.stringify(t)}`);
}
function Ri(n, e) {
  switch (n) {
...
function xi(n, e) {
  for (let t of n) {
    ...
    return Number.isNaN(o) ? !1 : o > Ir.start && o < Ir.end;
  }
  return !1;
}
function Dr(n) {
...
var Ht = class {
  constructor(e) {
    ...
    this.persistedLocalIdsByTypeSlashName = Dr(e);
  }
  persistedModules;
...
function Lc(n, e, t) {
  ...
  return !t || !o
    ? t
    : t.type === "collectionreference" && W(t.value) && !Sr(n, o, t.value)
      ? { ...t, value: void 0 }
      : t.type === "multicollectionreference" && Array.isArray(t.value)
        ? { ...t, value: t.value.filter((r) => Sr(n, o, r)) }
        : t;
}
function Ki(n) {
...
function Sr(n, e, t) {
  let o = n.getNodeWithTrait(t, mo),
    r = o && n.getNodeParent(o);
  return Ao(r) && r.instanceIdentifier === e;
}
function Oi(n, e) {
  if (n === e) return !0;
  let t = P(n);
...
function Uc(n, e, t, o) {
  ...
  return r === To ? s === o : !t || !Oi(r, t) || s !== o ? !1 : no(e) ? e.includes(i) : e === i;
}
function Kc(n, e, t, o) {
  return e === t && n.id === o;
}
function Vc(n, e = "relative") {
  if (fo(n)) return !0;
  if (!lo(n)) return !1;
  switch (e) {
    case "relative":
...
function zc(n, e, t) {
  if ((it(n, e) || (t.onlyNodesWithPositionFixed = !1), e.__unsafeIsSlotPropertyChildNode(n))) {
  ...
  if (No(e) && Qo(e)) {
    (t.positionTypes.add("sticky"),
      ue("positionStickyTop", t, e),
      ue("positionStickyRight", t, e),
      ue("positionStickyBottom", t, e),
      ue("positionStickyLeft", t, e));
    return;
  }
  if (wo(e) && Fo(e)) {
...
//# sourceMappingURL=chunk-JP2GKNMH.mjs.map
