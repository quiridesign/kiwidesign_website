import { b as he } from "chunk-2FANYRRP.mjs";
import { a as pe } from "chunk-K6L5GVTR.mjs";
import { Oa as V, Pc as ue } from "chunk-PJ6FAON2.mjs";
import { f as me } from "chunk-GWGM5D6M.mjs";
import {
  Be as x,
  Cr as ie,
  Hw as F,
...
import { e as h } from "chunk-DHUNMEBO.mjs";
import { o as O } from "chunk-HSJM72PS.mjs";
import { a as E } from "chunk-JTCAKYEM.mjs";
import { f as A, m as H } from "chunk-LA34HORX.mjs";
import { oa as f, pa as g } from "chunk-FCG35XJJ.mjs";
import { b as p } from "chunk-4JY5UMT2.mjs";
import { e as D } from "chunk-WLHSDIGQ.mjs";
var et = ({ naturalWidth: r, naturalHeight: o }) => ({
...
function N(r) {
  ...
  let e = Math.round(parseFloat(n) * ((i && Ee[i]) || 1));
  return e <= 0 ? 0 : e;
}
function st(r) {
  let o = Pe(r);
...
var Ae = 5e4,
  He = 'xlink:href="data:image/',
  fe = /xlink:href=['"]data:image\/[^;]+;base64,([A-Za-z\d+=/]+)/gu;
function dt(r) {
  return r.length > Ae || r.includes(He);
}
function ct(r) {
  let o = 0,
    t;
...
var ye = 10,
  Oe = (r = "horizontal", o = !0, t) => {
    let n = t?.stores.persistedUserDefaults.layoutGap ?? ye;
    return {
      layout: "stack",
      stackDirection: r,
  ...
  Ue = (r) => ({
    ...
    gridType: void 0,
    gap: r?.stores.persistedUserDefaults.layoutGap ?? ye,
    paddingPerSide: !1,
    padding: l.padding,
    paddingTop: l.padding,
    paddingBottom: l.padding,
...
var ro = (r, o) => {
  ...
  _e = (r, o, t, n, i, e) => {
    let s = new V({ ...Oe(t, i, r), fillEnabled: !1, ...o });
    p(S(s));
  ...
  Se = (r, o, t, n) => {
    let i = new V({ ...Ue(r), fillEnabled: !1, ...o });
    p(I(i));
    let e = o.gridType === T,
      s = Ze(e, h(o.height) ? o.height : void 0, h(i.gap) ? i.gap : void 0);
    for (let d = 0; d < t; d++) {
      let c = {};
      if (s) {
  ...
  io = (r, o, t, n = !1) => {
    if (o === 2) return Se(r, t, n ? 0 : 4);
    if (o === 3 || o === 4) return Se(r, t, n ? 0 : 3, o);
    let i = n ? 0 : 2;
    return _e(r, t, t.stackDirection ?? "horizontal", i, !1);
  },
  Ce = ae.width,
  qe = (r, o, t, n, i, e) => {
  ...
  Xe = (r, o, t, n, i, e) => {
    (qe(r, o, t, n, i, e), !(i > Ce) && (S(o) && Je(o, e), I(o) && Ke(o, e)));
  },
  Ye = (r, o, t, n, i, e) => {
    let s = o.getPrimaryId(),
      d = {};
    if ((Xe(r, o, t, n, i, d), (e[s] = d), U(o) && o.stackWrapEnabled && i <= Ce)) {
      let m = Qe(o);
...
function no(r, o, t) {
  ...
  for (let c in d) {
    ...
    let u = {};
    (Ye(r.tree, n, s, i, m.width, u), ge(r.tree, m, u));
  }
}
function ao(r, o, t, n = r.getParent(t.id), i = de(r, t)) {
  let e = {
    width: { 2: !0, 0: !0, 3: !0, 1: !0, 4: !0, 5: !0 },
    height: { 2: !0, 0: !0, 3: !0, 1: !0, 4: !0, 5: !0 },
  };
  if (
    (!n || !x(t) || (ue(t) && t.autoSize === !0) || ne(t)
      ? ((e.width[1] = !1),
        (e.height[1] = !1),
        (e.width[3] = !1),
        (e.height[3] = !1),
...
var $e = [
  ...
  mo = new Set($e.map((r) => r.vectorSetModuleId));
export {
  mt as a,
  ge as b,
  we as c,
...
//# sourceMappingURL=chunk-TNHWGVQK.mjs.map
