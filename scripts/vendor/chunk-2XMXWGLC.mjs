...
import { a as q, c as F, e as N } from "chunk-WLHSDIGQ.mjs";
var L = F((E, C) => {
  "use strict";
  (function (s, i) {
...
%c${JSON.stringify(a, null, 2)}`),
      ...
      function (s, i, l) {
        ...
        var o =
          (this && this.__awaiter) ||
          function (g, t, r, c) {
            return new (r || (r = Promise))(function (f, v) {
              function _(b) {
                try {
                  w(c.next(b));
                } catch (h) {
  ...
  O = new P.FramerTracking({
    ...
    addContext: (s) => {
      ...
      (i?.stores?.scopeStore &&
        ...
        s.appVersion === void 0 && (s.appVersion = "FramerWeb/80f113d"),
        S && s.projectId === void 0 && (s.projectId = S),
...
//# sourceMappingURL=chunk-2XMXWGLC.mjs.map
